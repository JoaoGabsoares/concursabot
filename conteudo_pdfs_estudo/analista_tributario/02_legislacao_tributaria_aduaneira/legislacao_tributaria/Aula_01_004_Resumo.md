...
todo o material possa ser revisado em um período de tempo mais curto.
      ...
      Com isso em mente, apresentamos a vocês o Resumo da Legislação Tributária - IPI
...
Limitações Constitucionais ao Poder de Tributar
  ...
  ● Principais princípios tributários aplicáveis ao IPI:
        ...
        ○ Princípio da Legalidade: Apenas para instituição e majoração acima do

           limite previsto em lei.

        ○ Princípio da Noventena: Tanto a instituição como a majoração somente

           produzem efeitos após noventa dias da norma que o instituiu ou majorou.

        ○ Princípio da Seletividade: O IPI deve ser graduado conforme a

           essencialidade dos produtos industrializados.

        ○ Princípio da Não Cumulatividade: Permite-se compensar o IPI que for
...
● Princípios Inaplicáveis:
     ...
     ○ Princípio da Legalidade: não se aplica em relação à alteração de alíquotas

        dentro dos limites e condições legais (aumentando até 30 unidades

        percentuais ou reduzindo a zero)
...
Industrialização
  ...
  ● Exemplos de operações de industrialização:
       ...
       ○ Transformação: mistura de matérias-primas ou produtos intermediários

          para obter espécie nova

       ○ Beneficiamento: operação de industrialização que importa em modificar,

          aperfeiçoar, ou, de qualquer forma, alterar o funcionamento, a utilização, o

          acabamento ou a aparência do produto

       ○ Montagem: na reunião de produtos, peças ou partes e de que resulte um
...
---
     ...
     ○ Acondicionamento ou reacondicionamento: alteração da apresentação

        do produto, pela colocação de embalagem, ou substituição da embalagem

        original, exceto embalagem de transporte

     ○ Renovação ou recondicionamento: operação de industrialização exercida

        sobre o produto usado ou parte remanescente de produto deteriorado ou

        inutilizado, renovando-o ou restaurando-o para utilização
...
● Principais exclusões do conceito de industrialização:
     ...
     ○ A operação efetuada fora do estabelecimento industrial, consistente na
        ...
        reunião de produtos, peças ou partes e de que resulte casas, pontes,

        galpões, usinas, centrais telefônicas etc.
     ...
     ○ A mistura de tintas entre si, ou com concentrados de pigmentos, sob
        ...
        comercial varejista, efetuada por máquina automática ou manual, desde
...
---
          ...
          que    fabricante      e    varejista     não sejam empresas interdependentes,
...
Incidência do IPI
  ...
  ● De acordo com o RIPI, o campo de incidência do imposto abrange todos os
  ...
  ● Resumindo:
       ...
       ○ Dentro do campo de incidência: produtos com alíquotas positivas, zero,

          ou mesmo isentos.

       ○ Fora do campo de incidência: produtos com notação NT e os que

          resultarem de operações excluídas do conceito de industrialização.

Classificação de Produtos


  ● A diferença básica entre o SH e a NCM é que esta possui 8 dígitos (2 a mais do

    que o SH). Tais dígitos representam o item e o subitem, e foram estabelecidos

    para detalhar melhor os produtos relacionados no SH.
...
● Far-se-á a classificação de conformidade com as Regras Gerais para Interpretação
  ...
  da Nomenclatura Comum do MERCOSUL - NCM, integrantes do seu texto.

● As NESH constituem elementos subsidiários de caráter fundamental para a

  correta interpretação do conteúdo das Posições e Subposições, bem como das

  Notas de Seção, Capítulo, Posições e de Subposições da Nomenclatura do
