...
Palavras II. Trata-se de um material pensado para lhe ajudar em todo esse processo, visando,
...
Preposições
 ...
 ● Essenciais - as preposições puras, que só funcionam como preposição: a, com,
 ...
 ● Acidentais - aquelas palavras que, na verdade, pertencem a outra classe, mas
   ...
   que, “acidentalmente”, fazem papel de preposição.


 ● Tenho que estudar (de)/ Jogo como goleiro (de).


 ● Valor semântico das preposições: a dica é verificar o sentido do termo que vem
...
Conjunções
 ...
 ● As    conjunções      coordenativas         introduzem          orações coordenadas, isto é,

   sintaticamente independentes uma da outra. São diferentes das orações

   subordinadas, que estão ligadas sintaticamente à oração principal.
...
OBS: o “mas” é uma conjunção adversativa que não pode ser deslocada. Ele inicia a
...
Subordinativas
  ...
  ● São aquelas que unem uma oração a outra, chamada de principal.


    Oração com função de advérbio (Orações subordinativas
...
Conjunções que podem aparecer com mais de um sentido

 ● Aqui, estão só as divisões. Recomendo você exercitar tentar preencher sozinho,

   ao lado de cada tipo de conjunção, todas aquelas que você lembrar, até garantir

   que você domina as listas.

 ● Esse exercício é fundamental para ganhar tempo e confiança na hora da prova.
