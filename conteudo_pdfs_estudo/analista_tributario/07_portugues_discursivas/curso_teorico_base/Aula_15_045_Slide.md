...
- interpretacao
- redacao_discursiva
arquivo_origem: Aula 15_045_Slide.txt
...
Em todas as frases abaixo foi feita a transformação da voz passiva pronominal (+
se) pela voz passiva com auxiliar (+ ser). Assinale a frase em que essa
transformação foi feita de forma adequada.
