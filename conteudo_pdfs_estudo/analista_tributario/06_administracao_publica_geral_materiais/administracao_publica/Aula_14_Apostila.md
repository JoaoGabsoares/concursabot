...
por objetivo identificar as oportunidades e as ameaças (desafios). Trata-se de elementos não
...
---
  ...
  Aula 13
       ...
       Demais desvantagens de custos: Trata-se de outras desvantagens de custo (que não estão
       relacionadas à economia de escala). Por exemplo:
...
As atividades primárias são as seguintes:
       ...
       Marketing e Vendas: trata-se das atividades relacionadas a proporcionar meios para que os
       clientes possam adquirir os produtos, ou seja, atividades que criam os “canais de venda”,
...
---
  ...
  Aula 13
       ...
       exemplo: instalação, treinamento, reparos, consertos, fornecimento de peças, etc. Trata-se
...
Vejamos quais são elas:
       ...
       Gerência de Recursos Humanos: trata-se de atividades associadas ao recrutamento,
...
Trata-se de indicadores que demonstram se a execução da estratégia está contribuindo para a
...
Relaciona-se, principalmente, a três variáveis:
       ...
       motivação, trabalho em equipe, cultura organizacional, etc. Trata-se dos aspectos
...
“priorizar” aqueles mais importantes.
...
2. (FGV – DPE-RO - Analista em Administração - Classe A – 2025)
  ...
  A partir da Análise SWOT, ferramenta que examina aspectos dos ambientes interno e externo
  das organizações, é possível definir estratégias adequadas ao combinar esses fatores,
  orientando assim a tomada de decisões.

  Com base nessa lógica, analise as alternativas a seguir:

  I. Estratégia de desenvolvimento ocorre quando a organização apresenta forças e
  oportunidades, buscando expandir ou inovar com base em seus pontos fortes.

  II. Estratégia de crescimento ocorre quando há fraquezas e oportunidades, exigindo mudanças
  internas para aproveitar o ambiente favorável.

  III. Estratégia de manutenção ocorre quando há forças e ameaças, sendo necessário usar as
  capacidades organizacionais para proteger-se de riscos externos.

  Levando em consideração os conceitos propostos na Análise SWOT, está correto o que se afirma
  em
...
Vejamos um esquema com cada uma das estratégias:
...
3. (FGV – DPE-RO - Analista em Administração - Classe A – 2025)
  ...
  Ao propor mudanças no modelo de avaliação de desempenho, um gestor de uma empresa
  pública busca adotar um método que não se limite a critérios financeiros, mas que também
  considere a perspectiva dos clientes, os processos internos e o aprendizado organizacional.

  Nesse contexto, a ferramenta mais adequada para esse tipo de avaliação é:
...
É o Balanced Scorecard (BSC) que leva em consideração o equilíbrio entre 04 diferentes
perspectivas: Financeira; Cliente; Processos Internos e; Aprendizado e Crescimento.

O gabarito é a letra C.

4. (FGV – Prefeitura de Canaã dos Carajás - PA - Agente – 2025)

  A matriz SWOT é uma ferramenta estratégica usada pelas organizações para identificar os
  elementos internos e externos que podem influenciar sua atuação.

  Assinale a opção que apresenta, corretamente, exemplos de elementos de influência externa à
  organização.
  ...
  d) Força e oportunidade.

  e) Oportunidade e ameaça.
...
5. (FGV – TJ-AP – Analista Judiciário – Área Apoio Especializado – Especialidade Controle Interno
   - 2024)

  Charles H. Kepner e Benjamin B. Tregoe foram os primeiros proponentes da Matriz GUT. Um
  analista de uma organização pública pretende utilizá-la como ferramenta para identificar ações
  prioritárias. Ao terminar sua elaboração, a matriz abaixo é apresentada numa reunião decisória:
...
---
  ...
  Ao final da reunião, mantidos os valores da Matriz, os problemas foram ordenados, de mais
  para menos prioritários, na seguinte ordem:
...
A Matriz GUT (ou Matriz Gravidade, Urgência e Tendência) é uma ferramenta utilizada para
priorizar os problemas. Após a análise (que é realizada através de algumas “perguntas-padrão”), os
problemas da organização recebem notas (que variam de 1 a 5) para cada um desses fatores
(Gravidade, Urgência e Tendência).

Essas notas são multiplicadas e, então, pode ser possível estabelecer o grau de importância de
cada problema. Quanto maior for o resultado obtido, maior será a prioridade do problema.

Vejamos os problemas destacados pelo enunciado:
...
Multiplicando as notas dadas para cada variável, a ordem de prioridade (do mais prioritário para o
menos prioritário) é a seguinte:

Problema c = G (4) x U (4) x T (5) = 80

Problema d = G (4) x U (4) x T (4) = 64

Problema b = G (4) x U (5) x T (2) = 40

Problema e = G (3) x U (3) x T (4) = 36

Problema a = 3 (3) x U (3) x T (3) = 27

O gabarito é a letra D.

6. (FGV – TJ-AP – Analista Judiciário – Área Apoio Especializado – Especialidade Controle Interno
   - 2024)

  A área de Controle Interno de uma organização pública está passando por uma reestruturação
  e, para tanto, os responsáveis por esse projeto realizaram uma análise SWOT. Identificaram a
  ausência de profissionais especializados, porém, mencionaram que há uma maior quantidade de
  concursos públicos sendo realizados no atual governo.
...
Ausência de profissionais especializados é uma fraqueza (Weakness), ou seja, aspecto do ambiente
interno que coloca a organização em uma posição desfavorável.

Maior quantidade de concursos públicos sendo realizados no atual governo é uma oportunidade
(Opportunities), ou seja, aspecto do ambiente externo que influenciam positivamente a
organização.
...
7. (FGV – TJ-AP – Analista Judiciário – Área Apoio Especializado – Especialidade Administração -
  ...
  O modelo das cinco forças competitivas, proposto por Porter, é uma ferramenta amplamente
  utilizada na formulação de estratégias de negócio. A análise das cinco forças orienta os gestores
  na formulação de estratégias que favoreçam a consolidação das vantagens competitivas da
  organização na indústria em que atua.

  Acerca das proposições do modelo das cinco forças e das estratégias competitivas de Porter,
  analise as afirmativas a seguir.

  I. A possibilidade de integração vertical das atividades em determinada indústria influencia o
  poder de barganha dos fornecedores.

  II. A estratégia de liderança em custos permite que a empresa obtenha lucros quando uma
  competição acirrada corroer as margens dos concorrentes.

  III. A ameaça de novos entrantes é influenciada por barreiras à entrada, tais como a existência
  de economias de escala significativas na indústria.

  IV. Barreiras de saída significativas influenciam o grau de rivalidade entre os concorrentes
...
A primeira assertiva está correta. De fato, os fornecedores tornam-se “poderosos” quando
conseguem “integrar para frente” (integração vertical), ou seja, eles conseguem assumir os
negócios dos seus clientes.

A segunda assertiva está correta. Isso mesmo. Isso, pois, essa estratégia busca tornar a organização
mais competitiva através da produção de produtos mais baratos do que os produtos dos
concorrentes. A organização que adota essa estratégia está orientada para a eficiência.
...
A terceira assertiva está correta. Isso mesmo. A economias de escala são um exemplo de barreiras
que dificultam a entrada de uma empresa no setor.

A quarta assertiva está correta. De fato, a existência de elevadas barreiras de saída do setor
influencia a rivalidade (ou concorrência).
...
8. (FGV – TJ-AP – Analista Judiciário – Área Apoio Especializado – Especialidade Administração -
  ...
  Certa organização de grande porte está em fase de formulação de seu planejamento estratégico
  e fez uso da matriz GE/McKinsey para análise de seu portfólio de negócios. Os resultados foram:
  ...
  e) a organização deve investir no negócio C e investir seletivamente nas demais unidades de
  negócio.
...
Vejamos cada uma das unidades de negócio apresentadas pelo enunciado.

- unidade de negócio A – alta atratividade da indústria e posição competitiva média =
investimento e crescimento

- unidade de negócio B – média atratividade da indústria e posição competitiva média = cautela e
seletividade

- unidade de negócio C – alta atratividade da indústria e posição competitiva alta = investimento e
crescimento

- unidade de negócio D – baixa atratividade da indústria e posição competitiva alta = cautela e
seletividade

- unidade de negócio E – alta atratividade da indústria e posição competitiva baixa = cautela e
seletividade

- unidade de negócio F – média atratividade da indústria e posição competitiva baixa = desinvestir
ou colher

Vamos analisar cada uma das alternativas.

Letra A: errada. De fato, para o negócio F deve-se “desinvestir ou colher”. Entretanto, para o
negócio D deve-se ter “cautela e seletividade”.

Letra B: correta. Isso mesmo! Para os negócios A e C é indicado “investimento e crescimento” e
para o negócio F deve-se “desinvestir ou colher”.
...
Letra C: errada. De fato, para o negócio E é indicado “cautela e seletividade”. Entretanto, para os
negócios A e C é indicado “investimento e crescimento”.

Letra D: errada. De fato, para os negócios B, D e E é indicado “cautela e seletividade” e para o
negócio F deve-se “desinvestir ou colher”. Entretanto, para o negócio A é indicado “investimento e
crescimento”.

Letra E: errada. De fato, para o negócio C é indicado “investimento e crescimento”. Entretanto,
apenas para os negócios B, D e E é indicado “cautela e seletividade”. Para o negócio A é indicado
“investimento e crescimento” e para o negócio F deve-se “desinvestir ou colher”.

O gabarito é a letra B.

9. (FGV – TCE-PA – Auxiliar Técnico de Controle Externo – 2024)

  A análise do ambiente em organizações públicas é um processo que avalia as condições externas
  e internas que podem influenciar sua atuação. Isso inclui o exame de fatores políticos,
  econômicos, sociais, tecnológicos, legais e ambientais, além da análise de forças, fraquezas,
  oportunidades e ameaças (análise SWOT).

  A análise que aponta os processos e projetos que precisam de alterações para renderem o
  esperado e a análise que visa a determinar fatores e mudanças no mercado que podem ser
  usadas em benefício da empresa são, respectivamente,

  a) Falhas e Oportunidades.

  b) Fraquezas e Oportunidades.
...
“Processos e projetos que precisam de alterações para renderem o esperado” são exemplos de
fraquezas, ou seja, aspectos do ambiente interno que colocam a organização em uma posição
desfavorável.

“Fatores e mudanças no mercado que podem ser usadas em benefício da empresa” são exemplos
de oportunidades, ou seja, aspectos do ambiente externo que influenciam positivamente a
organização.
...
10. (FGV – Departamento Nacional de Infraestrutura de Transportes – Analista Administrativo
  ...
  A matriz Ansoff é uma ferramenta cuja finalidade é analisar as variáveis do produto e do
  mercado com relação ao seu crescimento.

  Uma estratégia dessa matriz é a penetração no mercado que tem por característica explorar

  a) novos mercados com novos produtos.

  b) mercado novo com produtos tradicionais.

  c) novo mercado com mercados tradicionais.

  d) mercados tradicionais com produtos novos.

  e) produtos tradicionais em mercados tradicionais.
...
A Matriz Ansoff classifica 04 tipos de estratégias:
       ...
       mercado existente (mercado “tradicional”), através de produtos que também já existem
       (produtos “tradicionais”). Por exemplo: uma empresa de táxi fecha parcerias com diversas
       empresas para a realização de “viagens corporativas”.
...
11. (FGV – Departamento Nacional de Infraestrutura de Transportes – Analista Administrativo
   – Administração - 2024)
...
---
  ...
  Entre os modelos de apoio à decisão em uma organização, a matriz SWOT se destaca no
  processo estratégico por permitir analisar seus ambientes interno e externo, trazendo aspectos
  positivos e negativos que podem impactar cenários futuros.

  Assinale a opção que apresenta o critério de avaliação desse modelo que se relaciona ao
  ambiente externo.
...
12.    (FGV – CVM – Analista Perfil 5 - Mercado de Capitais – 2024)

  Determinada autarquia realizou um conjunto de audiências públicas visando a consultar os
  operadores do mercado quanto às mudanças na regulamentação do setor. No processo de
  análise estratégica dessa indústria, a autarquia considerou necessário não só estimular a
  eficiência, mas principalmente garantir a integridade e disciplinar a atuação dos atuais
  operadores em uma indústria altamente disputada e com concentração de fatias de mercado
  elevadas nas mãos alguns poucos.

  Ao considerar o conceito de forças competitivas estratégicas, as medidas da autarquia visavam a
  lidar com a seguinte força:
  ...
  d) rivalidade entre os concorrentes;
...
A assertiva trata da rivalidade entre concorrentes. Essa força mede a rivalidade do mercado, ou
seja, avalia como está a concorrência no mercado.

O gabarito é a letra D.

13. (FGV – Controladoria Geral do Estado da Paraíba - Auditor de Contas Públicas – Auditoria
   Governamental - 2024)

  Certa empresa, em fase de formulação de seu planejamento estratégico, utilizou a matriz BCG
  para análise de seu portfólio de produtos. A matriz aponta: produto A – alta taxa de crescimento
  do mercado e baixa participação no mercado; produto B – baixa taxa de crescimento do
  mercado e baixa participação no mercado; produto C – alta taxa de crescimento do mercado e
  alta participação no mercado; produto D – baixa taxa de crescimento do mercado e alta
  ...
  b) o produto C é um produto “vaca leiteira”, que deve financiar o produto A (“ponto de
  interrogação”);

  c) os produtos B e D são produtos “cachorro”, cujos mercados pouco crescem, e devem ser
  abandonados;

  d) o produto B é um produto “ponto de interrogação”, que deve ser financiado pelo produto D,
  que é “vaca leiteira”;

  e) o produto A é um produto “estrela” no qual a empresa deve investir para que não se torne
  um produto “cachorro”.

Comentários:

Vejamos cada um dos produtos.

produto A – alta taxa de crescimento do mercado e baixa participação no mercado = Interrogação

produto B – baixa taxa de crescimento do mercado e baixa participação no mercado =
Abacaxi/Cachorro

produto C – alta taxa de crescimento do mercado e alta participação no mercado = Estrela
...
produto D – baixa taxa de crescimento do mercado e alta participação no mercado = Vaca Leiteira

Portanto, a única assertiva correta é a letra A. De fato, o produto D é um produto “vaca leiteira”,
que deve financiar o produto C (“estrela”).

O gabarito é a letra A.

14.    (FGV – ALESC – Analista Legislativo III – Administrador - 2024)

  Michael Porter propõe um modelo de cinco forças competitivas para analisar a rivalidade entre
  concorrentes e a ameaça representada por novos entrantes, pela possível emergência de
  ...
  b) Competição entre as firmas dentro da indústria.

  c) Produtos substitutos.

  d) Competição por clientes e consumidores.

  e) Poder de negociação dos compradores.

Comentários:

A assertiva trata da rivalidade entre concorrentes (competição entre as firmas dentro da
indústria). Essa força mede a rivalidade do mercado, ou seja, avalia como está a concorrência no
mercado.
...
15. (FGV – Câmara Municipal de São Paulo - Consultor Técnico Legislativo - Administração –
  ...
  A análise de ambiente, também conhecida como análise ambiental, refere-se ao processo de
  avaliação e compreensão do ambiente externo e interno que impacta uma organização, projeto
  ou iniciativa.

  Assinale a opção que define o principal objetivo da Matriz SWOT.

  a) Prever com precisão todas as mudanças ambientais futuras.
...
---
  ...
  b) Identificar exclusivamente as fraquezas internas de uma organização.

  c) Avaliar continuamente os cenários futuros de desenvolvimento ambiental.

  d) Integrar os recursos organizacionais e antever cenários de oportunidades.

  e) Tornar obsoletos os cenários desenhados para garantir a inovação.
...
Portanto, a única assertiva correta é a letra D. Isso, pois, a análise SWOT busca integrar os recursos
organizacionais (buscando minimizar as fraquezas e fortalecer as forças) e antever cenários de
oportunidades (buscando minimizar/eliminar os impactos que as ameaças podem causar e
aproveitar as oportunidades, antevendo os cenários positivos).

O gabarito é a letra D.

16. (FGV – Controladoria Geral do Estado da Paraíba - Auditor de Contas Públicas – Auditoria
   Contábil e Finanças Públicas - 2024)

  Para a construção do mapa estratégico e dos projetos e planos de ação, os gestores dessa
  mesma organização (figura 1) deverão levar em consideração questões orientadoras que
  sempre remetam aos princípios e valores estratégicos compatíveis com cada perspectiva.
...
---
  ...
  a) maximizar capital social com cidadãos

  b) aumentar as receitas e melhorar fluxo de caixa

  c) melhorar continuamente as atividades dos setores

  d) incorporar nos serviços a coprodução com usuários

  e) ampliar a capacidade de integração com outros atores

Comentários:

Letra A: errada. Trata-se da perspectiva dos clientes (“satisfação” dos cidadãos).

Letra B: errada. Trata-se da perspectiva financeira.

Letra C: errada. Trata-se da perspectiva dos processos internos.

Letra D: errada. Trata-se da perspectiva dos clientes.

Letra E: correta. De fato, trata-se da perspectiva de aprendizado e crescimento.

O gabarito é a letra E.

17.    (FGV – Câmara Municipal de Fortaleza – Analista de Gestão de Pessoas – 2024)

  Ao utilizar o modelo das cinco forças de Porter na formulação de sua estratégia, o gestor deve
  considerar, em sua análise,

  a) o poder de barganha dos fornecedores do setor.

  b) os seus produtos do tipo vaca-leiteira.

  c) as forças internas da sua organização.

  d) a perspectiva acerca de seus processos internos.

  e) o nível de gravidade de determinado problema operacional.

Comentários:

Letra A: correta. De fato, Porter identificou 05 forças competitivas (Cinco forças de Porter):
Ameaça de Novos Entrantes, Ameaça de Produtos Substitutos, Poder de Barganha dos
Fornecedores, Poder de Barganha dos Clientes e Rivalidade entre Concorrentes (concorrência no
setor).
...
Letra B: errada. Vaca leiteira está associada à Matriz BCG.

Letra C: errada. Forças estão associadas à Análise SWOT.

Letra D: errada. Perspectiva dos Processos Internos está associada ao Balanced Scorecard.

Letra E: errada. Análise do nível de gravidade está associada à Matruz GUT.

O gabarito é a letra A.

18.    (FGV – Câmara dos Deputados - Técnica legislativa – 2023)

  A Análise SWOT é uma ferramenta de gestão altamente eficaz, frequentemente empregada por
  sociedades empresárias e organizações para avaliar sua posição atual, identificar oportunidades,
  lidar com desafios e elaborar estratégias eficazes.

  Sobre a análise SWOT, assinale a afirmativa correta.

  a) S representa pontos fortes dos sistemas externos da organização.

  b) W representa pontos fracos dos sistemas externos da organização.

  c) O representa oportunidades oferecidas pela organização.

  d) T representa ameaças oferecidas pela organização.

  e) É uma ferramenta de origem indeterminada, que vem sendo usada desde a década de 1960.

Comentários:

O acrostico “SWOT” deriva das seguintes palavras em inglês: Weakness (Fraquezas), Opportunities
(Oportunidades) e Threats (Ameaças). Em português, também é conhecida como matriz “FOFA”.

Letra A: errada. S representa Strengths (Forças/Pontos Fortes) do ambiente interno.

Letra B: errada. W representa Weakness (Fraquezas/Pontos Fracos) do ambiente interno.

Letra C: errada. O representa Opportunities (Oportunidades) do ambiente externo.

Letra D: errada. T representa Threats (Ameaças) do ambiente externo.
...
Letra E: correta. Conforme explica Nakagawa, a “Análise SWOT não tem um pai ou mãe definidos,
mas muitos acreditam que ela tenha sido desenvolvida na década de 1960 por professores da
Universidade Stanford, a partir da análise das 500 maiores empresas dos Estados Unidos.”1

O gabarito é a letra E.

19.      (FGV – Câmara dos Deputados - Técnica legislativa – 2023)

     A Matriz GUT, que leva em consideração os fatores de Gravidade, Urgência e Tendência, é uma
     ferramenta poderosa empregada na gestão de projetos, na resolução de problemas e na
     orientação de decisões estratégicas.

     Sobre a matriz GUT, assinale a afirmativa correta.

     a) ‘A ação pode aguardar?’ é uma pergunta de Gravidade

     b) ‘A ação é relativamente importante?’ é uma pergunta de Urgência.

     c) ‘A situação vai melhorar?’ é uma pergunta de Urgência.

     d) ‘A situação vai piorar?’ é uma pergunta de Tendência.

     e) ‘A ação é extremamente importante?’ é uma pergunta de Tendência.

Comentários:

Letra A: errada. ‘A ação pode aguardar?’ é uma pergunta de Urgência.

Letra B: errada. ‘A ação é relativamente importante?’ é uma pergunta de Gravidade.

Letra C: errada. ‘A situação vai melhorar?’ é uma pergunta de Tendência.

Letra D: correta. De fato, ‘A situação vai piorar?’ é uma pergunta de Tendência.

Letra E: errada. ‘A ação é extremamente importante?’ é uma pergunta de Gravidade.

O gabarito é a letra D.

20. (FGV – Câmara dos Deputados - Analista Legislativo - Técnico em material e Patrimônio –
   2023)

1
    NAKAGAWA, Marcelo. Ferramenta: Análise SWOT (Clássico). Movimento Empreenda. SEBRAE.
...
---
    ...
    Aula 13
     ...
     A análise SWOT é uma poderosa ferramenta de gestão amplamente utilizada por empresas e
     organizações para avaliar sua situação atual, identificar oportunidades, enfrentar desafios e
     desenvolver estratégias eficazes.

     Sobre a análise SWOT, assinale a afirmativa correta.

     a) É uma ferramenta de domínio público e de origem indeterminada.

     b) S denomina pontos fortes dos sistemas externos da organização.

     c) W denomina pontos fracos dos sistemas externos da organização.

     d) O denomina oportunidades oferecidas pela organização.

     e) T denomina ameaças oferecidas pela organização.
...
Letra A: correta. Conforme explica Nakagawa, a “Análise SWOT não tem um pai ou mãe definidos,
mas muitos acreditam que ela tenha sido desenvolvida na década de 1960 por professores da
Universidade Stanford, a partir da análise das 500 maiores empresas dos Estados Unidos.”2

Letra B: errada. S representa Strengths (Forças/Pontos Fortes) do ambiente interno.

Letra C: errada. W representa Weakness (Fraquezas/Pontos Fracos) do ambiente interno.

Letra D: errada. O representa Opportunities (Oportunidades) do ambiente externo.

Letra E: errada. T representa Threats (Ameaças) do ambiente externo.

O gabarito é a letra A.

21. (FGV – Câmara dos Deputados - Analista Legislativo - Técnico em material e Patrimônio –
   2023)

     A Matriz GUT (Gravidade, Urgência e Tendência) é uma ferramenta eficaz usada na gestão de
     projetos, na resolução de problemas e na tomada de decisões estratégicas.

     Sobre a matriz GUT, analise as afirmativas a seguir.
...
---
  ...
  I.   Gravidade pondera se a ação pode aguardar.

  II. Urgência avalia se a ação é relativamente importante.

  III. Tendência pondera se a situação vai piorar.
...
A primeira assertiva está errada. Nada disso! Gravidade analisa o grau de dano ou prejuízo que o
problema poderá trazer à organização.

A segunda assertiva está errada. Nada disso! Urgência avalia o prazo que a organização possui para
agir sobre o problema.

A terceira assertiva está correta. De fato, Tendência avalia de que forma esse problema irá se
desenvolver caso a organização não atue sobre ele. Trata-se do “padrão de desenvolvimento” da
situação. Em outras palavras, avalia o quanto pior (ou melhor) serão os impactos desse problema
com o passar do tempo.

O gabarito é a letra C.

22. (FGV – AL-MA - Técnico de Gestão Administrativa - Administrador de Recursos Humanos –
   2023)

  Caso o administrador de uma empresa elabore uma Matriz SWOT, é correto afirmar que, como
  consequência natural dessa ação, ele deve identificar
...
Letra A: errada. A alternativa trouxe elementos relacionados às 05 forças de Porter.

Letra B: errada. A alternativa trouxe elementos relacionados à Matriz GUT.

Letra C: errada. Isso mesmo. Análise SWOT é utilizada para buscar entender a “posição atual” da
organização. Consiste, basicamente, na análise do ambiente interno (forças e fraquezas) e do
ambiente externo (ameaças e oportunidades).
                                                        ==219a34==

Letra D: errada. A alternativa trouxe elementos relacionados ao Balanced Scorecard.

Letra E: errada. A alternativa trouxe elementos relacionados à Matriz BCG.

O gabarito é a letra C.

23.    (FGV – DPE-RS - Analista - Área Administrativa – Administração – 2023)

  O modelo das Cinco Forças de Porter é uma ferramenta amplamente utilizada no planejamento
  estratégico. O modelo busca avaliar a atratividade de uma indústria com base em cinco forças
  competitivas, que influenciam a natureza da competição e o potencial de lucratividade em
  determinada indústria ou setor. Dentre as forças competitivas do modelo estão:
  ...
  e) poder de barganha das empresas dominantes; concentração do mercado.

Comentários:

Porter identificou 05 forças competitivas (Cinco forças de Porter): Ameaça de Novos Entrantes,
Ameaça de Produtos Substitutos, Poder de Barganha dos Fornecedores, Poder de Barganha dos
Clientes e Rivalidade entre Concorrentes (concorrência no setor).
...
24.    (FGV – TJ-RN - Analista Judiciário - Tecnologia de Informação – Análise de Suporte – 2023)

  Gilberto é presidente da Orapost e se reuniu com seus chefes de departamentos para geração
  de um relatório empresarial com base em uma análise SWOT da empresa. Essa análise é uma
  técnica usada para identificar forças, oportunidades, fraquezas e ameaças para a sua empresa.
  Seu objetivo é identificar onde a empresa está no momento e como dar o próximo passo. Com o
  início do processo, surgiram várias perguntas.

  Com base nas possíveis respostas abaixo sobre a análise, a que representa o conceito de
  AMEAÇAS da análise SWOT a ser utilizada por Gilberto no relatório final é:

  a) uma comparação com os concorrentes; nosso atendimento é de nível mundial, pois possui
  uma alta pontuação;

  b) um site com baixa visibilidade devido à falta de orçamento para campanhas de marketing;

  c) uma promoção de campanhas publicitárias no YouTube, no Facebook e no Instagram, de
  forma a aumentar a visibilidade de e-commerce;

  d) um novo concorrente de comércio eletrônico planejado para inaugurar no próximo mês;
  pode ser que a nossa base de clientes diminua;

  e) uma diminuição contínua no número de transações efetuadas por meio de dispositivos
  móveis, por problemas de interação com o site da empresa.

Comentários:

Letra A: errada. Atendimento de alta qualidade é um exemplo de força

Letra B: errada. Problema por falta de orçamento é um exemplo de fraqueza.

Letra C: errada. A existência de redes sociais para realização de campanhas para aumentar a
visibilidade é um exemplo de oportunidade.

Letra D: correta. De fato, a entrada de um novo concorrente no setor é um exemplo de ameaça.

Letra E: errada. Problema no site da empresa é um exemplo de fraqueza.

O gabarito é a letra D.

25.    (FGV – CGM - RJ - Técnico de Controle Interno – 2023)

  A Matriz GUT foi proposta por Charles H. Kepner e Benjamin B. Tregoe em 1981 como uma
  ferramenta a ser utilizada na solução de problemas. Numa organização, cinco problemas foram
...
---
  ...
  avaliados e resultaram nas pontuações listadas a seguir. Indique a alternativa coerente com o
  modelo e que representa o problema prioritário:
...
Letra A: errada. G=1 x U=1 x T=1 = 1

Letra B: errada. G=2 x U=4 x T=5 = 40

Letra C: correta. G=4 x U=4 x T=4 = 64

Letra D: errada. G=8 x U=6 x T=8 = Essa alternativa não é coerente com a Matriz GUT, pois as notas
variam de 01 a 05.

Letra E: errada. G=10 x U=10 x T=10 = Essa alternativa não é coerente com a Matriz GUT, pois as
notas variam de 01 a 05.

Portanto, o problema prioritário está na letra C, uma vez que, dentre as alternativas coerentes com
a Matriz GUT (que apresentaram notas de 01 a 05), a que obteve a maior nota foi a letra C.

O gabarito é a letra C.

26.    (FGV – TCE-ES - Auditor de Controle Externo - Auditoria Governamental – 2023)

  Uma Instituição de Ensino Superior (IES) formulou um mapa estratégico visando a organizar os
  objetivos estratégicos para os próximos dez anos, considerando as dimensões tradicionais do
  modelo Balanced Scorecard (BSC). Dentre os objetivos, estão contemplados em uma mesma
...
---
  ...
  dimensão o aumento da receita e o reinvestimento na IES, bem como a captação de recursos
  para pesquisas.
...
Aumento da receita e o reinvestimento estão relacionados à perspectiva financeira. A perspectiva
financeira envolve de indicadores que demonstram se a execução da estratégia está
contribuindo para a melhoria dos resultados financeiros. É nessa perspectiva que se analisavam
o crescimento da receita e a produtividade

O gabarito é a letra C.

27.    (FGV – Prefeitura de Manaus - AM - Administrador Geral – 2022)

  O uso da análise SWOT permite ao gestor realizar um diagnóstico da situação organizacional, o
  que permite que ele identifique elementos ou condições que servirão de base para o
  desenvolvimento da estratégia de sua organização.

  No entanto, independentemente da qualidade da análise realizada, alguns aspectos não
  poderão ser controlados pelo gestor, como, por exemplo,

  a) as forças e as oportunidades.

  b) as forças e as ameaças.

  c) as oportunidades e as ameaças.

  d) as oportunidades e as fraquezas.

  e) as ameaças e as fraquezas.
...
A Análise SWOT é utilizada para buscar entender a “posição atual” da organização. Consiste,
basicamente, na análise do ambiente interno (forças e fraquezas – aspectos controláveis) e do
ambiente externo (ameaças e oportunidades – aspectos não controláveis).

O gabarito é a letra C.

28.    (FGV – MPE-GO - Assistente Administrativo – 2022)

  O uso da análise SWOT por uma organização permite que ela identifique tanto elementos que
  independem de suas ações quanto outros que são passíveis de modificações.

  Assinale a alternativa que apresenta um elemento identificado pela análise SWOT que não pode
...
29.    (FGV – TJ-DFT - Analista Judiciário – Administração – 2022)
...
30.    (FGV – TCE-TO - Auditor de Controle Externo – Administração – 2022)
...
31.    (FGV – IMBEL - Supervisor - Administrador – Reaplicação – 2021)
...
32.    (FGV – Prefeitura de Paulínia - SP - Agente de Apoio Administrativo – 2021)
...
33.    (FGV – Câmara de Aracaju - SE - Assistente Administrativo – 2021)
...
34.    (FGV – Câmara de Aracaju - SE - Assistente Administrativo – 2021)
...
35.    (FGV – IMBEL - Supervisor - Administrador – Reaplicação – 2021)
...
36.    (FGV – IMBEL - Supervisor - Administrador – Reaplicação – 2021)
...
38.    (FGV – FUNSAÚDE - CE - Analista Administrativo – Suprimentos – 2021)
...
40.    (FGV – FUNSAÚDE - CE - Analista Administrativo – Administração – 2021)
...
41.    (FGV – FUNSAÚDE - CE - Analista Administrativo – Administração – 2021)
...
42.    (FGV – IMBEL - Engenheiro de Controle de Qualidade – 2021)
...
43.    (FGV – FUNSAÚDE - CE - Analista Administrativo – Suprimentos – 2021)
...
44.    (FGV – FUNSAÚDE - CE - Analista Administrativo – Administração – 2021)
...
45.    (FGV – TJ-RO - Analista Judiciário – Administrador – 2021)
...
46.    (FGV – IMBEL – Administrador - 2021)
...
48.    (FGV – Câmara de Aracaju-SE – Analista Administrativo - 2021)
...
49.    (FGV - Prefeitura de Niterói - Analista de Políticas Públicas - 2018)
...
50.    (FGV - Prefeitura de Niterói - Analista de Políticas Públicas - 2018)
...
51.    (FGV – MPE-AL – Analista do Ministério Público - 2018)
...
52.    (FGV – AL-RO – Assistente Legislativo - 2018)
...
53.    (FGV – MPE-AL – Analista do Ministério Público - 2018)
...
Trata-se de descrições encontradas nos campos da ferramenta 5W2H.

O gabarito é a letra E.

55.    (FGV – AL-RO – Assistente Legislativo - 2018)
...
Letra C: errada. Trata-se de características da Matriz GUT.
...
56.    (FGV – AL-RO – Analista Legislativo - 2018)
...
57.    (FGV – AL-RO – Analista Legislativo - 2018)
...
58.    (FGV – Prefeitura de Salvador-BA – Técnico de Nível Superior - 2017)
...
59.    (FGV – SEPOG-RO – Analista de Planejamento e Finanças - 2017)
...
60.     (FGV – Prefeitura de Salvador – Técnico de Nível Superior - 2017)
...
61.    (FGV – Prefeitura de Salvador-BA – Técnico de Nível Superior - 2017)
...
62.    (FGV – Prefeitura de Salvador-BA – Técnico de Nível Superior - 2017)
...
63.    (FGV – CODEBA – Analista Portuário - 2016)
...
Aula 13
                                              ...
                                              GABARITO
1. Letra B                                 22. Letra C                  43. Letra C
2. Letra E                                 23. Letra C                  44. Letra D
3. Letra C                                 24. Letra D                  45. Letra D
4. Letra E                                 25. Letra C                  46. Letra C
5. Letra D                                 26. Letra C                  47. Letra D
6. Letra E                                 27. Letra C                  48. Letra D
7. Letra E                                 28. Letra E                  49. Letra D
8. Letra B                                 29. Letra D                  50. Letra A
9. Letra B                                 30. Letra C                  51. Letra B
10. Letra E                                31. Letra C                  52. Letra B
11. Letra A                                32. Letra D                  53. Letra D
12. Letra D                                33. Letra D                  54. Letra E
13. Letra A                                34. Letra B                  55. Letra E
14. Letra B                                35. Letra C                  56. Letra D
15. Letra D                                36. Letra A                  57. Letra B
16. Letra E                                37. Letra A                  58. Letra D
17. Letra A                                38. Letra C                  59. Letra D
18. Letra E                                39. Letra A                  60. Letra C
19. Letra D                                40. Letra C                  61. Letra E
20. Letra A                                41. Letra A                  62. Letra E
21. Letra C                                42. Letra E                  63. Letra C
