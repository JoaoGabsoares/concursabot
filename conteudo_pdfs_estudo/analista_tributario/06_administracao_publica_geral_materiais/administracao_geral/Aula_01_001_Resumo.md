...
Conceitos Introdutórios.       Trata-se de um material pensado para lhe ajudar em todo esse
...
Conceitos Introdutórios
  ...
  ➔ Conceito: Administração é a utilização de todos os recursos organizacionais

    (pessoas, equipamentos, dinheiro, etc.), de forma planejada, organizada,

    dirigida e controlada, para o alcance dos objetivos da organização, que não

    poderiam ser alcançados por uma só pessoa (de forma autônoma).
