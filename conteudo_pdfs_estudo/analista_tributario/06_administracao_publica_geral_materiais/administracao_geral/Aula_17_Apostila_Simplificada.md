...
---
      ...
      Aula 16
                                                                                     ...
                                                                                     Índice
1) Gestão do Desempenho - PDF SIMPLIFICADO
...
Gestão do Desempenho 
  ...
  3 – Avaliação de Desempenho 
     ...
     3.2 – Objetivos da Avaliação de Desempenho (Benefícios da Avaliação de Desempenho) 
  ...
  5 – Erros da Avaliação de Desempenho (Vieses dos Processos de Avaliação de Desempenho) .. 36
...
De acordo com Marras5, a “avaliação de desempenho (AD) é um instrumento gerencial que
...
---
   ...
   Aula 16
         ...
         competências individuais para a sua melhoria contínua.9
...
3.2 – Objetivos da Avaliação de Desempenho (Benefícios da Avaliação de
Desempenho)
...
Vejamos, a seguir, algumas das possibilidades que existem:
       ...
       avalia o seu próprio desempenho. Para isso, é necessário que existam alguns “padrões” ou
...
Aula 16
     ...
     participativa. O ideal é que o gestor seja “aberto” a receber feedbacks. Caso contrário, a
     ...
     custoso. Além disso, é necessário que o avaliado mantenha a mente “aberta” e “receptiva”
...
métodos que estudaremos a seguir:
       ...
       Listas de Verificação                                                   Ancoradas em
        ...
        Incidentes Críticos                 Avaliação de Competências
...
---
   ...
   Aula 16
                             ...
                             Métodos Tradicionais de Avaliação de Desempenho
                                                   ...
                                                   colunas) que tem por objetivo avaliar o desempenho dos indivíduos através
                         Escalas Gráficas
                                                  de “fatores de avaliação” pré-determinados aos quais são atribuídas “notas”
                                                                            previamente graduadas.

                                                  Consiste em um “check-list” realizado através de uma tabela padronizada na
                                                   qual consta uma lista de fatores que devem ser avaliados (considerados)
                       Listas de Verificação
                                                     pelo gestor no momento da avaliação. Funciona como uma espécie de
                                                                                  "lembrete".
...
Desempenho                                            altamente positivos (eficazes) ou altamente negativos (ineficazes).
                                                   ...
                                                   Os Métodos Comparativos, consistem na realização de comparações entre
                          Comparativos
                                                   dois indivíduos, ou então entre um indivíduo e o grupo a que ele pertence.
...
Desempenho                                          Etapas da
                     por Objetivos (APPO)             APPO
                      ...
                      Competências e de            competências necessárias à realização das tarefas, com base nos
...
Aula 16
                     ...
                     Outros Métodos Tradicionais de Avaliação de Desempenho
                      ...
                      Escalas de         método das escalas gráficas. Primeiro são identificados os elementos críticos do
                   ...
                   Comportamento            o comportamento real dos indivíduos no trabalho). Por fim, o avaliador dá
                                            ...
                                            Consiste na análise do desempenho de determinado indivíduo através da
                  Observação Direta
