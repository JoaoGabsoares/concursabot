...
ANÁLISE DE BALANÇOS - CONCEITOS BÁSICOS 

   1 - Resumo das principais rubricas contábeis 

       1.1 – O Balanço Patrimonial (BP) 

       1.2 – Demonstração de resultados - DRE 

       1.3 – Outros itens das demonstrações financeiras 

       1.4 – Resumo esquemático das principais contas, relevantes para a análise de balanços e administração
       financeira. 

   2 - Análise de balanços e indicadores 

       2.1 – Análise horizontal e vertical 

       2.2 – Análise de demonstrações financeiras por índices 
       ...
       2.2.4. – Graus de Alavancagem 

       2.2.5. –Capital de giro operacional e financeiro e Efeito Tesoura 

   3 - Avaliação de projetos de investimento por múltiplos e índices 

       3.1 – Múltiplos e índices utilizados para avaliar projetos de investimento/empresas 
...
para a análise financeira e valuation, e por que a gestão de caixa, estoques, recebíveis, necessidade de
capital de giro, alavancagem etc., dependem de um bom conhecimento das rubricas contábeis.
...
que também são bastante utilizados em administração financeira e finanças.
        ...
        qualquer aprofundamento nos CPCs, não falaremos de partidas dobradas e nem das
        regras de contabilização. É uma abordagem adotada na Administração Financeira, com
        foco mais gerencial e de apoio à gestão de caixa, orçamentação, cálculo de alavancagem
        etc.
...
as contas que estão no balanço patrimonial representam posições em determinado período do tempo
e não em determinado intervalo no tempo, como será visto no caso das receitas, despesas e resultados.
...
As definições apresentadas a seguir estarão sempre de acordo com os Pronunciamentos do Comitê de
Pronunciamentos Contábeis (CPC) e com as definições legais, pois são as mais abrangentes e mais atuais
disponíveis ao mercado em geral.
...
Os grupos de contas previstos pela LSA são (artigo 178):
...
contas.
       ...
       No ativo, as contas serão subdivididas do seguinte modo:
       ...
       companhia ou exercidos com essa finalidade, inclusive o fundo de comércio adquirido. (Pula diretamente
       do item IV para o item VI, na versão disponível no site WWW.planalto.gov.br).
...
No Passivo Exigível as contas serão subdivididas do seguinte modo:

       As obrigações da companhia, inclusive financiamentos para aquisição de direitos do ativo não
       circulante, serão classificadas no passivo circulante, quando vencerem dentro do exercício seguinte,
       e no passivo não circulante, se tiverem vencimento em prazo maior, observado a questão de seu
       ciclo operacional, como no caso do Ativo.

No Patrimônio Líquido as contas serão subdivididas do seguinte modo:
...
---
  ...
  Aula 01
       ...
       Já as reservas de capital referem-se: à contribuição do subscritor de ações que ultrapassar o valor
       nominal e a parte do preço de emissão das ações sem valor nominal que ultrapassar a importância
       destinada à formação do capital social, inclusive nos casos de conversão em ações de debêntures ou
       partes beneficiárias; o produto da alienação de partes beneficiárias e bônus de subscrição; o prêmio
       recebido na emissão de debêntures; as doações e as subvenções para investimento.
...
As Companhias Abertas publicam seus resultados trimestralmente.

Pela legislação (artigo 187), a demonstração do resultado do exercício discriminará:
...
---
  ...
  Aula 01
       ...
       § 1º do artigo 187: Na determinação do resultado do exercício serão computados:
...
período.
               ...
               (-) Deduções, abatimentos e impostos da Receita Bruta
               (=) Receita Líquida das Vendas e Serviços
               (-) Custo das mercadorias e serviços vendidos (CMV)
               (=) Lucro Bruto
               ...
               (+) Resultado Financeiro (não operacional)
...
aquelas relacionadas à operação do negócio, como, por exemplo, juros por compra a prazo de materiais
para o escritório.
...
Antes de prosseguirmos com os indicadores e as análises propriamente ditas, há um indicador que é
bastante usado em finanças e que não está previsto na LSA (apenas na instrução 527 da CVM), é o EBITDA,
em inglês “Earnings Before Interests, Taxas, Depreciation and Amortization”, ou em português, LAJIDA
“Lucro antes dos Juros, Imposto de Renda (incluindo Contribuição Social), Depreciação e Amortização”.
...
Os investimentos das Companhias em ativo imobilizado (máquinas, prédios etc.) e em ativo intangível
...
O LAJIDA procura captar o fluxo de caixa total da Companhia ANTES da destinação aos grupos de credores
e acionistas. A partir do lucro líquido devemos “devolver” os gastos com juros (credores), impostos
(governo) e depreciação e amortização (que não são desembolsos de caixa, de forma que estarão
disponíveis à Companhia.

A retirada dos impostos é óbvia, apesar de o governo não ser propriamente um credor, não “financiar” a
empresa, o imposto pago é irretratável, portanto não estaria disponível para nenhuma destinação, nem
para pagar credores, nem para dividendos aos acionistas.
...
têm interesses na estrutura da companhia.
        ...
        O aluno pode ter visto em outras aulas, inclusive minhas, essa questão do EBITDA ou
        outras questões contábeis. Isso é necessário, pois há muita interseção entre Finanças
        Corporativas, Administração Financeira e Contabilidade. É normal que os conteúdos
        sejam retomados, ou para apresentar outra abordagem, ou para relembrar conceitos.

1.4 – Resumo esquemático das principais contas, relevantes para a análise de balanços e
administração financeira.
...
Se, nos exemplos anteriores, soubéssemos que o endividamento no ano imediatamente anterior era de
44%, sabemos que a empresa se endividou mais (pois foi a 50%, conforme exemplo anterior). Se, por
hipótese, a margem bruta no ano anterior era de 25%, sabemos que a empresa aumentou seus custos e
diminuiu a sua margem para 20%.

Alguns autores fazem divisão entre Análise Financeira e Análise Econômica.
...
Finanças são, essencialmente, decisões sobre modelos de financiamento dos negócios da Companhia.
Envolverá decisões sobre emissão de ações, tomada de dívida, renegociações etc., de forma a buscar a
forma MAIS BARATA ou mais inteligente de financiar os negócios atuais e futuros das Companhias.

         Dessa forma, a análise financeira iria se ocupar da estrutura de capital da empresa.

         Já a análise econômica diria respeito aos resultados propriamente ditos, o quanto a
         Companhia consegue extrair de lucro de suas atividades.

         Outra abordagem comum em Administração financeira é que a análise econômica se dá
         por regime de competência (conforme a regra contábil), e a análise financeira se dá em
         regime de caixa.

Vejamos alguns exemplos de análise vertical e horizontal.

 ATIVO ANO 20XX                         %       PASSIVO ANO 20XX                      %
 ATIVO CIRCULANTE                               PASSIVO CIRCULANTE
 Caixa            e         4.000    11,94%     Contas a pagar              7.000   20,90%
 Equivalentes
 Contas a receber           6.500    19,40%     Salários a pagar            1.500   4,48%
 Antecipação        de      2.500     7,46%
 despesas
 TOTAL                    13.000    38,81%      TOTAL                       8.500   25,37%
 ATIVO NÃO CIRCULANTE                           PASSIVO           NÃO
                                                CIRCULANTE
 Realizável a longo         4.000    11,94%     Financiamento BNDES        18.000   53,73%
 prazo
 Investimentos              8.000    23,88%     TOTAL PNC                  18.000   53,73%
 Imobilizado                7.000    20,90%     PATRIMÔNIO
                                                LÍQUIDO
 Intangível                 1.000     2,99%     Capital social              6.400   19,10%
 Diferido                     500     1,49%     Reservas de lucro             600   1,79%
 TOTAL                    20.500    61,19%      TOTAL                       7.000   20,90%
 TOTAL ATIVO              33.500      100%      TOTAL PASSIVO              33.500   100%
...
Isso é o que chamamos de alavancagem financeira.

Vejamos agora um modelo de análise horizontal, aplicada a um demonstrativo de resultados (DRE):

                     ITENS (EM .000 REAIS)                           20X1         20X0           %
       RECEITA OPERACIONAL LÍQUIDA                                     42.000        35.000   20,00%
       (-) CMV                                                         22.000        16.000   37,50%
       (=) Lucro bruto                                                 20.000        19.000    5,26%
       (-) Despesas operacionais
        Administrativas                                                 4.000       6.500   -38,46%
        Comerciais                                                        500       1.200   -58,33%
        Financeiras                                                     4.400       2.200   100,00%
       (=) Lucro Operacional (LAJIR)                                     11.100       9.100   21,98%
       (+) RECEITAS FINANCEIRAS E + GANHOS                                3.000     - 1.000      ND
       (=) Lucro antes do Ir (LAIR)                                      14.100       8.100   74,07%
       (-) Provisão para o IR (34%)                                       4.794       2.754    74,07%
       (=) LUCRO LÍQUIDO DO EXERCÍCIO                                     9.306       5.346   74,07%
...
podem ser negativas ou positivas, a depender do balanço final de todas as movimentações financeiras
(sejam operacionais ou não).

A alta do lucro líquido foi de 74,07%.
...
Índices financeiros são aqueles que tratam da estrutura de capital (financiamento, capital próprio, capital
de terceiros etc.) e da estrutura de liquidez (capacidade de honrar os compromissos) da Companhia.
...
Os índices podem ser analisados de forma individual ou isolada, em comparação com indicadores-padrão
...
Os dados serão calculados com base nas informações a seguir:

            ATIVO CIRCULANTE                               PASSIVO CIRCULANTE
            Caixa e Equivalentes          4.000            Contas a pagar         7.000
            Contas a receber              6.500            Salários a pagar       1.500
            Estoques                      2.500
            TOTAL                      13.000              TOTAL                  8.500
            ATIVO NÃO                                      PASSIVO NÃO
            CIRCULANTE                                     CIRCULANTE
            Realizável a longo prazo      4.000            Financiamento BNDES   18.000
            Investimentos                 8.000            TOTAL PNC             18.000
            Imobilizado                   7.000            PATRIMÔNIO LÍQUIDO
            Intangível                    1.000            Capital social         6.400
            Diferido                       500             Reservas de lucro        600
            TOTAL                      20.500              TOTAL                  7.000
            TOTAL ATIVO                33.500              TOTAL PASSIVO         33.500
...
São índices que procuram medir a capacidade financeira da entidade.
...
Mede o quanto o ativo circulante é maior do que o passivo circulante.

Sua fórmula é:

                          𝐶𝐺𝐿 𝑜𝑢 𝐶𝐶𝐿 = 𝐴𝑡𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒 − 𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒

No exemplo temos:

                                        𝐶𝐺𝐿 = 13.000 − 8.500 = 4.500
...
Sua fórmula é:
                                           ...
                                           𝐶𝑎𝑖𝑥𝑎 𝑜𝑢 𝐸𝑞𝑢𝑖𝑣𝑎𝑙𝑒𝑛𝑡𝑒𝑠 𝑑𝑒 𝐶𝑎𝑖𝑥𝑎
                                   𝐼𝐿𝐼 =
                                                 𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒
...
É o índice que mede quanto do passivo circulante da Companhia estaria coberto pelo seu ativo circulante
“já vendido”, ou seja, sem os estoques. Um índice igual ou maior que 100% indicaria um equilíbrio
confortável nas obrigações correntes da Companhia (que vencem em menos de 1 ano), uma vez que
estariam cobertas MESMO sem novas vendas de estoques.
...
Sempre vale lembrar que os itens permanentes do ativo não circulante NÃO entram em índices de liquidez,
...
Tomemos os exemplos a seguir, para calcular os índices.

                                     ITENS (EM .000 REAIS)                  20X1
                       RECEITA OPERACIONAL LÍQUIDA                            42.000
                       (-) CMV                                                22.000
                       (=) Lucro bruto                                        20.000
                       (-) Despesas operacionais
                        Administrativas                                       4.000
                        Comerciais                                              500
                       (=) Lucro Operacional (LAJIR)                          15.500
                       (+) RECEITAS FINANCEIRAS E + GANHOS                    (3.000)
                       (=) Lucro antes do Ir (LAIR)                           12.500
                       (-) Provisão para o IR (34%)                             4.250
                       (=) LUCRO LÍQUIDO DO EXERCÍCIO                           8.250
...
---
  ...
  Aula 01
            ...
            ATIVO CIRCULANTE            20X1      20X0     PASSIVO CIRCULANTE    20X1     20X0
        ...
        O conhecimento desses índices é fundamental para a Administração Financeira de curto e
        longo prazos, pois é com base neles que se calcula tudo, desde o ciclo de caixa e a
        necessidade de capital de giro, até os graus de alavancagem da estrutura de capital.
...
Vamos adotar as médias.

No caso, o Patrimônio Líquido Médio seria de 6.700, Ativo Total médio seria de 32.400.

Costuma-se chamar esse índice de ROE, return on equity (em inglês).
...
Indica qual o retorno sobre o TODO o investimento da Companhia, uma vez que os ativos representam
todos recursos utilizados para gerar aquele lucro.
...
A empresa “gira” seu ativo 1,3 vez durante o ano.
...
empresa gira seu contas a receber em função das vendas. Dependerá do cálculo do contas a receber médio.

Sua fórmula é:

                                                               𝑅𝑒𝑐𝑒𝑖𝑡𝑎 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐿í𝑞𝑢𝑖𝑑𝑎
                   𝐺𝑖𝑟𝑜 𝑑𝑜 𝐶𝑅 (𝑡𝑢𝑟𝑛𝑜𝑣𝑒𝑟 𝑟𝑒𝑐𝑒𝑏í𝑣𝑒𝑖𝑠) =
...
A empresa “gira” seu contas a receber 7 vezes durante o ano.
...
Para calcular o prazo médio de recebimento, basta dividir 360 dias do ano pelo giro do CR.
     ...
     𝑃𝑟𝑎𝑧𝑜 𝑀é𝑑𝑖𝑜 𝑑𝑒 𝑅𝑒𝑐𝑒𝑏𝑖𝑚𝑒𝑛𝑡𝑜 =                                                 = 𝐴𝑝𝑟𝑜𝑥 52 𝑑𝑖𝑎𝑠
                                                  𝑇𝑢𝑟𝑛𝑜𝑣𝑒𝑟 𝑅𝑒𝑐𝑒𝑏í𝑣𝑒𝑖𝑠 (7)

Giro do Contas a Pagar (fornecedores) e Prazo Médio de Pagamento

Mede quantas vezes o contas a pagar (fornecedores) girou no período.

                                                                    𝐶𝑢𝑠𝑡𝑜𝑠 𝑑𝑎 𝑀𝑒𝑟𝑐 𝑉𝑒𝑛𝑑𝑖𝑑𝑎 𝑛𝑜 𝑝𝑒𝑟í𝑜𝑑𝑜
      𝑇𝑢𝑟𝑛𝑜𝑣𝑒𝑟 𝐶𝑜𝑛𝑡𝑎𝑠 𝑎 𝑃𝑎𝑔𝑎𝑟(𝑔𝑖𝑟𝑜 𝑑𝑎𝑠 𝑜𝑏𝑟𝑖𝑔𝑎çõ𝑒𝑠) =
                                                                     𝑐𝑜𝑛𝑡𝑎𝑠 𝑎 𝑝𝑎𝑔𝑎𝑟 𝑚é𝑑𝑖𝑜 𝑛𝑜 𝑝𝑒𝑟í𝑜𝑑𝑜
...
o seguinte:
                                            ...
                                            𝑁ú𝑚𝑒𝑟𝑜 𝑑𝑒 𝑑𝑖𝑎𝑠 𝑛𝑜 𝑝𝑒𝑟í𝑜𝑑𝑜 (360 𝑑𝑖𝑎𝑠)
      𝑃𝑟𝑎𝑧𝑜 𝑀é𝑑𝑖𝑜 𝑑𝑒 𝑃𝑎𝑔𝑎𝑚𝑒𝑛𝑡𝑜 =                                                 = 𝐴𝑝𝑟𝑜𝑥 98 𝑑𝑖𝑎𝑠
                                                𝑇𝑢𝑟𝑛𝑜𝑣𝑒𝑟 𝑂𝑏𝑟𝑖𝑔𝑎çõ𝑒𝑠 (3,7)

Giro dos Estoques e Período Médio no Estoque
...
(em todas as etapas) é o seguinte:
                                          ...
                                          𝑁ú𝑚𝑒𝑟𝑜 𝑑𝑒 𝑑𝑖𝑎𝑠 𝑛𝑜 𝑝𝑒𝑟í𝑜𝑑𝑜 (360 𝑑𝑖𝑎𝑠)
      𝑃𝑒𝑟í𝑜𝑑𝑜 𝑀é𝑑𝑖𝑜 𝑛𝑜 𝐸𝑠𝑡𝑜𝑞𝑢𝑒 =                                               = 𝐴𝑝𝑟𝑜𝑥 49,3 𝑑𝑖𝑎𝑠
                                                    𝑇𝑢𝑟𝑛𝑜𝑣𝑒𝑟 (7,3)
...
Sua fórmula é:
                       ...
                       𝑀𝐶 = 𝑃𝑟𝑒ç𝑜 𝑈𝑛𝑖𝑡á𝑟𝑖𝑜 𝑑𝑒 𝑉𝑒𝑛𝑑𝑎 − 𝐶𝑢𝑠𝑡𝑜 𝑣𝑎𝑟𝑖á𝑣𝑒𝑙 𝑢𝑛𝑖𝑡á𝑟𝑖𝑜
...
quando paga juros vira para o prejuízo, significa que o negócio é bom, mas a estrutura de capital não se
paga.
...
pagamento dos juros dos empréstimos (normalmente de longo prazo). Podemos usar o LAJIR ou EBIT, ou
o LAJIDA ou EBITDA.

O LAJIR já temos, é R$ 15.500. Supondo, por exemplo, que as despesas no ano com depreciação e
amortização tenham sido de R$ 500, o LAJIDA seria de R$ 16.000, uma vez que a depreciação e a
amortização não são desembolsos de caixa, portanto ficaria à disposição para pagar os juros da dívida.
...
Significa que a geração de caixa anual (medida pelo EBITDA) seria suficiente para pagar até 5,3 vezes o
serviço anual da dívida.

2.2.4. – Graus de Alavancagem

        IMPORTANTE!!! Graus de alavancagem dizem respeito mais à gestão de caixa e/ou
        gestão de estrutura patrimonial. É raro cair em provas exclusivas de análise balanços,
        EXCETO se isso estiver incluído no conteúdo de Administração GERAL ou FINANCEIRA.
        ...
        Administração Financeira, de forma que estudar apenas pelo material dessa matéria é
        suficiente.
...
Agora podemos calcular os graus de alavancagem. É fundamental termos as fórmulas bem decoradas!
                                                                 ...
                                                                 𝑉𝑎𝑟𝑖𝑎çã𝑜 % 𝑑𝑜 𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙
            𝐺𝑟𝑎𝑢 𝑑𝑒 𝐴𝑙𝑎𝑣𝑎𝑛𝑐𝑎𝑔𝑒𝑚 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐺𝐴𝑂 =
                                                                      𝑉𝑎𝑟𝑖𝑎çã𝑜 % 𝑑𝑎 𝑅𝑒𝑐𝑒𝑖𝑡𝑎

                                                           𝑀𝑎𝑟𝑔𝑒𝑚 𝑑𝑒 𝐶𝑜𝑛𝑡𝑟𝑖𝑏𝑢𝑖çã𝑜 (𝑝𝑎𝑡𝑎𝑚𝑎𝑟 𝑖𝑛𝑖𝑐𝑖𝑎𝑙)
     𝐺𝑟𝑎𝑢 𝑑𝑒 𝐴𝑙𝑎𝑣𝑎𝑛𝑐𝑎𝑔𝑒𝑚 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐺𝐴𝑂 =
                                                          𝐿𝑎𝑗𝑖𝑟 𝑜𝑢 𝑙𝑢𝑐𝑟𝑜 𝑜𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 (𝑝𝑎𝑡𝑎𝑚𝑎𝑟 𝑖𝑛𝑖𝑐𝑖𝑎𝑙)
...
Há ainda outra forma de escrever essa fórmula:

                                                                 𝐶𝑢𝑠𝑡𝑜𝑠 𝐹𝑖𝑥𝑜𝑠        400
      𝐺𝑟𝑎𝑢 𝑑𝑒 𝐴𝑙𝑎𝑣𝑎𝑛𝑐𝑎𝑔𝑒𝑚 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐺𝐴𝑂 = 1 +                                  =1+     = 3 𝑣𝑒𝑧𝑒𝑠
                                                               𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙     200

Alavancagem Financeira

No caso da alavancagem operacional, tratávamos de contas da demonstração de resultados, que são
essencialmente contas operacionais, da aplicação de ativos circulantes (estoques, salários, vendas etc.).
...
Quando se fala de alavancagem financeira estamos tratando de questões de estrutura patrimonial, de
ativos, passivos e patrimônio líquido.

Considere as seguintes variações de contas patrimoniais.
...
40% (400/1.000), na desejada será de 60% (600 de passivo, para 1.000 de ativos totais).
                     ...
                     𝐺𝑟𝑎𝑢 𝑑𝑒 𝐸𝑛𝑑𝑖𝑣𝑖𝑑𝑎𝑚𝑒𝑛𝑡𝑜 𝑎𝑡𝑢𝑎𝑙 =                         =       = 40%
                                                              𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙    1.000
                                                               ...
                                                               𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙    600
                   𝐺𝑟𝑎𝑢 𝑑𝑒 𝐸𝑛𝑑𝑖𝑣𝑖𝑑𝑎𝑚𝑒𝑛𝑡𝑜 𝑑𝑒𝑠𝑒𝑗𝑎𝑑𝑜 =                          =       = 60%
                                                                𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙    1.000
...
atual (considerando que não há imposto de renda, ou seja LAIR = Lucro Líquido), seriam:
                                            ...
                                            𝐿𝐴𝐼𝑅 = 𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜    140
                           𝑅𝑂𝐴 𝑎𝑡𝑢𝑎𝑙 =                           =       = 14%
                                                𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙        1.000

                                            𝐿𝐴𝐼𝑅 = 𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜 140
                           𝑅𝑂𝐸 𝑎𝑡𝑢𝑎𝑙 =                          =     = 23,3%
                                             𝑃𝑎𝑡𝑟𝑖𝑚ô𝑛𝑖𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜   600

O ROE e ROA para a nova situação de estrutura patrimonial, seria:

                                           𝐿𝐴𝐼𝑅 = 𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜    110
                            𝑅𝑂𝐴 𝑛𝑜𝑣𝑎 =                          =       = 11%
                                               𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙        1.000

                                            𝐿𝐴𝐼𝑅 = 𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜 110
                            𝑅𝑂𝐸 𝑛𝑜𝑣𝑎 =                          =     = 27,5%
                                             𝑃𝑎𝑡𝑟𝑖𝑚ô𝑛𝑖𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜   400

Perceba que, mesmo com uma QUEDA no lucro, há um aumento nos ganhos sobre o patrimônio líquido (de
23,3% para 27,5%).

        Já deu para entender que aumentar o endividamento, pode aumentar a lucratividade
        (retorno) do acionista. E como se calcula a alavancagem?
...
operacional e com a variação da Receita:
                                                                ...
                                                                𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 + 𝐶𝑢𝑠𝑡𝑜𝑠 𝐹𝑖𝑥𝑜𝑠
            𝐺𝑟𝑎𝑢 𝑑𝑒 𝐴𝑙𝑎𝑣𝑎𝑛𝑐𝑎𝑔𝑒𝑚 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐺𝐴𝑂 =
                                                                       𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙
...
A alavancagem combinada significa a multiplicação de ambas, como o lucro operacional no numerador e
no denominador serão cancelados (multiplicação por 1), a fórmula da alavancagem combinada fica:

                                                           𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 + 𝐶𝑢𝑠𝑡𝑜𝑠 𝐹𝑖𝑥𝑜𝑠
            𝐺𝑟𝑎𝑢 𝑑𝑒 𝐴𝑙𝑎𝑣𝑎𝑛𝑐𝑎𝑔𝑒𝑚 𝐶𝑜𝑚𝑏𝑖𝑛𝑎𝑑𝑎 =
                                                         𝐿𝑢𝑐𝑟𝑜 𝑜𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 − 𝐷𝑒𝑠𝑝𝑒𝑠𝑎 𝑐𝑜𝑚 𝑗𝑢𝑟𝑜𝑠

Vejamos um novo exemplo, envolvendo ambos os graus de alavancagem.
...
Mostrando os cálculos:
                             ...
                             𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 + 𝐶𝑢𝑠𝑡𝑜𝑠 𝐹𝑖𝑥𝑜𝑠 200 + 400
                    𝐺𝐴𝑂 =                                    =          = 3,00
                                    𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙            200

                                      𝐿𝑢𝑐𝑟𝑜 𝑜𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙             200
                   𝐺𝐴𝐹 =                                         =         = 1,82
                            𝐿𝑢𝑐𝑟𝑜 𝑜𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 − 𝐷𝑒𝑠𝑝𝑒𝑠𝑎 𝑐𝑜𝑚 𝑗𝑢𝑟𝑜𝑠 200 − 90

O GAC é a multiplicação dos dois, mas há outra forma de ver, que nos indica o significado do grau de
alavancagem combinado.

                      𝑀𝑎𝑟𝑔𝑒𝑚 𝑑𝑒 𝐶𝑜𝑛𝑡𝑟𝑖𝑏𝑢𝑖çã𝑜 600
             𝐺𝐴𝐶 =                          =     = 5,45 = 𝐺𝐴𝐹 × 𝐺𝐴𝑂 = 1,82 × 3,00
                         𝑀𝑎𝑟𝑔𝑒𝑚 𝐿í𝑞𝑢𝑖𝑑𝑎       110
...
2.2.5. –Capital de giro operacional e financeiro e Efeito Tesoura
         ...
         Mais uma questão comum a Administração Financeira (Gestão de Caixa) e Análise de
         Balanços. O conteúdo em Administração Financeira é mais robusto, se o aluno já tiver
         estudado isso nessas aulas (se o concurso pedir ambos os temas em Administração Geral),
         pode ir diretamente para os exercícios.
...
Neste ponto, vamos analisar os conceitos de ativo circulante operacional, ativo circulante financeiro,
passivo circulante operacional, passivo circulante financeiro, passivo permanente e ativo permanente.
...
IMPORTANTE!!! Avaliação por múltiplos e índices costuma estar associada a Finanças Corporativas, mais
do que à Análise de Balanços. Caso o edital do concurso não esteja pedindo explicitamente cálculo do valor
do projeto por múltiplos, a chance de cair é pequena, portanto essa parte poderá ser preterida em favor de
...
seu preço de mercado e seu patrimônio ficaria bem baixa.
         ...
         empresa. Uma empresa com P/VP igual a 1, por exemplo, teria um valor de mercado
         IGUAL ao valor do patrimônio líquido.

Uma empresa com P/VP igual a 0,4 teria um preço de mercado que valeria apenas 40% do patrimônio
líquido. Se o patrimônio líquido for realmente realizável (der para vender os ativos, quitar as dívidas e sobrar
o que está no balanço), seria melhor comprar a empresa e vender seus ativos.
...
P/VPA também é um indicador de estresse. Quando o mercado desaba, às vezes empresas sólidas ficam
com preço de mercado muito abaixo de seu patrimônio.

Preço/Lucro (P/L ou P/LPA)
...
Veja alguns exemplos com dados passados:
...
qual seria o ganho previsto, já descontando o IR? Daria pouco mais de 10%, para arredondar 10% (para
2022).
...
Um parêntese. Quase todos consideram que é bom para a bolsa quando os juros caem. Um dos motivos
para essa percepção é que a opção “sem risco” dos investidores fica menos atraente, ou seja, seu P/L da
renda fixa aumenta (leva mais tempo para retornar), permitindo que se pague um pouco mais pela opção
em renda variável, ou seja, pelas ações em bolsa.
...
---
  ...
  Aula 01
       ...
       Nesse caso não se aplica o conceito P/L. Se a empresa vinha de lucros crescentes e, por algum
       motivo, começou a dar prejuízo, devem-se estudar esses motivos para avaliar se ainda se pode
       confiar no fluxo futuro de lucros, pois se não voltarem, a cotação será penalizada no futuro. Os riscos
       de investir em empresas com prejuízos recorrentes são maiores. É melhor deixar para o campo da
       especulação.).

Avaliando empresas pelo P/L

       Imagine uma empresa varejista que não tem ações na bolsa. Não sabemos, portanto, qual o seu
       preço de mercado. Porém, se soubermos que a média dos índices Preço/Lucro dos varejistas com
       perfil semelhante listados na bolsa de valores é de 15,4, basta pegarmos o lucro dessa empresa que
...
EV/EBITDA (FV/EBITDA) – Enterprise (or firm) Value / EBITDA

Também é um índice comparativo, que pode ser usado inclusive para diferentes países.

O EBITDA, no Brasil conhecido como LAJIDA é o Lucro antes dos impostos, juros, depreciação e
amortização. Ele tem um significado interessante, seria o fluxo de caixa gerado pela empresa que estaria
disponível tanto para credores quanto para acionistas. É entendido com a geração de caixa da empresa.
...
políticas tributárias de cada país, que afetam bastante os lucros. Também é usado para encontrar
candidatos para fusões e aquisições. Uma empresa com um múltiplo baixo pode ser vista como um bom
candidato a aquisição.
...
Para calcular o valor de uma empresa pelo EV/EBITDA, segue-se a mesma lógica do P/L. Procura-se o
múltiplo médio de empresas semelhantes à que queremos analisar e o multiplicamos pelo EBITDA.
...
Índice de payout nada mais é do que o percentual do lucro líquido que é distribuído a título de dividendos.
                                         ...
                                         𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑𝑜 𝐷𝑖𝑠𝑡𝑟𝑖𝑏𝑢í𝑑𝑜 𝑜𝑢 𝐷𝑒𝑐𝑙𝑎𝑟𝑎𝑑𝑜 𝑛𝑜 𝑃𝑒𝑟í𝑜𝑑𝑜
                   Í𝑛𝑑𝑖𝑐𝑒 𝑑𝑒 𝑃𝑎𝑦𝑜𝑢𝑡 =
                                               𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜 𝐴𝑗𝑢𝑠𝑡𝑎𝑑𝑜 𝑑𝑜 𝑃𝑒𝑟í𝑜𝑑𝑜
...
empresa.
                                  ...
                                  𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑𝑜 𝐷𝑖𝑠𝑡𝑟𝑖𝑏𝑢í𝑑𝑜 𝑜𝑢 𝐷𝑒𝑐𝑙𝑎𝑟𝑎𝑑𝑜 𝑛𝑜 𝑃𝑒𝑟í𝑜𝑑𝑜 𝑝𝑜𝑟 𝐴çã𝑜
            𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑 𝑌𝑖𝑒𝑙𝑑 =
                                            𝑉𝑎𝑙𝑜𝑟 𝑃𝑎𝑔𝑜 𝑝𝑒𝑙𝑎 𝐴çã𝑜 𝑑𝑎 𝐸𝑚𝑝𝑟𝑒𝑠𝑎

Considere que a Companhia Siderúrgica Nacional tenha apurado um lucro líquido de R$ 13,6 bilhões em
2021 e tenha distribuído R$ 6,8 bilhões a título de dividendos. Qual o índice de payout?

                                            𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑𝑜 𝑛𝑜 𝑃𝑒𝑟í𝑜𝑑𝑜     6,8
                    Í𝑛𝑑𝑖𝑐𝑒 𝑑𝑒 𝑃𝑎𝑦𝑜𝑢𝑡 =                             =     = 0,5 = 50%
                                           𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜 𝑛𝑜 𝑃𝑒𝑟í𝑜𝑑𝑜 13,6
...
equivalente a R$ 2,25 por ação a título de dividendos. Qual o Dividend Yield?
                                           ...
                                           𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑𝑜 𝑝𝑜𝑟 𝐴çã𝑜        2,25
              𝐷𝑖𝑣𝑖𝑑𝑒𝑛𝑑 𝑌𝑖𝑒𝑙𝑑 =                                     =      = 0,3 = 30%
                                    𝑉𝑎𝑙𝑜𝑟 𝑃𝑎𝑔𝑜 𝑝𝑒𝑙𝑎 𝐴çã𝑜 𝑑𝑎 𝐸𝑚𝑝𝑟𝑒𝑠𝑎 7,50
...
EVA – Economic Value Added – Valor Econômico Adicionado - Custo de Oportunidade

        EVA é algo comum a três matérias: Finanças, Administração Financeira e Contabilidade. É
        mais comum em provas de finanças, mas, como veremos nos exercícios, também cai em
        análise de demonstrações financeiras, gestão de estrutura patrimonial e retorno sobre
        investimentos.

        Devo estudar? Se seu concurso for só de Análise de Demonstrações Financeiras (dentro de
        Administração financeira e não de Contabilidade), só é provável que caia se estiver
        explícito no edital. Se for um concurso envolvendo também administração financeira de
        longo prazo, é possível que caia, mesmo sem explicitar (ainda que seja raro). Porém os
        conteúdos são parecidos, se já estudou isso em Administração Financeira, pode ir direto
        para os exercícios em Análise de Balanços, e vice-versa.
...
Mas e se o uso alternativo desse R$ 1 milhão fosse, por exemplo, ser aplicado em um fundo de renda
fixa com retorno de R$ 120 mil por ano?
...
A fórmula básica do Valor Econômico Agregado é:

                    𝐸𝑉𝐴 = 𝑁𝑂𝑃𝐴𝑇 − (𝐶𝑢𝑠𝑡𝑜 𝑑𝑒 𝐶𝑎𝑝𝑖𝑡𝑎𝑙 × 𝐼𝑛𝑣𝑒𝑠𝑡𝑖𝑚𝑒𝑛𝑡𝑜 𝑑𝑒 𝐶𝑎𝑝𝑖𝑡𝑎𝑙)
...
Quanto ao custo de capital, veremos adiante, costuma ser usado o WACC, custo médio ponderado de
capital, por ser considerado o RETORNO MÍNIMO exigido por aquela estrutura de capital (parte de
acionistas, parte de credores).
...
---
  ...
  Aula 01
                              ...
                              𝐸𝑉𝐴 = (𝑅𝑂𝐼% − 𝑊𝐴𝐶𝐶%) × 𝐴𝑡𝑖𝑣𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙
...
investido (R$ 40.000), é simples calcular o EVA:
               ...
               𝐸𝑉𝐴 = 𝐿𝑢𝑐𝑟𝑜 𝑂𝑝𝑒𝑟𝑎𝑐𝑖𝑜𝑛𝑎𝑙 𝐴𝑃Ó𝑆 𝑜 𝐼𝑅 − (𝐶𝑎𝑝𝑖𝑡𝑎𝑙 𝐼𝑛𝑣.× 𝐶𝑢𝑠𝑡𝑜 𝑑𝑒 𝑂𝑝𝑜𝑟𝑡. )

                                     𝐸𝑉𝐴 = 200.000 − 40.000 = 160.000
...
1) 2022 / Banca: CESPE / SECONT-ES

Os dados a seguir foram extraídos da contabilidade de determinada entidade.
...
O indicador de endividamento geral da entidade cresceu mais de 7% no período em análise.
...
2) 2022 / Banca: Avança SP / Câmara Municipal de Sorocaba - Analista Orçamentário e Financeiro

O giro do ativo indica:

A.        o retorno da empresa com o nível de investimentos.
B.        a o retorno obtido sobre o Capital Próprio.
C.        a comparação do lucro obtido com o volume de vendas do período.
D.        a valorização do lucro do acionista sobre o investimento.
E.        quanto a empresa vendeu para cada $1,00 de investimento total.
...
D.       proporção entre ativo circulante e passivo circulante;
E.       necessidade de capital de giro operacional líquido.

4) 2021 / Banca: FUNDATEC / FUNDATEC - 2021 - Prefeitura de Ivoti - RS – Contador
...
5) 2022 / Banca: CESPE / CEBRASPE / Telebras - Especialista em Gestão de Telecomunicações – Contador

ACC – Ativo Circulante Cíclico / ACF – Ativo Circulante Financeiro / ANC – Ativo Não Circulante / PCC –
Passivo Circulante Cíclico / PCF – Passivo Circulante Financeiro / PNC – Passivo Não Circulante / PL –
Patrimônio Líquido

OBS: O ANC é todo representado por direitos a receber a longo prazo.
...
6) 2021 / Banca: CESPE / CEBRASPE / AL-CE - Analista Legislativo - Ciências Contábeis

O evento que provoca o aumento do giro dos estoques de uma empresa comercial é:

A.        o aumento da participação de itens obsoletos no estoque.
B.        a redução dos prazos médios de recebimento das vendas efetuadas a prazo.
C.        a elevação dos níveis de estoques mantidos pela empresa.
D.        a redução da participação das vendas a prazo nas vendas totais da empresa.
E.        o aumento da quantidade de mercadorias vendidas.

7) 2021 / Banca: CESPE / CEBRASPE / AL-CE - Analista Legislativo - Publicidade e Propaganda

O fato de uma empresa apresentar um índice de endividamento de 70% indica que:

A.        o grau de endividamento da empresa é baixo.
B.        a empresa possui boa rentabilidade.
C.        a empresa está excessivamente imobilizada.
D.        a participação dos recursos próprios nos investimentos da empresa é de 70%.
E.        a participação do capital próprio nos investimentos da empresa é de 30%.

8) 2022 / Banca: FUNDATEC / IPE Saúde - Analista de Gestão em Saúde - Contabilidade
...
9) 2022 / Banca: Quadrix / CRF-GO - Contador
...
O índice de endividamento geral da empresa ao final de 2020 era de 0,60, o que evidencia que seu
patrimônio líquido era positivo nessa data.

       Certo
       Errado

10) 2022 / Banca: Quadrix / CRF-GO - Contador
...
O retorno sobre o capital próprio no exercício ficou abaixo de 20%.

      Certo
      Errado

11) 2022 / Banca: Quadrix / CRF-GO - Contador
...
12) 2021 / Banca: FUNDATEC / PGE-RS - Analista Contador
...
Comparando-se as demonstrações contábeis de dois exercícios e os respectivos índices de rentabilidade dos
capitais próprios, chegou-se à conclusão de que o índice do segundo ano foi menor que o do primeiro. Entre
os eventos relacionados a seguir, qual deles pode ter contribuído para tal redução?

A.       A aquisição, à vista, de ações de outra companhia.
B.       A compra, a prazo, de bens para o ativo imobilizado.
C.       A quitação de empréstimo de curto prazo.
D.       A realização (integralização) de capital em dinheiro.
E.       A reclassificação de dívida de longo para curto prazo.

13) 2021 / Banca: Instituto Consulplan / TJM-MG - Analista Judiciário - Contador
...
14) 2021 / Banca: IADES / CAU - MS - Contador
...
rentabilidade como boa ou ruim. Se uma empresa projeta um lucro de R$ 5 milhões, com um índice
dívida/PL de 0,65 e um Return on Assets (ROA) de 12,0%, então significa que seus proprietários podem
esperar por uma taxa de retorno sobre o patrimônio líquido (TRPL) igual a
...
E.       24,0%.
           ...
           Questões gerais mais antigas e de bancas variadas (tipos diferentes de questões)

15) ESAF - Analista Técnico da SUSEP/Controle e Fiscalização - Atuária/2006
...
16) CESPE - Perito Criminal Federal/Área 1/1997
...
17) CESPE - Analista Judiciário (TRE RJ) /Administrativa/ Contabilidade/2012
...
18) CEPERJ - Analista de Controle Interno (SEFAZ RJ)/2012/
...
19) FCC - Analista Judiciário (TRT 6ª Região)/Administrativa/Contabilidade/2012/
...
20) FCC - Técnico Judiciário (TRF 4ª Região)/Apoio Especializado/Contabilidade/2014/
...
21) CESGRANRIO - Profissional Básico (BNDES)/Contabilidade (Ciências Contábeis)/2011
...
22) VUNESP - Profissional Básico (BNDES)/Contabilidade (Ciências Contábeis)/2001
...
Com base nessas informações, o Investimento Operacional em Giro (IOG) da companhia é, em R$
...
23) FCC - Analista Judiciário (TRT 4ª Região)/Apoio Especializado/Economia/2006/
...
24) FUNRIO - Analista Técnico-Administrativo (MJ)/2009/
...
25) FUNDATEC - Auditor do Estado (CAGE RS)/2014/
                                                        ==219a34==
...
26) FGV - Analista da Defensoria Pública (DPE RO)/Analista Contábil/2015/
...
que pagar o fornecedor, portanto teríamos necessidade de capital de giro negativa. Item D.

27) 2021 / Banca: CESPE / CEBRASPE / TC-DF - Auditor Conselheiro Substituto
...
28) 2022 / Banca: FGV / CGU - Auditor Federal de Finanças e Controle
...
29) 2021 / Banca: CESPE / CEBRASPE / TC-DF - Auditor Conselheiro Substituto
...
Caso utilize o valor econômico agregado (EVA) como medida de análise para a tomada de decisão, a
empresa deverá optar por não vender a unidade de fretes.

         Certo
         Errado

30) 2021 / Banca: CESPE / CEBRASPE / TC-DF - Auditor Conselheiro Substituto
...
Optamos por não negritar a resposta certa, pois há alunos que vem direto ao gabarito para estudar.
...
Essa questão tem um erro no ano X1, pois o Passivo Circulante deveria ser 690 e não 590 (somatório de 310 com
380). Vamos usar o 590, pois é o que fecha a conta com o passivo total (590 + 1.000 + 1.207)

                                      𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒 + 𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝑁ã𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒
                              𝐼𝐸𝐺 =
                                                      𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙

Ativo total Xo = Passivo Total X0 = 1.676

Passivo exigível total Xo = 370 + 510 = 880

                                                           800
                                                𝐼𝐸𝐺0 =          = 52,5%
                                                          1.676

Ativo total X1 = Passivo Total X1 = 2.797

Passivo exigível total X1 = 590 + 1.000 = 1.590
...
C) errado, pois não compara lucro

D) errado, pois não compara retorno com o investimento do acionista (patrimônio líquido)

E) correto, pois pega a receita (o quanto vendeu) e divide pelo ativo total (investimento total), se vendeu 10.000
para um ativo de 5.000, o GA vai ser 2, ou seja, 2 reais vendidos para cada 1 real de ativo total. Resposta E.
...
questão desse tipo. Se está dizendo que o ILC é igual, a coisa mais importante a fazer é colocar a fórmula do ILC
na nossa frente.
...
circulante, pois essa é a definição do ILC. Resposta D
...
Aqui o importante é primeiro entender que estamos falando de índice de rentabilidade, o que já exclui o item E.

Se estamos falando de unidade monetária que restou, estamos falando de comparações com a Receita Líquida,
ou seja, de MARGEM. Logo item B está fora, pois compara lucro com patrimônio líquido.

Das três margens que sobraram, a margem de contribuição é calculada após retirar os custos variáveis apenas,
a margem bruta refere-se ao lucro bruto, retirando custos totais da mercadoria, inclusive fixos, mas AMBAS não
tiram impostos e demais despesas.

A única margem que trabalha com o lucro líquido, que retira todas as despesas e impostos, é a margem líquida.
Resposta A
...
Para aumentar o giro de estoques temos 2 caminhos, aumentar o custo da mercadoria vendida total (que está
relacionado a QUANTO vendemos), ou à redução do estoque médio.

O item A não aumenta as vendas e tende a aumentar o prazo médio do estoque, pois item obsoleto não vende
bem.

B trata de recebimento, nada a ver com giro de estoques.

C está errada, pois fala de aumentar os estoques, o que reduziria o giro.
...
E está certa, pois se aumentarmos as vendas, aumentaremos os custos totais e o giro seria maior. Resposta E.
...
Primeira coisa SEMPRE! Identificar a fórmula.
...
B está errada, pois não dá para afirmar nada sobre a rentabilidade.

C está errada, pois nada sabemos sobre ativos imobilizados.

D está errada, pois confunde capital próprio com de terceiros na fórmula.
...
Deve-se iniciar colocando as fórmulas à vista.
...
Item I está correto, pois é a leitura da fórmula do ILI.

Item II está errado, pois o ILG considera também itens de longo prazo.

Item III está certo, pois o ILG tira os estoques do ativo circulante. Resposta D
...
Aqui o caso é saber o tamanho do ativo total e do passivo exigível.

Ativo total é tudo o que representa aplicação dos recursos da empresa: circulante, investimentos, imobilizado e
intangível.

No caso, o ativo total seria 5.500 + 2.500 + 3.000 + 1.500 = 12.500
...
disponibilidades de curto prazo (recebíveis até o exercício seguinte) é maior do que os exigíveis de curto prazo
(vencíveis até o exercício seguinte).
...
O que pode fazer o índice ficar menor?

A) a aquisição de ações de outra companhia altera apenas a composição do ativo.

B) A compra a prazo de bens aumenta o passivo e o imobilizado.

C) quitar empréstimo de curto prazo altera o caixa e o passivo circulante.
...
Pela fórmula
                  ...
                  𝐶𝐺𝐿 = 𝐴𝑡𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒 − 𝑃𝑎𝑠𝑠𝑖𝑣𝑜 𝐶𝑖𝑟𝑐𝑢𝑙𝑎𝑛𝑡𝑒 = 5.000 − 3.500 = 1.500

Se pode ter 300% do CGL, será 4.500. Resposta D.
...
Sabemos que o retorno sobre o ativo é de 12%, e sabemos o lucro projetado de 5 MM.
                                               ...
                                               𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜           5𝑀𝑀
                                    𝑅𝑂𝐴 =                      = 12% =
                                             𝐴𝑡𝑖𝑣𝑜 𝑇𝑜𝑡𝑎𝑙 𝑀é𝑑𝑖𝑜         𝐴𝑡𝑖𝑣𝑜

O ativo vai ser 5MM / 0,12 = 41,6MM

A dívida é igual a 0,65 do PL, portanto o ativo TOTAL é igual ao PL + a dívida (0,65PL) = 1,65 PL

Se o ativo é 41,6 MM e é igual a 1,65 do PL, o PL é 25,25 MM

                                           𝐿𝑢𝑐𝑟𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜        5𝑀𝑀
                            𝑅𝑂𝐸 =                            =        = 19,8%
                                     𝑃𝑎𝑡𝑟𝑖𝑚ô𝑛𝑖𝑜 𝐿í𝑞𝑢𝑖𝑑𝑜 𝑀é𝑑𝑖𝑜 25,25𝑀𝑀
...
O índice de endividamento padrão, definido pela CVM na RCVM 80/22, não é o que o enunciado trata, ele divide
...
de adiantamentos pagos a fornecedores mantém MAIS caixa. Resposta A.
...
É uma questão que trata da NECESSIDADE LÍQUIDA de Capital de Giro Operacional (investimento
operacional em giro). Essa conta, muito comum em finanças, exclui do Ativo Circulante e do Passivo
Circulante o caixa (que já é líquido, portanto não estará mais relacionado à parte operacional da empresa) e
recebíveis que não estão relacionados com a operação e do Passivo circulante os itens que não tem a ver
com o financiamento direto das operações.
...
Dividendos a pagar NÃO é despesa operacional, é distribuição de lucro. Resposta B.
...
operacional é (R$ 17.000 – R$ 16.000) R$ 1.000. Resposta B.
...
Do nosso material: Podemos entender o P/L como uma medida do “apetite” do investidor por comprar as ações.
Se este vem se elevando, é porque os investidores estão pagando mais “caro” pelas ações do que anteriormente,
seja por que suas opções fora da renda variável estão menos atraentes, seja por que ele acredita que o lucro da
empresa crescerá fortemente nos próximos anos. Em resumo, o P/L indicaria em quantos anos eu retornaria o
meu investimento, caso o lucro da empresa não subisse.
...
Aqui precisamos colocar ambas as fórmulas.
...
No caso, o item A está errado, pois ter despesas superiores a receitas na DRE pode não gerar nem prejuízo, uma
vez que pode haver lucro contábil proveniente de outras áreas.
...
qualquer um desses NEGATIVO, também não significa que teremos lucro contábil negativo (apesar de ser muito
provável).
...
Dei essa longa explicação, mas o aluno, por praticidade, deveria ter avaliado primeiramente o item E, pois é o
único que traz algo sobre NOPAT e EVA. Resposta E.
...
Já o investimento de capital, em termos de MERCADO, é a avaliação feita pela contabilidade, 15 milhões. E o
custo de capital é 17%. Basta substituir na fórmula.

                           𝐸𝑉𝐴 = 2 𝑚𝑖𝑙ℎõ𝑒𝑠 − (17% × 15 𝑚𝑖𝑙ℎõ𝑒𝑠) = −550 𝑚𝑖𝑙
...
sabíamos como a empresa se financiava (se esses 17% eram um mix entre custo de capital próprio e de terceiros).
Agora ele AFIRMA que é tudo capital de terceiros. Nesse caso, o custo dos juros seria de 17% x 15.000.000 =
2.550.000.
