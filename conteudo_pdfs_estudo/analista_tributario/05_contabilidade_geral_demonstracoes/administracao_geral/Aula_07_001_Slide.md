...
---
   ...
   de detentores de direitos sobre o patrimônio.
              ...
              Aumentos           OU          Redução nos                           Contribuições
                                                                                                   RECEITAS
              de ativos                        passivos                            de detentores
...
---
 ...
 Despesas
 DESPESAS são reduções nos ativos, ou aumentos nos passivos, que resultam
 em reduções no patrimônio líquido, exceto aqueles referentes a distribuições
 aos detentores de direitos sobre o patrimônio.


                                              Aumentos
           Reduções             OU                                                     Distribuição
                                                 nos                                                   DESPESAS
           de ativos                                                                  aos detentores
                                               passivos
...
---
     ...
     A DRE é a demonstração contábil que apresenta a confrontação entre receitas
     e despesas da entidade.


     Objetiva evidenciar a situação econômica da entidade, medindo               o
     desempenho da entidade.
     Procura evidenciar a composição do resultado gerado (lucro ou prejuízo) em
     um determinado período (geralmente um ano) a partir das operações da
     entidade.
...
---
 ...
 (-) abatimentos concedidos e descontos incondicionais (comercial)
 ...
 (=) Resultado Operacional Bruto (LOB)
...
---
 ...
 (-) Imposto de Renda (IR)
 (=) Resultado do Exercício antes das Participações (REAP)
 (-) Participações
     Debêntures
     Empregados
     Administradores
 ...
 (=) Resultado Líquido do Exercício (RELEx)
...
---
 ...
 Não confunda os descontos incondicionais (comerciais) com os
...
---
    ...
    Descontos Incondicionais (comerciais): ocorrem no momento da compra
    (obtidos) ou da venda (concedidos), sendo destacados na própria nota fiscal. A
    palavra “incondicional” denota ausência de condições impostas ao cliente para
    que tivesse direito ao desconto.

                         Descontos Incondicionais Obtidos = redutora do CMV
            Descontos Incondicionais Concedidos = redutora da Receita de Vendas


  Descontos Condicionais (financeiros): ocorrem no momento da liquidação de
  uma dívida ou do recebimento de um direito, fato posterior à compra ou à
  venda. O desconto financeiro só ocorre mediante condição imposta ao
  devedor (geralmente quitação antes da data do vencimento). São
...
---
 ...
 operacional, as deduções das vendas e o custo das mercadorias
 vendidas são subtraídos diretamente da receita bruta de vendas.
...
Outras Receitas e Outras Despesas
 ...
 Compreendem os ganhos e perdas decorrentes das baixas de bens ou
 de direitos classificados nos grupos investimentos, imobilizado e
 intangível. Refere-se às antigas “Receitas Não Operacionais” e
...
---
 ...
 Se uma empresa vender um ativo imobilizado, ela deverá reconhecer
 seu resultado — ganho ou perda — como resultado não operacional.
...
Participações
Correspondem a parcelas do resultado do exercício destinadas aos proprietários
de debêntures, a empregados, a administradores, aos proprietários de partes
beneficiárias e a instituições ou fundos de assistência ou previdência de
empregados.

Base de Cálculo → resultado do exercício após as deduções, diminuído dos
prejuízos acumulados e acrescido dos Juros sobre Capital Próprio
...
---
 ...
 Art. 190. As participações estatutárias de empregados,
 administradores e partes beneficiárias serão determinadas,
 sucessivamente e nessa ordem, com base nos lucros que
 remanescerem depois de deduzida a participação anteriormente
 calculada.
...
---
  ...
  Ordem das Participações
       ...
       Contribuição p/ Fundos Assistência e Previdência Social dos empregados
                     ...
                     “Dedicação Exclusiva Até a Prova Final”
...
---
  ...
  Participações
   No cálculo das participações, retira-se os prejuízos acumulados. Porém,
   na DRE o prejuízo não entra. Na DRE fica:
...
---
 ...
 A compensação do prejuízo acumulado deverá ser demonstrada na
 apuração do resultado do exercício, após a dedução do imposto de
 renda e da contribuição social sobre o lucro.
...
---
 ...
 Questão de Prova
 A Empresa Cariacica S/A apresentou as seguintes informações extraídas do
...
---
 ...
 Com base nessas informações, nos termos da Lei nº 6.404/1976 e suas alterações,
 o Lucro Líquido do Exercício apresentará um valor, em reais, de
 a) 236.196,00.
 b) 256.671,50.
 c) 226.960,00. Resultado antes das Participações        400.000,00
                   (-) Prejuízos Acumulados              (50.000,00)
 d) 220.000,00     (=) Base de cálculo das participações 350.000,00
...
---
      ...
      + Variações monetárias ativas                                               (=) Resultado antes dos tributos sobre o lucro
      + Receitas de aluguel                                                       (-) Despesa com tributos sobre o lucro
      + Dividendos recebidos (investimentos avaliados pelo custo)                 (=) Resultado Líquido das Operações Continuadas
      (=) Resultado Operacional Líquido                                           (+/-) Resultado líquido das operações descontinuadas
      (+) Outras Receitas                                                         (=) Resultado Líquido do Período
      (-) Outras Despesas
      ...
      (÷) número de ações
@profgilmarpossati         do capital social
                        @canalcontabilizando
...
---
 ...
 As despesas podem ser classificadas na demonstração do resultado
 do exercício de acordo com sua natureza ou função.
...
---
 ...
 ✓ Confrontação de receitas e despesas

       Receitas – R$ 1.000,00
       Despesas – R$ 800,00
       Logo, o resultado do exercício será de R$ 200,00 (1.000,00 – 800,00)
...
---
 ...
 1º) Elaboração do Balancete de Verificação;

 2º) Transferência dos saldos das contas de receitas e despesas para
 a conta transitória “Apuração do Resultado do Exercício – ARE” e
 apuração do saldo.
...
---
 ...
 3º) Transferência do saldo da conta “ARE” para uma conta do PL;
