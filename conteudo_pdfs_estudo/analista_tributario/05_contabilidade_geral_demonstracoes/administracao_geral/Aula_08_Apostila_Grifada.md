...
aula_numero: 08
titulo_aula: OPERAÇÕES COM MERCADORIAS
---
...
1. Fatores que alteram valores de compra e venda, forma de registro e apuração do CMV 

   1.1. Apuração do CMV e Fatores que Alteram o Valor das Compras 

      1.1.1. Apuração do CMV 

      1.1.2. Fatores que alteram o valor das compras 

   1.2. Fatores que Alteram o Valor das Vendas 

2. Tributos Incidentes sobre Compras e Vendas 

   2.1. Aspectos Introdutórios 

   2.2. Tributos incidentes sobre Compras e Vendas 

      2.2.1. ICMS 

      2.2.2. Contabilização do ICMS 

      2.2.3. IPI 

      2.2.4. Contabilização do IPI 

      2.2.5. ISS 

      2.2.6. Contabilização do ISS 

      2.2.7. PIS/COFINS (Contribuições incidentes sobre as vendas) 
...
Pessoal, nessa aula vamos revisar alguns pontos já estudados na aula sobre a DRE e aprofundar
...
---
 ...
 1. FATORES QUE ALTERAM VALORES DE COMPRA E VENDA,
        FORMA DE REGISTRO E APURAÇÃO DO CMV

1.1. Apuração do CMV e Fatores que Alteram o Valor das Compras
1.1.1. Apuração do CMV
Para o cálculo do CMV utilizamos a seguinte equação:
                  CMV = Estoque inicial + compras líquidas – estoque final
Como regra, o valor do estoque inicial e final é fornecido pelo examinador (na ausência de
informações consideramos ambos zerados). Para encontrar o valor das compras líquidas devemos
saber o descrito a seguir.
...
Aqui você precisa saber o disposto no CPC 16 – Estoques, conforme destacado abaixo:
...
deduzidos na determinação do custo de aquisição.
  ...
  (+) outros custos diretamente atribuíveis à aquisição de produtos acabados, materiais e
  serviços
...
(STJ/2015) Com relação aos critérios de avaliação de ativos de companhias abertas, julgue o
item a seguir.
...
(CM/2015) Em 31/12/2013, a Cia. Z adquiriu 60 unidades da boneca baby por R$ 1.800,00.
...
afeta a base de cálculo dos impostos.
  ...
  Não confunda os descontos incondicionais (comerciais) com os descontos
  condicionais (financeiros).
  Descontos Incondicionais (comerciais): ocorrem no momento da compra (obtidos)
  ou da venda (concedidos), sendo destacados na própria nota fiscal. A palavra
  “incondicional” denota ausência de condições impostas ao cliente para que tivesse
  direito ao desconto.
  ...
  dívida ou do recebimento de um direito, fato posterior à compra ou à venda. O
  desconto financeiro só ocorre mediante condição imposta ao devedor (geralmente
...
---
  ...
  quitação antes da data do vencimento). São reconhecidos como receita (obtidos) ou
  despesa financeira (concedidos).
Realizada essa breve revisão, vamos passar ao estudo de alguns detalhes sobre os tributos
incidentes sobre compras e vendas. Trata-se de aspectos fundamentais para resolver questões
sobre operações de mercadorias.

     2. TRIBUTOS INCIDENTES SOBRE COMPRAS E VENDAS
2.1. Aspectos Introdutórios
Pessoal, para fins de provas, devemos saber o tratamento dos seguintes tributos incidentes sobre
as operações de compra e venda de mercadorias: ICMS, IPI, PIS/COFINS e ISS.
As questões não apresentam grandes dificuldades, desde que saibamos alguns detalhes que
fazem toda a diferença na hora de resolver as questões. Como o assunto é rico em detalhes, há
um campo fértil para exigências em provas e acaba que muitos alunos se perdem nessa
“montanha” de detalhes.
Vamos a seguir destrinchar tudo o que você precisa saber para “detonar” essas exigências.
Avante!

2.2. Tributos incidentes sobre Compras e Vendas
2.2.1. ICMS
O Imposto sobre operações relativas à circulação de mercadorias e sobre prestação de serviços
de transporte interestadual e intermunicipal e de comunicação (ICMS) possui as seguintes
características:
    ...
    Incidência: incide sobre a circulação de mercadorias e sobre prestação de serviços de
    transporte interestadual e intermunicipal, comunicações e fornecimento de energia
    elétrica.
    Observação: Não são todas as mercadorias ou operações que estão sujeitas ao ICMS. Há
    casos de isenção e não incidência previstos em legislação específica, os famosos
    Regulamentos do ICMS de cada Estado.
...
---
    ...
    Imposto Não Cumulativo: O valor devido é compensado em cada operação ou prestação
    com o montante cobrado anteriormente, ou seja, o imposto só recai sobre o valor
    acrescentado em cada fase da circulação do produto, evitando assim a ocorrência do
    chamado efeito “cascata”, decorrente da incidência do imposto sobre imposto, ou
    sobreposição de incidências.  Em suma, o valor incidente na compra é compensado
    do valor incidente na venda.

    Alíquota: varia em função do tipo de mercadoria, do destino, da origem entre outros
    aspectos. Existem as alíquotas internas, as quais são livremente estipuladas pelos
    Estados (geralmente 17% ou 18%) e as alíquotas interestaduais, com critérios
    específicos.

   * Exemplo: Uma empresa adquiriu mercadorias para revenda no valor de R$ 100,00 com incidência
...
2.2.2. Contabilização do ICMS
Meu camarada, para você entender a contabilização do ICMS deve primeiramente visualizar como
se efetiva a sua incidência sobre as operações de compra e venda de mercadorias, principais
atividades de uma empresa comercial.
Nesse sentido, no momento da compra de mercadorias, há o pagamento ao fornecedor de uma
parcela embutida ao custo da mercadoria de ICMS.
Por outro lado, no momento da venda, há o recebimento de clientes e dentro do valor há uma
parcela correspondente ao ICMS. Essa parcela cobrada do cliente deverá ser repassada ao fisco
estadual.
Entretanto, antes desse repasse ao fisco estadual essa parcela do ICMS (recebida do cliente na
venda) poderá ser compensada pelo valor do ICMS pago ao fornecedor por ocasião da compra
dessa mercadoria vendida.
Vamos ver um exemplo para ficar mais claro.
Fato 1 – A empresa comercial “Guanxuma Verde” adquiriu mercadorias à vista para revenda
no valor total de R$ 1.000,00 com incidência de ICMS de 17%.
Nesse momento, a empresa gera um direito (ICMS a recuperar) no valor de R$ 170,00. Já o
fornecedor reconhece uma obrigação de R$ 170,00 (ICMS a recolher), pois deverá recolher o valor
do ICMS ao fisco estadual.
Veja que a empresa pagou R$ 830,00 referente à mercadoria e R$ 170,00 referente ao imposto.
...
Fato 2 – A empresa vendeu essas mesmas mercadorias por R$ 1.500,00 com incidência de
ICMS de 17%.
...
Assim, temos:
        ...
        Valor ICMS Pago ao
                                              Direito                ICMS a Recuperar
        Fornecedor (Compra)


        Valor ICMS Recebido
                                            Obrigação                 ICMS a Recolher
         do Cliente (Venda)
...
O Imposto sobre Produtos Industrializados (IPI) possui as seguintes características:
    ...
    à Competência: trata-se de um imposto de competência federal.

    à Incidência: incide sobre produtos industrializados. Logo, é devido por empresas
    industriais (e equiparadas).
    Observação: Não são todos os produtos industrializados ou operações que estão sujeitos
    ao IPI.
    ...
    à Imposto Não Cumulativo: o valor incidente na compra é compensado do valor
    incidente na venda.

    à Alíquota: O IPI é um imposto proporcional e, portanto, sua alíquota varia de forma
    constante, em função da grandeza econômica tributada. Assim, existe uma infinidade de
...
---
    ...
    alíquotas aplicáveis, as quais estão dispostas em uma tabela (TIPI) baseada na
    Nomenclatura Comum do Mercosul (NCM).

* Exemplo: Uma empresa adquiriu um produto no valor de R$ 100,00 com incidência de IPI à
...
2.2.4. Contabilização do IPI
Pessoal, a contabilização do IPI segue o mesmo raciocínio do ICMS. Logo, não há maiores
dificuldades. Basicamente, devemos entender que as indústrias, em regra, possuem a seguinte
lógica operacional: compram matérias-primas, transformam essa matéria-prima em produtos e,
então, vendem. Nesse sentido, o IPI pago ao fornecedor da matéria-prima é compensado pelo IPI
incidente na venda do produto manufaturado com essa matéria-prima.
Vamos ver um exemplo para ficar mais claro.
Fato 1 – A empresa industrial “Sentinela da Querência” adquiriu matérias-primas à vista para
manufaturar no valor total de R$ 1.000,00 com incidência de IPI de 10%.
Nesse momento, a empresa gera um direito (IPI a recuperar) no valor de R$ 100,00. Já o
fornecedor reconhece uma obrigação de R$ 100,00 (IPI a recolher), pois deverá recolher o valor
do IPI ao fisco federal.
Veja que a empresa pagou R$ 1.000,00 referente à matéria-prima e R$ 100,00 referente ao
imposto.
O lançamento dessa operação é:
...
Assim como o ICMS, o IPI é um imposto não cumulativo e, como tal, permite que a empresa
...
Em razonete, fica mais fácil de visualizar essa sistemática:
          ...
          Valor IPI Pago ao
                                              Direito                   IPI a Recuperar
        Fornecedor (Compra)


        Valor IPI Recebido do
                                            Obrigação                      IPI a Recolher
           Cliente (Venda)
...
A recuperabilidade (ou não) do ICMS e do IPI está relacionada ao destino que a empresa dá aos
...
recuperável de acordo com as informações disponibilizadas (ou não!) pela banca. Saber isso é
...
O Imposto sobre Serviços de Qualquer Natureza (ISS) possui as seguintes características:
    ...
    Competência: trata-se de um imposto de competência municipal. Logo, dificilmente será
    exigido em concursos da área federal ou estadual.
...
2.2.6. Contabilização do ISS
Em regra, o ISS é recolhido mensalmente, no mês seguinte à ocorrência do fato gerador (prestação
do serviço). Assim, no mês da ocorrência, temos o seguinte lançamento:
...
2.2.7. PIS/COFINS (Contribuições incidentes sobre as vendas)
A Contribuição para o Programa da Integração Social (PIS) e a Contribuição para o Programa de
Formação do Patrimônio do Servidor Público (PASEP) são tributos que as entidades de um modo
geral devem recolher mensalmente ao fisco federal, tendo como base o faturamento.
...
A legislação tributária trata ambas as contribuições de forma conjunta. No cálculo dessas
contribuições temos dois tipos de regimes incidentes: o regime cumulativo e o regime não
cumulativo1.
Regime Cumulativo: regime segundo o qual as entidades calculam os valores a serem recolhidos
por meio de alíquota fixada pelo fisco federal incidente sobre base de cálculo também fixada pelo
fisco.
São contribuintes do regime cumulativo todas as pessoas jurídicas que não estejam obrigadas ao
recolhimento do Imposto de Renda Pessoa Jurídica (IRPJ) com base no lucro real, ou seja, se
enquadram nesse regime as pessoas jurídicas que apuram o IRPJ com base no lucro presumido ou
arbitrado.
As alíquotas aplicáveis a esse regime são:
    §   0,65% para o PIS/Pasep;
    §   3% para a COFINS.
Regime Não Cumulativo: esse regime é aplicável às pessoas jurídicas que apuram o IRPJ com
base no lucro real.
As alíquotas aplicáveis a esse regime são:
    §   1,65% para o PIS/Pasep;
    §   7,6% para a COFINS.
A diferença desse regime além das alíquotas e bases de cálculos diferentes, é que as entidades
podem compensar do montante das contribuições devidas, valores das contribuições pagas a
fornecedores de mercadorias e de outros bens ou serviços.
...
Observação: As despesas administrativas e as despesas de vendas não entram no cálculo, pois
elas são evidenciadas na DRE após o Resultado Operacional Bruto.
Gabarito: B
...
e) R$ 474,00
Comentários
Pessoal, essa questão é interessante para você fixar o seguinte: a base de incidência do ICMS
não inclui o IPI. Como assim, professor?
Isso significa, no caso apresentado na questão, que o ICMS está incluso nos 900,00, ou seja, apesar
de a empresa pagar 927,00 (900,00 + 27,00 de IPI), o ICMS incide sobre os 900,00. Assim, temos:
ICMS = 900,00 x 18% = 162,00
Observe que a empresa adquiriu mercadorias para revenda. Isso significa que o ICMS é
recuperável e o IPI é não recuperável.
Logo, o valor a ser ativado como estoque será:
...
e) Débito: de Mercadorias 4.500,00 da compra e do IPI (5%)
          ...
          e crédito de Fornecedores    5.250,00 pela dívida total.
Comentários
Observe que a aquisição de mercadorias é para revenda. Logo, ICMS é recuperável e o IPI não é.
Assim, temos:
...
9. (ESAF/Auditor Fiscal/Receita Federal/2009) No mercadinho de José Maria Souza, que ele,
orgulhosamente, chama de Supermercado Barateiro, o Contador recebeu a seguinte
documentação:
...
e) R$ 97.000,00.
Comentários
Para calcular o Lucro Bruto devemos antes calcular o valor do Custo da Mercadoria Vendida (CMV).
Conforme já estudamos em nosso curso, o CMV pode ser obtido por meio da “velha” fórmula:
                   CMV = Estoque Inicial + compras líquidas – estoque final
...
Observação: o frete sobre vendas não entra no cálculo, pois é evidenciado posteriormente ao
lucro bruto.
Gabarito: D
...
A questão informa que 70 unidades desse estoque foi vendido, o que representa 70% do estoque.
Logo, temos:
...
e) 45.000,00.
Comentários
Para calcularmos o lucro bruto devemos saber qual o valor do CMV. Assim, temos:
                    CMV = Estoque inicial + compras líquidas – estoque final
CMV = 60.000,00 + 70.000,00 – 20.000,00
CMV = 110.000,00
De posse do valor do CMV e das demais informações fornecidas pela questão, podemos calcular
o valor do lucro bruto, conforme descrito a seguir:
...
Observação: os Descontos Financeiros Concedidos, as Comissões sobre Vendas e os Fretes sobre
vendas não entram no cálculo do lucro bruto, pois são despesas que entram no cálculo após o
lucro bruto, a fim de se chegar ao valor do lucro líquido do exercício.
Gabarito: D
...
e) 203.000,00.
Comentários
Pessoal, a questão segue a lógica que já sabemos: devemos primeiro identificar o custo dos
estoques e, posteriormente, confrontarmos com o valor da venda para chegar no lucro bruto.
Assim, temos:
...
A questão informa que todo esse estoque foi vendido pelo valor de R$ 420.000,00. Logo, temos
a seguinte situação:
...
e) Resultado Bruto com Vendas = R$ 172.000,00 e Despesa com Frete = R$ 10.000,00.
Comentários
...
A questão informa que 60% desse estoque (CMV = 309.000,00) foi vendido por 475.000,00. Assim,
temos:
...
14. (FCC/Auditor Conselheiro Substituto/TCM-GO/2015) A Cia. Comerciante S.A. adquiriu
...
e) 414.000,00.
Comentários
Questão bem simples em que temos que calcular o valor que será ativado como estoques.
Efetuando os cálculos, temos:
...
Gabarito: D
15. (CESPE/Analista/Contabilidade/TJ-AM/2019) Com relação a operações que envolvem
resultado do exercício e a métodos de custeio das entidades comerciais, julgue o item que se
segue.
Situação hipotética: Uma entidade comercial apresenta estoque inicial no valor de R$ 1 mil,
compras líquidas no período no valor de R$ 500 e estoque final de R$ 500. Assertiva: Nesse caso,
o custo da mercadoria vendida por essa entidade comercial é de R$ 1 mil.
Comentários
Questão bem simples. Basta efetuar o cálculo por meio da equação:
CMV = Estoque Inicial + Compras Líquidas – Estoque Final
CMV = 1.000 + 500 – 500
...
Considerando-se que os estoques de mercadorias do estabelecimento para revenda às indústrias
tenham sido de R$ 280.000 no início desse período e de R$ 50.000 no fim, é correto afirmar que,
nessas condições, o custo, em reais, das mercadorias vendidas no período foi
...
Comentários
Veja que a questão nos forneceu o estoque inicial e o estoque final. Logo, precisamos descobrir o
valor das compras e com esse valor o CMV.
Compras
Valor das aquisições                    3.000.000
(-) ICMS sobre compras                  (540.000)
(+) Frete e seguro sobre compras        20.000
(-) ICMS sobre fretes                   (2.000)
(=) Compras líquidas                    2.478.000
Logo,
CMV = 280.000 + 2.478.000 – 50.000
CMV = 2.708.000
Observação: o ICMS foi deduzido porque é recuperável (ele está incluso no valor da nota fiscal,
os 3.000.000 no caso e, portanto, precisa ser deduzido). O IPI não foi deduzido, pois não está
dentro do valor da nota fiscal. Veja que o examinador separou as informações. Se fosse “valor da
nota com incidência de IPI”, ou algo próximo disso, aí precisaríamos deduzir o valor do IPI.
Outra expressão chave que nos indica que não devemos deduzir o IPI é “revenda”. Nesse caso,
não há tributação na saída (não houve industrialização... a mercadoria não é matéria-prima e sim
uma mercadoria para revenda...).
Gabarito: B
