...
Avançada - Demonstração do Valor Adicionado. Trata-se de um material pensado para lhe
...
Demonstração do Valor Adicionado
 ...
 ● De acordo com a LSA, a obrigatoriedade é apenas para as companhias abertas,

   ou seja, as companhias fechadas estão dispensadas da elaboração da DVA.


 ● Conforme previsão do art. 188, II, da LSA, a demonstração do valor adicionado

   deverá indicar, no mínimo, o valor da riqueza gerada pela companhia, a sua
...
● Os dados para sua elaboração são extraídos a partir da demonstração do
...
● Exemplos das utilidades da Demonstração do Valor Adicionado:
...
● Como são contabilizadas as receitas na DVA: Receita de venda de mercadorias,

  produtos e serviços representa os valores reconhecidos na contabilidade a esse

  título pelo regime de competência e incluídos na demonstração do resultado do

  período.


● Como são contabilizadas as Outras Receitas na DVA: Representam os valores

  que sejam oriundos, principalmente, de baixas por alienação de ativos

  não-circulantes, tais como resultados na venda de imobilizado, de investimentos,

  e outras transações incluídas na demonstração do resultado do exercício que não
...
● Exemplo de valores que não são contabilizados na Demonstração do

  Resultado do Exercício, mas são apresentados na DVA como receitas: Gastos

  incorridos na construção de ativos para uso próprio da entidade não

  representam itens de resultado, mas são contabilizados como outras receitas na

  DVA; tratamento diferente dos critérios contábeis.


● Insumos Adquiridos de Terceiros: Representam os valores relativos às

  aquisições de matérias primas, mercadorias, materiais, energia, serviços, que
...
---
  ...
  tenham sido transformados em despesas do período. Enquanto permanecerem
...
● Na distribuição do valor adicionado, qual o tratamento dado a distribuição do

  valor adicionado ao pessoal? Nesse item entram valores apropriados ao custo e

  ao resultado do exercício na forma de:
     ...
     ○ Benefícios: representados pelos valores relativos à assistência médica,
...
● Na distribuição do valor adicionado, qual o tratamento dado a distribuição do
  ...
  valor adicionado aos Impostos, Taxas e Contribuições? Valores relativos aos

  tributos devidos pela empresa, como, imposto de renda, contribuição social
  ...
  impostos e contribuições a que a empresa esteja sujeita.


● Qual o tratamento que deve ser dado aos tributos compensáveis? Para os
...
● Exemplos da Remuneração de Capitais de Terceiros: Valores pagos ou

  creditados aos financiadores externos de capital, como, juros, aluguéis, royalties,
