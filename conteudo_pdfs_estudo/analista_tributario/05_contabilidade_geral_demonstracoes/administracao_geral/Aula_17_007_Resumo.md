...
todo o material possa ser revisado em um período de tempo mais curto.
      ...
      Com isso em mente, apresentamos a vocês o Contabilidade Geral e Avançada -

Demonstração dos Fluxos de Caixa. Trata-se de um material pensado para lhe ajudar em
...
Demonstração dos Fluxos de Caixa
 ...
 ● A Demonstração de Fluxo de Caixa é obrigatória para as S.As., As companhias

   fechadas com Patrimônio Líquido inferior a R$ 2.000.000,00 (dois milhões de

   reais) na data do balanço não serão obrigadas à elaboração e divulgação da

   Demonstração do Fluxo de Caixa.

 ● A Demonstração do Fluxo de Caixa (DFC) pode ser elaborada pelo método direto
...
● O Pronunciamento encoraja fortemente as empresas a seguirem a seguinte
  ...
  classificação: Juros pagos e recebidos: Atividades operacionais Juros sobre o

  capital próprio e dividendos recebidos: Atividades operacionais
...
● Transações de investimento e financiamento que não envolvem o uso de caixa
  ...
  ou equivalentes de caixa não devem ser incluídas na demonstração dos fluxos
