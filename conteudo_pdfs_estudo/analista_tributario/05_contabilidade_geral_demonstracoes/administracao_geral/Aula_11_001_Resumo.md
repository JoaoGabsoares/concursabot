...
Avançada – DLPA e DMPL. Trata-se de um material pensado para lhe ajudar em todo esse
...
Demonstração do Resultado do Exercício (DRE) que demonstra o lucro ou prejuízo por
...
Um primeiro ponto a salientar é que a DLPA pode ser incluída na DMPL. Vejam que a

lei afirma que o que pode ocorrer é a inclusão da primeira na segunda e não a

substituição de uma por outra. Esta questão é recorrente em provas e não podemos
...
fechamento    da      demonstração.           Ressalve-se,       contudo,       que     a   conta   prejuízos

acumulados pode subsistir ao término do exercício, diminuindo o PL, tendo, assim,
...
As reservas de lucros que podem ser constituídas a partir de existência de lucro no
...
Os dividendos representam a remuneração do capital dos sócios. Quando você

emprega dinheiro em uma sociedade, espera receber um retorno. E o principal
...
recebimento dos sócios são os dividendos.
           ...
           Estatuto expresso             Fixa o quanto quiser
                                         ...
                                         exercício
                                          ...
                                          - Reserva legal
         Estatuto omisso (base
          de cálculo): 50% do            - Reserva para
              lucro líquido              contingências
            ajustado, que é
             encontrado da               + Reversão de reserva para
           seguinte maneira              contingências
...
As doações e subvenções governamentais, antes do advento das mudanças contábeis,

eram registradas à conta de reserva de capital. Pois bem, agora essas doações são
...
como, por exemplo, quando a empresa tem um volume extraordinário de

empréstimos a serem quitados, ou quando está em recuperação judicial ou

extrajudicial. Poderá, assim, constituir reserva especial para dividendos obrigatórios
...
O orçamento poderá ter prazo de até 5 exercícios, salvo no caso de execução, por prazo
...
A Demonstração das Mutações do Patrimônio Líquido (DMPL) é mais completa que a

DLPA. Esta última torna-se apenas uma coluna da DMPL. A Lei 6404/76 permite que a

DLPA seja incluída na DMPL.
