...
---
      ...
      Aula 16
                                                                                     ...
                                                                                     Índice
1) Princípios de Contabilidade - Teoria


2) Princípios de Contabilidade - Questões Comentadas


3) Listas de Questões - Princípios de Contabilidade
...
Perceba que a adoção da essência sobre a forma visa fornecer informações mais próximas da realidade, de
...
muitas operações realizadas pela empresa não fariam sentido como, por exemplo, a apropriação da
...
(SEFAZ-AP) O princípio contábil que influencia o valor econômico dos ativos e, em muitos casos, o valor
...
---
  ...
  Aula 16
              ...
              Custo        Valor na         data     da
                                                           liquidar no curso normal das       Não
             Histórico     aquisição
                                                           operações

              Custo        Valor para adquirir na Valor para liquidar na data
                                                                                              Não
             Corrente      data do balanço        do balanço

              Valor        Valor obtido pela venda Valor para liquidar no curso
                                                                                              Não
            Realizável     de forma ordenada       normal das operações

                      Valor presente do fluxo Valor presente do fluxo de
       Valor Presente de entradas esperado no saídas para liquidar no curso                   Sim
                      curso normal            normal

                           Valor pelo qual um ativo pode ser trocado, ou um passivo
            Valor justo    liquidado, entre partes conhecedoras, dispostas a isso, em         Não
                           uma transação sem favorecimentos.

                           Os efeitos da alteração do poder aquisitivo da moeda
         Atualização       nacional devem ser reconhecidos nos registros contábeis
                                                                                              Não
          Monetária        mediante o ajustamento da expressão formal dos
...
20.000,00 (esse será o custo histórico). No entanto, caso a empresa queira adquirir esse mesmo veículo hoje
...
Aquisição de máquinas pelo valor de 72.000,00 financiadas em 36 meses com pagamento mensal de 2 mil.
...
Estudaremos com maiores detalhes o regime de competência na sequência da aula, oportunidade em que
...
A partir dos fatos mencionados, qual o resultado da demonstração do resultado do exercício, considerando o
...
e) R$ 60.000 em jan./2020 e de R$ 40.000,00 em fev./2020, considerando-se o regime de competência.
Comentários
...
---
  ...
  Aula 16
   ...
   •   Receita de dezembro de 2012, recebida em dezembro de 2012 = R$ 8.000,00. (4)
...
Essa correlação fica bem evidente no clássico exemplo da receita de vendas, senão vejamos:
...
custo da mercadoria vendida foi de R$ 70.000,00.
 ...
 D – Caixa                                                   D – Custo da Mercadoria Vendida (CMV)
 C – Receita de Vendas ... 100.000,00                        C – Estoques ... 70.000,00
...
Receita = 400.000 (80% recebido no período)
...
Resultado = 48.000,00 - 40.000,00 = 8.000,00
Regime de Competência
Receita = 80.000,00
Despesa = 64.000,00
...
9. (FUNDATEC/Pref. Palmeira das Missões-RS/2019) Na contabilidade pública ao determinar que os
...
do passivo circulante, com o objetivo de melhorar seu resultado patrimonial. Este procedimento fere o
Princípio da
a) Fidedignidade.
b) Competência.
c) Integridade.
