...
aula_numero: '18'
titulo_aula: TÓPICOS DA LEI 6.404/76
artigos_citados:
- Art. 183.
- Art. 184-A.
- Art. 184.
...
---
     ...
     (PREVIC) O exercício social das empresas regidas pela Lei das Sociedades
     Anônimas deve ter a duração de um ano, ainda que seu intervalo não coincida
     com o ano civil, ressalvados os casos em que a entidade esteja em seu primeiro
     ano de operação ou tenha acabado de sofrer alteração estatutária.
...
---
     ...
     (CREA-DF) De acordo com a Lei das S.A., art. 175, o exercício social terá
     duração de um ano e a data do término será fixada no estatuto. Na constituição
     da companhia e nos casos de alteração estatutária, o exercício social poderá ter
     duração diversa. Em conformidade com essa lei, julgue os itens seguintes.
     Um exercício social não poderá ter duração menor que seis meses.
...
---
      ...
      De acordo com a Lei das S.A., art. 175, o exercício social terá duração de um
      ano e a data do término será fixada no estatuto. Na constituição da companhia
      e nos casos de alteração estatutária, o exercício social poderá ter duração
      diversa. Em conformidade com essa lei, julgue os itens seguintes.


      (CREA-DF) Um exercício social não poderá ter duração menor que seis meses.
...
---
      ...
      (CREA-DF) Como regra geral, o exercício social deve corresponder a um ano e
      pode ter o seu término em qualquer mês do calendário civil, segundo o que for
...
---
      ...
      (UNIPAMPA) A sociedade empresária constituída por ações deverá apresentar,
      ao final de cada exercício social, as seguintes demonstrações financeiras:
      balanço patrimonial, demonstração dos lucros ou prejuízos acumulados,
      demonstração do resultado do exercício, demonstração do fluxo de caixa e, em
      caso de companhia aberta, demonstração do valor adicionado.
...
---
      ...
      (STM) Integra o rol de demonstrações obrigatórias o balanço patrimonial, a
...
---
      ...
      (INCA) As demonstrações financeiras necessárias para as sociedades por ações
      são o balanço patrimonial, a demonstração dos lucros ou prejuízos acumulados,
      a demonstração do resultado do exercício e a demonstração dos fluxos de
      caixa. Se a companhia for caracterizada como uma companhia aberta, ela deve,
      ainda, apurar a demonstração do valor adicionado.
...
---
      ...
      (FHS-SE) A Lei n. 6.404/1976, modificada em 2007 pela Lei n.º 11.638, alterou o
      conjunto obrigatório das chamadas demonstrações financeiras a serem
      elaboradas pelas sociedades por ações. Desse modo, tornou obrigatórias para
      todas as companhias as demonstrações dos fluxos de caixa e das mutações do
      patrimônio líquido, vedou a demonstração das origens e aplicações de recursos
      e passou a exigir a demonstração do valor adicionado apenas para as
      companhias e demais sociedades de grande porte.
...
---
      ...
      (SLU-DF) ) A demonstração dos lucros ou prejuízos acumulados é obrigatória
      para companhias abertas, que deverão apresentá-la à parte da demonstração
      de mutações do patrimônio líquido, caso esta seja elaborada pela companhia.
...
---
      ...
      (TCM-BA) Conforme alteração introduzida na Lei n.º 6.404/1976 pela Lei n.º
      11.638/2007, determinada demonstração contábil passou a ser optativa para as
      companhias abertas. A referida demonstração contábil é o(a)
...
---
      ...
      (ABIN) As normas expedidas pela Comissão de Valores Mobiliários (CVM)
      deverão ser observadas pelas companhias abertas na elaboração das
      demonstrações financeiras e esses relatórios serão submetidos à auditoria
...
---
      ...
      (Polícia Federal) O BP permite ao usuário da informação a análise da situação
...
---
      ...
      (SLU-DF) Com as alterações implementadas na Lei n.º 6.404/1976 pela Lei n.º
      11.941/2009, o patrimônio líquido deixou de ser considerado como um grupo
      do passivo.
...
---
      ...
      (SLU-DF) No balanço patrimonial de uma companhia aberta, os saldos credores
      e devedores devem ser apresentados em contas separadas, mesmo aqueles
...
---
      ...
      (FUB) Se uma empresa adquire um fundo de comércio, esse item patrimonial
      deve ser classificado no ativo imobilizado.
...
---
      ...
      (FUB) Se uma empresa industrial tiver participação de caráter permanente no
      capital social de outras empresas, esse item patrimonial deverá ser classificado
      em investimentos, no ativo não circulante.
...
---
      ...
      (FUB) Os valores correspondentes a participações permanentes no capital de
      outras sociedades e avaliados pelos métodos do custo, da equivalência
      patrimonial ou do valor justo devem compor o subgrupo investimentos do ativo
      não circulante.
...
---
      ...
      (SLU-DF) A classificação de ativos e passivos como circulantes ou não circulantes
      deve obedecer ao ciclo operacional da empresa.
...
---
      ...
      (EBSERH) Se, em determinada empresa, o prazo entre a aquisição de ativos
      para a produção e sua transformação em caixa ou equivalente for superior ao
...
---
      ...
      (MEC) Se uma sociedade anônima tem o capital subscrito representado pelas
      contas capital autorizado e capital a subscrever, então, quando ocorrer uma
      subscrição de ações, essa sociedade anônima deverá fazer um lançamento
      contábil a crédito da conta capital a subscrever, classificada no patrimônio
      líquido.
...
---
      ...
      Deixou de ser uma reserva de capital a partir da vigência da Lei nº 11.638/2007
      a Reserva
...
(CAGE-RS) De acordo com a Lei nº 6.404/76, com redação dada pela Lei nº 11.638/07, a
...
---
      ...
      (SEFAZ-AL) A conta ajustes de avaliação patrimonial pertence ao patrimônio
      líquido e destina-se a registrar, no balanço patrimonial, os aumentos ou as
      diminuições de valor de elementos do ativo e do passivo sujeitos à avaliação a
      valor justo por determinação legal ou regulamentação específica, enquanto tais
      variações não puderem ser reconhecidas no resultado do exercício em
...
---
   ...
   Critérios de Avaliação do Passivo
        ...
        Obrigações, encargos e riscos Valor atualizado até a data do balanço
                    (PC)              (ajustados a valor presente, se o valor for
                                      relevante)
          Obrigações em moeda         Convertidas em moeda nacional à taxa de
                estrangeira           câmbio em vigor na data do balanço
        Obrigações, encargos e riscos Valor atualizado até a data do balanço,
                   (PÑC)              ajustados a valor presente.
...
---
   ...
   Critérios de Avaliação em Op. Societárias
       ...
       aquisição de controle, participações societárias ou negócios. (Incluído
