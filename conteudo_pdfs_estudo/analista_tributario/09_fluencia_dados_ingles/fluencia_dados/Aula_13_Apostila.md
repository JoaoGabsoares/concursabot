...
2) Análise de Informações - Big Data - Premissas


3) Análise de Informações - Big Data - Big Data Analytics


4) Análise de Informações - Big Data - Conceitos Avançados


5) Análise de Informações - Big Data - Resumo


6) Mapa Mental - Análise de Informações - Big Data


7) Questões Comentadas - Análise de Informações - Big Data - Multibancas


8) Lista de Questões - Análise de Informações - Big Data - Multibancas
...
entretenimento. Quando você acessa a Netflix, ela te dá uma lista de recomendações2 em sua
...
Não existe uma definição singular sobre a terminologia Big Data. Vejamos algumas:
 ...
 Mayer-Schönberger Big Data é a habilidade da sociedade de aproveitar a informação por novas maneiras para
                     produzir introspecção úteis ou bens e serviços de valor significante.
          e Cukier’s
      ...
      ENGENHEIRO DE        Construir e manter pipelines de dados,                  Hadoop, Apache Spark,
        ...
        ARQUITETO DE    Definir infraestrutura, padrões e frameworks             AWS, Azure, Google Cloud,
           ...
           DE DADOS                  tendências e insights.                                Excel
                        Identificar padrões ocultos nos dados usando             RapidMiner, WEKA, Python
            MINERADOR
                         técnicas estatísticas e de machine learning.                  (Scikit-Learn)
...
de dados não relacionais:
 ...
 Particionamento   tabela é dividida em partes menores que são armazenadas em diferentes servidores físicos, mas
                   são tratadas como uma única tabela. O objetivo é melhorar a performance, permitindo que cada
  (fragmentação)   partição seja processada em paralelo e reduzindo a quantidade de dados que precisam ser
                   processados. O particionamento pode ser vertical, horizontal ou híbrida (mista).
...
Não entraremos em detalhes, mas existe também o particionamento híbrido, que mistura ambos.
Para entender melhor, vamos considerar a tabela abaixo que contém cinco colunas e oito linhas:
...
O particionamento vertical divide a tabela original verticalmente (por colunas), logo a estrutura
da tabela original se modifica nas tabelas derivadas. Ele é usado quando se deseja melhorar o
...
Um cenário ideal para esse tipo de partição é quando você não precisa de todas as informações
da tabela em sua consulta. Por exemplo, imagine uma tabela que possua dados como nome e
...
horizontalmente (por linhas), logo a estrutura                                                  da
tabela original se mantém nas tabelas                             7777777    7777777    7777777
derivadas (com o mesmo número de colunas).                        888888     888888     888888
                                                                                           Ele é
usado quando se deseja distribuir os dados entre                                             várias
instâncias de servidores, de forma a melhorar a escalabilidade e o desempenho da aplicação. A ideia
aqui é colocar linhas diferentes em tabelas derivadas diferentes.
...
a falhas? Não! Por que? Porque não há redundância de dados, portanto, a falha de uma máquina
...
replicação é o processo de criar cópias dos dados (chamadas réplicas) e armazená-los em máquinas
diferentes. Como os dados são replicados de forma redundante em várias máquinas, todo o sistema
pode tolerar falhas de uma ou mais máquinas, pois os usuários podem acessar os dados de uma
máquina diferente que funciona normalmente. Portanto, é um sistema com alta disponibilidade!
...
assim, não podem ser utilizados em ambientes que necessitam de transações 1.
...
1
  Embora muitos bancos de dados NoSQL priorizem escalabilidade em detrimento do modelo ACID, atualmente alguns oferecem suporte total ou
parcial a transações ACID, como o MongoDB (a partir da versão 4.0) e o CouchDB. Assim, bancos NoSQL podem ser usados em cenários que exigem
transações.
...
Data2. A maioria das arquiteturas de Big Data inclui alguns ou todos os seguintes componentes:
...
DESCRITIVA     ACONTECEU? e preciso dos temas relevantes para a empresa no presente momento. Exemplo: por
                          meio do cruzamento de dados, conclui-se que determinada pessoa atualmente é
                          identificada como má pagadora.
  ANÁLISE        POR QUE O foco está na relação de causas e consequências percebidas ao longo do tempo,
                          dentro de um determinado tema. Assim, a análise diagnóstica funciona baseada na
DIAGNÓSTICA    ACONTECEU? coleta de dados relacionados a um determinado assunto, cruzando informações com o
...
Processamento origem, processá-los e gravar a saída em novos arquivos. As opções incluem a execução de
 ...
 mensagens em ingestão (consumo) de mensagens para atuar como um buffer para mensagens e para oferecer
    ...
    tempo real enfileiramento de mensagens. Essa parte de uma arquitetura de streaming é geralmente
               ...
               Depois de capturar mensagens em tempo real, a solução deve processá-las, filtrando, agregando
               e preparando os dados para análise – os dados de fluxo processados são gravados em um coletor
Processamento de saída. O Azure Stream Analytics fornece um serviço de processamento de fluxo gerenciado
               com base em consultas SQL em execução perpétua que operam em fluxos ilimitados. Você
      em Fluxo também pode usar tecnologias de streaming Apache de código aberto, como Storm e Spark
...
Armazenamento apresentados por meio de uma tecnologia NoSQL de baixa latência, como o HBase, ou um banco
    ...
    Analíticos armazenamento de dados distribuído. O Azure Synapse Analytics fornece um serviço
      ...
      Análise e de dados tabular no Azure Analysis Services. Ele também pode oferecer suporte a BI de
    Relatórios autoatendimento, usando as tecnologias de modelagem e visualização no Microsoft Power BI
                ou no Microsoft Excel. A análise e os relatórios também podem assumir a forma de exploração
                interativa de dados por cientistas de dados ou analistas de dados. Para esses cenários, muitos
...
Big data é caracterizado por cinco principais atributos: volume, variedade, velocidade, valor e
veracidade. Logo, definir Big Data apenas pelo grande volume de dados armazenados em tabelas
relacionais é uma visão limitada e não abrange a totalidade do conceito.
...
Em suma: Volume é apenas um dos cinco V’s do Big Data! Ele também se caracteriza pela
Veracidade, Velocidade, Valor e Variedade. Além disso, os dados são armazenados em diferentes
formatos e, não apenas, tabelas relacionais.
...
41. (FCC / Copergás-PE - 2023) Na era do Big Data, as empresas precisam utilizar repositórios e
    tecnologias para armazenamento, tratamento e análise desse grande volume de dados, dentre
    as quais, encontram-se:

   a) os sistemas OLAP, que têm foco no nível operacional da organização, proporcionando alta
   velocidade na consulta, inserção, alteração e exclusão de dados. Os dados, voláteis, são
   armazenados em SGBDs relacionais e a sua atualização é feita no momento da transação.

   b) os Data Warehouses, que proporcionam alto desempenho para consulta de dados históricos.
   Os dados são obtidos de diversas fontes, passam por um processo de ETL e geralmente são
   armazenados em um modelo dimensional como Star e Snowflake.

   c) as ferramentas OLAP, que utilizam a técnica de argumentação ativa, isto é, ao invés de o
   gestor definir o problema, selecionar os dados e as ferramentas para analisá-los, as ferramentas
   OLAP pesquisam automaticamente a base de dados à procura de anomalias e possíveis
   relacionamentos, identificando problemas que não tinham sido detectados pelo gestor.

   d) as análises de BI, que utilizam algoritmos estatísticos e técnicas de machine learning para
   identificar a probabilidade da ocorrência de resultados futuros a partir de dados históricos
   armazenados em data lakes.

   e) as ferramentas de Data Mining, que combinam os melhores elementos de Data Lakes e de
   Data Warehouses, formando um sistema aberto e padronizado, capaz de estruturar os dados e
   os recursos de gerenciamento de dados, de forma a proporcionar ao gestor uma exploração
   detalhada dos dados em busca de informações para a tomada de decisão.

Comentários:

(a) Errado, a descrição do item trata de Sistemas OLTP e, não, OLAP; (b) Correto; (c) Errado, que
item viajante – não tem nada correto; (d) Errado, a descrição está correta, mas isso não tem
nenhuma relação com repositórios ou tecnologias de armazenamento; (e) Errado, outra questão
viajante – Data Mining não tem relação com repositórios ou tecnologias de armazenamento.

                                                                                       Gabarito: Letra B

42. (FCC / SEFAZ-SC - 2018) Como não existe um modelo de armazenamento de dados único
...
43. (FCC / SEFAZ-SC – 2018) No âmbito da ciência de dados na definição de Big Data, utilizam-se
...
44.(FCC / SEFAZ-SC – 2018) As soluções em Big Data Analytics, usadas, por exemplo, pela Fazenda
...
45. (FCC / TCE-RS – 2018) Um sistema de Big Data costuma ser caracterizado pelos chamados 3 Vs,
...
46.(FCC / Câmara Legislativa do Distrito Federal – 2018) A proposta de uma solução de Big Data,
...
47. (FGV / Receita Federal - 2023) As principais plataformas de computação em nuvem, como
    Amazon Web Services (AWS), Microsoft Azure e Google Cloud Platform (GCP), oferecem
    soluções de Big Data para ajudar as empresas a coletar, armazenar, processar e analisar grandes
    quantidades de dados.

   As opções a seguir apresentam conjuntos de serviços que estão diretamente relacionados a
   soluções de Big Data oferecidas pelas plataformas de computação em nuvem elencadas acima,
...
Embora as plataformas de computação em nuvem mencionadas ofereçam serviços para
desenvolvimento e hospedagem de aplicativos, esses serviços não estão diretamente relacionados
a soluções de Big Data. As outras opções mencionadas - armazenamento de dados, processamento
de dados, análise de dados e streaming de dados - são todas soluções de Big Data que as
plataformas de computação em nuvem oferecem.

(a) Errado. Esses serviços de armazenamento em nuvem são altamente escaláveis e seguros e
permitem que os usuários armazenem grandes volumes de dados de forma eficiente. Eles também
oferecem recursos para gerenciamento de dados, como controle de versão e criptografia. O
Amazon S3 (Simple Storage Service) da AWS, o Azure Blob Storage da Microsoft e o Google Cloud
Storage são serviços populares de armazenamento em nuvem;

(b) Errado. Esses serviços oferecem soluções para processamento distribuído de dados em escala,
permitindo que os usuários executem tarefas de processamento de dados em grandes conjuntos de
dados. Eles utilizam tecnologias de código aberto, como Hadoop, Spark e Hive, para
processamento de dados. A AWS oferece o serviço Amazon EMR (Elastic MapReduce), a Microsoft
oferece o serviço Azure HDInsight e o Google oferece o serviço Google Cloud Dataproc.

(c) Errado. Esses serviços oferecem soluções de análise de dados em larga escala, permitindo que
os usuários executem consultas complexas em grandes volumes de dados armazenados em seus
sistemas de armazenamento em nuvem. Eles usam tecnologias de processamento de consultas,
como o SQL, para facilitar a análise de dados. A AWS oferece o serviço Amazon Athena, a Microsoft
oferece o serviço Azure Data Lake Analytics e o Google oferece o serviço Google BigQuery.
...
(d) Errado. Esses serviços permitem que os usuários processem dados em tempo real, coletando e
processando fluxos contínuos de dados de diversas fontes. Eles são úteis para aplicativos em que é
necessário tomar decisões com base em dados em tempo real, como monitoramento de segurança,
análise de mídia social e previsão de demanda. A AWS oferece o serviço Amazon Kinesis, a
Microsoft oferece o serviço Azure Stream Analytics e o Google oferece o serviço Google Cloud
Pub/Sub.

(e) Correto. Esses serviços permitem que os usuários desenvolvam e implantem aplicativos em
nuvem, oferecendo recursos para gerenciamento de infraestrutura, dimensionamento automático
e monitoramento de aplicativos. Embora sejam serviços importantes para a plataforma de nuvem,
eles não estão diretamente relacionados a soluções de Big Data. A AWS oferece o serviço AWS
Elastic Beanstalk, a Microsoft oferece o serviço Azure App Service e o Google oferece o serviço
Google App Engine.

                                                                                       Gabarito: Letra E

48.(FGV / SMF-RJ – 2023) No contexto de Big Data, para armazenar petabytes de dados não
...
(a) Errado. Isso não é uma característica necessária em um banco de dados para Big Data que lida
com dados não estruturados e semiestruturados. A linguagem SQL é mais comumente associada a
bancos de dados relacionais e pode não ser adequado para a variedade de dados encontrados em
Big Data.

(b) Errado. As propriedades ACID são importantes em bancos de dados transacionais, mas em
cenários de Big Data, onde a escalabilidade e a velocidade de processamento são cruciais, muitas
vezes é necessário abrir mão de algumas dessas propriedades em favor da escalabilidade e do
processamento paralelo;

(c) Correto. Esta é uma característica essencial em um banco de dados para Big Data com alta
heterogeneidade. Os esquemas de dados dinâmicos permitem que o banco de dados se adapte à
estrutura variável dos dados, o que é comum em Big Data, onde os formatos de dados podem variar
amplamente;
...
(d) Errado. Utilize um SBGD central e local com estrutura sequencial de processamento não é uma
abordagem típica de sistemas de Big Data. Em vez disso, em ambientes de Big Data, é comum
utilizar sistemas distribuídos e paralelos que podem escalar horizontalmente para lidar com
grandes volumes de dados;

(e) Errado. Armazenar todos os tipos de dados em tabelas relacionais não é uma prática eficaz em
cenários de Big Data. Isso limitaria a flexibilidade e não acomodaria bem a variedade de formatos
de dados não estruturados e semiestruturados encontrados em Big Data por conta de sua
heterogeneidade.

                                                                                       Gabarito: Letra C

49.(FGV / TJ-RN - 2023) Observe a estrutura do dataset ilustrado a seguir
...
50. (FGV / TJ-RN - 2023) O modelo de banco de dados em que a associação entre dois registros é
...
51. (FGV / TJ-RN - 2023) O volume de informações digitais heterogêneas sobre processos judiciais
...
52. (FGV / TJ-RN - 2023) Os bancos de dados massivos possuem características que precisam ser
...
irrelevante e redundante, e apoiar a limpeza dos dados para melhorar sua qualidade é a veracidade.

                                                                                       Gabarito: Letra D

53. (FGV / Receita Federal - 2023) Bancos de dados NoSQL são usualmente divididos em categorias
    de store.
...
54. (FGV / IBGE - 2017) Observe a figura a seguir que ilustra relações entre colegas e seus interesses.
...
55. (FGV / IBGE - 2017) Bancos de Dados NoSQL podem armazenar dados em diversos formatos
...
56. (FGV / IBGE - 2016) Considere as seguintes características de um projeto de banco de dados.
...
57. (FGV / TJ-SC – 2015) Os termos Business Intelligence (BI) e Big Data confundem-se em certos
...
58. (FGV / TJ-BA - 2015) Analise as afirmativas a respeito da classe de gerenciadores de bancos de
...
59. (FGV / PROCEMPA - 2014) O teorema CAP (CAP Theorem) é um importante resultado teórico
...
60.(FGV / AL-BA – 2014) A expressão Big Data é utilizada para descrever o contexto da informação
...
1. (CESGRANRIO / IPEA - 2024) O IBGE é responsável no Brasil pela Classificação Nacional de
   Atividades Econômicas (código CNAE). Considere que um órgão de atuação nacional, que
   possui infraestrutura de Tecnologia de Informação e Comunicação (TIC) em todos os estados
   brasileiros, deseja realizar um censo de pequenas e médias empresas em 10 estados do Brasil.
   Para guardar os dados dessas empresas, foi criado um banco de dados distribuído (BDD)
   relacional com particionamento horizontal, também conhecido como sharding em muitos
   SGBDs NoSQL, utilizando como critério de distribuição a UF onde se localiza a sede da empresa,
   de tal modo que as empresas do Rio de Janeiro têm seus dados guardados na infraestrutura de
   TIC desse órgão no Rio de Janeiro. Com os dados distribuídos dessa forma,
   ...
   c) as consultas a dados sumarizados podem ser otimizadas por meio da utilização de
   MapReduce.
   d) os metadados do BDD devem ficar localizados apenas na infraestrutura de TIC da sede do
   órgão.
   e) os programas que consultam esses dados precisam saber em que estado eles se encontram.

Comentários:

(a) Errado. Embora uma falha em uma infraestrutura de TIC específica possa afetar o acesso aos
dados dessa localidade, o princípio do particionamento horizontal (sharding) é justamente distribuir
os dados de maneira que cada shard (partição) opere de forma independente. Assim, a falha em um
shard específico não deveria inviabilizar o uso de todo o banco de dados.

(b) Errado. As características ACID (Atomicidade, Consistência, Isolamento, Durabilidade) podem
ser desafiadoras de implementar em ambientes distribuídos devido à complexidade do
gerenciamento de transações distribuídas, mas não é correto afirmar que não podem ser
garantidas. Existem técnicas e mecanismos, como dois-phase commit, projetados para assegurar
as propriedades ACID em transações distribuídas.

(c) Correto. O MapReduce é uma técnica de processamento e geração de grandes conjuntos de
dados com um modelo paralelo, distribuído e facilmente escalável. Em um banco de dados
distribuído, como o descrito, onde os dados estão particionados por UF, a utilização de MapReduce
pode otimizar consultas a dados sumarizados ao processar os dados de forma distribuída e em
paralelo, agregando os resultados de forma eficiente.

(d) Errado. Embora seja essencial gerenciar metadados em um BDD, não é necessário que todos os
metadados fiquem localizados apenas na infraestrutura de TIC da sede do órgão. Os metadados
...
podem ser distribuídos ou replicados entre as infraestruturas para garantir a disponibilidade e o
acesso eficiente.

(e) Errado. Idealmente, os programas que consultam um banco de dados distribuído não precisam
saber exatamente em que estado os dados se encontram, graças ao uso de um sistema de
gerenciamento de banco de dados distribuído que abstrai essa complexidade. O SGBD pode
automaticamente direcionar as consultas para a localização correta dos dados, baseando-se em
informações de particionamento ou sharding.

                                                                                       Gabarito: Letra C

61. (CP-T / Marinha - 2022) De acordo com Elmasri (2018), em projetos de bancos de dados
...
62. (SELECON / EMGEPRON – 2021) Trata-se de uma infinidade de informações não estruturadas
...
63. (COMPERVE / TJ/RN – 2020) Embora Big Data tenha diferentes definições, há um consenso
...
64.(CCV-UFC / UFC – 2019) Sobre os banco de dados NoSQL, assinale a afirmativa correta:
...
65. (IADES / APEX BRASIL – 2018) Assinale a alternativa que apresenta o conceito de Big Data.
...
66. (CESGRANRIO / PETROBRAS – 2018) A principal definição de Big Data parte de três
...
67. (AOCP / CPD/BA – 2018) Big Data se refere ao imenso volume de conjuntos de dados que
...
68. (QUADRIX / CRM/DF – 2018) O fato de o ser humano gerar milhares de informações a cada
...
69. FEPESE / CIA/SC – 2017) Um banco de dados de Big Data deve possuir pelo menos três
...
70. (CESGRANRIO / PETROBRÁS – 2017) O termo Big Data é bastante conhecido pelos
...
71. (AOCP / CCAS-SC – 2015) Em relação à Big Data e NoSQL, é correto afirmar que:
...
61. (CESGRANRIO / IPEA - 2024) O IBGE é responsável no Brasil pela Classificação Nacional de
    Atividades Econômicas (código CNAE). Considere que um órgão de atuação nacional, que
    possui infraestrutura de Tecnologia de Informação e Comunicação (TIC) em todos os estados
    brasileiros, deseja realizar um censo de pequenas e médias empresas em 10 estados do Brasil.
    Para guardar os dados dessas empresas, foi criado um banco de dados distribuído (BDD)
...
62. (CP-T / Marinha - 2022) De acordo com Elmasri (2018), em projetos de bancos de dados
    distribuídos, é possível dividir os dados em unidades lógicas de acordo com as técnicas de:
...
63. (SELECON / EMGEPRON – 2021) Trata-se de uma infinidade de informações não estruturadas
    que, quando usadas com inteligência, se tornam uma arma poderosa para empresas tomarem
    decisões cada vez melhores. As soluções tecnológicas que trabalham com esse conceito
    permitem analisar um enorme volume de dados de forma rápida e ainda oferecem total controle
    ao gestor das informações. E as fontes de dados são as mais diversas possíveis: de textos e fotos
...
64.(COMPERVE / TJ/RN – 2020) Embora Big Data tenha diferentes definições, há um consenso
   sobre o modelo dos 3 V’s que correspondem a 3 características. Duas dessas características são:
...
65. (CCV-UFC / UFC – 2019) Sobre os banco de dados NoSQL, assinale a afirmativa correta:
...
66.    (IADES / APEX BRASIL – 2018) Assinale a alternativa que apresenta o conceito de Big Data.
...
67. (CESGRANRIO / PETROBRAS – 2018) A principal definição de Big Data parte de três
    características, conhecidas como 3 V do Big Data, a saber: velocidade, variedade e volume. O
    termo velocidade refere-se, principalmente, à:
...
68. (AOCP / CPD/BA – 2018) Big Data se refere ao imenso volume de conjuntos de dados que
   alcançam elevadas ordens de magnitude. O valor real do Big Data está no insight que ele produz
   quando analisado — buscando padrões, derivando significado, tomando decisões e, por fim,
   respondendo ao mundo com inteligência. Referente ao Big Data, é correto afirmar que o termo
   variedade refere-se:
...
69. (QUADRIX / CRM/DF – 2018) O fato de o ser humano gerar milhares de informações a cada
   minuto dá origem ao conceito de Big Data, que se trata de uma nova linha de banco de dados
   que não possui qualquer relação com as existentes até o momento. Pelo fato de as bases de
   dados Big Data serem do tipo Plano, não podem ser manipuladas e consultadas pelo SQL.

70. FEPESE / CIA/SC – 2017) Um banco de dados de Big Data deve possuir pelo menos três
    aspectos, os chamados 3Vs do Big Data, que são:
...
71. (CESGRANRIO / PETROBRÁS – 2017) O termo Big Data é bastante conhecido pelos
    profissionais de tecnologia da informação, especialmente aqueles envolvidos com bancos de
    dados, inteligência de negócios, sistemas de informações e sistemas de apoio à decisão. Uma
    característica inerente a esse conceito é a da:
...
72. (AOCP / CCAS-SC – 2015) Em relação à Big Data e NoSQL, é correto afirmar que:
...
2. ERRADO                               42. LETRA B
3. CORRETO                              43. LETRA C
4. ERRADO                               44. LETRA D
5. LETRA C                              45. LETRA A
6. ERRADO                               46. LETRA C
7. CORRETO                              47. LETRA E
8. ERRADO                               48. LETRA C
9. LETRA C                              49. LETRA A
10. ERRADO                              50. LETRA D
11. ERRADO                              51. LETRA B
12. CORRETO                             52. LETRA D
13. ERRADO                              53. LETRA B
14. ERRADO                              54. LETRA C
15. ERRADO                              55. LETRA D
16. CORRETO                             56. LETRA E
17. LETRA C                             57. LETRA C
18. LETRA B                             58. LETRA A
19. CORRETO                             59. LETRA C
20. LETRA C                             60. LETRA E
21. LETRA C                             61. LETRA C
22. ERRADO                              62. LETRA E
23. CORRETO                             63. LETRA C
24. CORRETO                             64. LETRA A
25. CORRETO                             65. LETRA E
26. CORRETO                             66. LETRA A
27. LETRA C                             67. LETRA B
28. LETRA C                             68. LETRA A
29. ERRADO                              69. ERRADO
30. CORRETO                             70. LETRA E
31. CORRETO                             71. LETRA A
32. CORRETO                             72. LETRA D
33. CORRETO
34. CORRETO
35. CORRETO
36. ERRADO
