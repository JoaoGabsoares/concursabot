...
- big_data
- ingles_fiscal
arquivo_origem: Aula 03_012_Slide.txt
...
---
        ...
        a faixa de valores entre o primeiro quartil (Q1) e o terceiro quartil (Q3). A
...
---
        ...
        direita, o que significa que incluem o limite direito, mas não o limite esquerdo.
        Exemplo 1:
...
---
         ...
         INEP - IBFC
         Gráﬁco composto por retângulos justapostos em que a base de
...
---
         ...
         A ﬁgura a seguir é uma forma de representação gráﬁca adequada
         ...
         superintendente Cláudio Ives do órgão responsável pela ﬁscalização
         de trânsito nessas rodovias. Podemos dizer que o superintendente
         utilizou uma representação gráﬁca denominada
         A) Gráﬁco de colunas
...
---
             ...
             Função predict()
        A função predict() em R é usada para fazer previsões com base em um modelo
        estatístico ajustado. Ela é comumente usada após ajustar um modelo de
        regressão, como o modelo de regressão linear criado pela função lm().
        Exemplo 1:
...
---
        ...
        disponibilizadas gratuitamente para a comunidade de usuários do R em todo o
        mundo. O CRAN é mantido e gerenciado por voluntários e fornece acesso fácil
        aos pacotes R, permitindo que os usuários instalem e atualizem pacotes
