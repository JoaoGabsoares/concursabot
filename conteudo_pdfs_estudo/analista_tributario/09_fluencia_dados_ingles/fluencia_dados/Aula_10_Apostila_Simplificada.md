...
---
      ...
      Aula 07
                                                                                     ...
                                                                                     Índice
1) Análise de Informações - Mineração de Dados


2) Questões Comentadas - Análise de Informações - Mineração de Dados - Multibancas


3) Lista de Questões - Análise de Informações - Mineração de Dados - Multibancas
...
uma grande definição a seguir:
          ...
          open-end utilizadas para explorar, organizar e analisar de forma automática ou semi-automática1uma grande
...
em conjunto com Data Warehouses2 – não é obrigatório que o seja! Você pode aplicar técnicas de
...
previsão, identificação, classificação e otimização. Fiquem com o mnemônico para memorizar:
 ...
 IDENTIFICAÇÃO específicas de nucleotídeos em uma cadeia de DNA. A área conhecida como autenticação é uma
               ...
               um supermercado podem ser categorizados em compradores que buscam desconto, compradores
               com pressa, compradores regulares leais, compradores ligados a marcas conhecidas e
 CLASSIFICAÇÃO compradores eventuais. Essa classificação pode ser usada em diferentes análises de transações de
...
serem analisados sem erros de incompletudes, inconsistências, ruídos, entre outros3.
...
contempla seis etapas:
    ...
    4     TRANSFORMAÇÃO DE DADOS           Dados são reduzidos por meio de sumarizações, agregações e discretizações4.
...
Aprendizado de Máquina (do inglês, Machine Learning) é a área da inteligência artificial que busca
desenvolver técnicas computacionais sobre aprendizado assim como a construção de sistemas
capazes de adquirir conhecimento de forma autônoma que tome decisões baseado em experiências
acumuladas por meio da solução bem-sucedida de problemas anteriores. Trata-se de uma
ferramenta poderosa para a aquisição automática de conhecimento por meio da imitação do
comportamento de aprendizagem humano com foco em aprender a reconhecer padrões
...
legal é que seu algoritmo pode ir aprendendo sozinho o que é uma laranja ou uma maçã. Cada
vez que o usuário confirma que o programa acertou ou errou, ele é capaz de aprender e melhorar!
...
de aprendizado supervisionado, aprendizado não supervisionado e aprendizado por reforço5. É
...
técnicas de Associação, Agrupamento são de aprendizado não-supervisionado6.
...
A Detecção de Anomalias7 é basicamente um valor discrepante, ou seja, um valor que se
...
Galera, a ideia da técnica de classificação é categorizar coisas. Posso dar um exemplo? Existe uma
loja americana chamada Target – ela vende de tudo, mas principalmente roupas. Ela ficou famosa
em 2002 por conseguir adivinhar mulheres que estavam grávidas e lhes enviar cupons de desconto
relacionados a bebês. Diego, como eles fizeram isso? Cara, isso virou exemplo de problemas de
classificação de livros didáticos de mineração de dados.
...
completamente. Ela está grávida, prevista para agosto e eu que te devo desculpas"8.

Voltando à classificação! Companhias de Seguro utilizam a classificação para adivinhar quais
pacientes idosos morrerão em breve; médicos usam para verificar se bebês prematuros estão
desenvolvendo infecções perigosas (já que o classificador pode colocar indicadores sutis de doenças
antes que os humanos notem quaisquer sinais); enfim, há infinitos exemplos de utilização da
classificação como técnica de mineração de dados.
...
classificação quanto para regressão9. Por que é baseado em distância? Porque o algoritmo se baseia
...
basicamente uma representação gráfica de regras de classificação10! Elas demonstram
...
---
 ...
 Dor no BOA          ARTÉRIAS      PESO        DOENÇA             Dor no     BOA       ARTÉRIAS    PESO    DOENÇA
...
total de palavras contidas em todos os e-mails normais11 da seguinte forma:
...
dentro do contexto de e-mails indesejados12:
...
de um valor limite, estamos usando um Support Vector Classifier (SVC)13.
...
vetores de suporte é um plano14; e quando temos mais dimensões, o classificador é um hiperplano.
...
Por fim, é importante saber que o SVM é considerado um método não paramétrico15, dado que não
...
determinístico e estocástico:
  ...
  Determinístico parâmetros do algoritmo e/ou da condição inicial.
                   Métodos estocásticos podem apresentar diferentes soluções dependendo dos parâmetros e/ou
     estocástico da condição inicial.
...
grupo, alcançando a posição ótima16. Lembrando que esse algoritmo gera agrupamentos em
...
Em outras palavras, o k-Medoides escolhe objetos da própria base como protótipo17 em lugar de
...
dos grafos18 utilizado para segmentar um conjunto de dados em diferentes grupos. Qual é o
...
Na imagem seguinte, temos um mesmo conjunto de dados agrupados por meio de diversos
...
fechar, podemos dizer que GMM é uma generalização do K-Médias.
                                                 ...
                                                 Em outras palavras, nós podemos afirmar que o K-
                                                 Médias é um caso especial do modelo de misturas
                                                 gaussianas, em que as distribuições gaussianas são
                                                 consideradas iguais e esféricas, com o mesmo desvio
                                                 padrão em todas as direções! Por outro lado, o GMM é
                                                 mais flexível do que o K-Médias, uma vez que pode
                                                 modelar conjuntos de dados com distribuições
                                                 complexas e não necessariamente esféricas – isto é,
                                                 com um formato mais elipsóide. No entanto, o GMM
                                                 pode ser mais difícil de ajustar, pois envolve a estimação
                                                 de muitos parâmetros. Logo, o K-Means pode ser visto
                                                 como uma aproximação simplificada do GMM, com
                                                 menos parâmetros a serem ajustados. Fechado? Fim!
...
compra leite e fralda também tende a comprar cerveja na mesma transação19.
...
Standard Process for Data Mining) é um modelo de referência20 de mineração de dados que
...
20 Também pode ser considerado um modelo de processos, um framework de processos, uma metodologia, entre outros.
...
Essa fase inicial concentra-se no entendimento dos objetivos e requisitos do projeto de uma
perspectiva de negócio e, em seguida, na conversão desse conhecimento em uma definição de
...
problema de mineração de dados e em um plano preliminar desenvolvido para atingir os objetivos.
Em outras palavras, essa fase busca entender qual problema o negócio quer resolver! Professor,
não entendi! Calma, vamos lá...
...
A segunda fase começa com uma coleta inicial dos dados e prossegue com atividades para explorá-
los com o intuito de obter um maior conhecimento e familiaridade. Em seguida, busca-se avaliar
a qualidade dos dados, descobrir as primeiras ideias sobre os dados ou detectar subconjuntos
interessantes para formar hipóteses de informação ocultas e descobrir insights. Essa fase
também é responsável por descrever os dados – por vezes, utilizando estatísticas.
...
Também chamada de pré-processamento, nessa fase ocorre a preparação dos dados para a fase
de modelagem. Essa etapa ocorre quando já entendemos o problema do negócio e já exploramos
os dados disponíveis. Ela abrange todas as atividades para construir o conjunto de dados final a
partir dos dados brutos iniciais, isto é, aqueles que serão alimentados na ferramenta de
modelagem. Professor, e que atividades são essas? Bem, me acompanhem...
...
algoritmos a serem utilizados, como também a elaboração e execução da modelagem sobre o
conjunto de dados preparado na fase anterior. Aliás, retornar à fase de preparação é bem
frequente e necessário nessa etapa – lembrem-se que se trata de um processo iterativo e cheio de
vai e volta! Você pode criar diferentes modelos e compará-los na próxima fase! Bacana?
...
critérios de sucesso lá na primeira fase? Agora é a hora de verificar se ela foi atingida. Se não foi, é
necessário voltar a primeira fase e entender o que deu de errado, determinar um novo escopo
e tentar novamente. Caso tudo tenha dado certo, é hora de seguir em frente para a última fase. E
o que mais?
...
Também chamada de desenvolvimento, essa fase busca colocar o modelo para funcionar. Ele
coloca fim ao seu projeto, mas é necessário se lembrar de monitorar os resultados e de adaptar o
modelo sempre que necessário. Os modelos que foram desenvolvidos, ajustados, validados e
testados durante várias iterações são salvos e preparados para o ambiente de produção (o nome é
estranho, mas esse é o ambiente em que o software está de fato funcionando).
...
2. (CESPE / TRT8 – 2022) Acerca de modelos preditivos e descritivos, assinale a opção correta:
...
3. (CESPE / ISS-Aracaju – 2021) Em um projeto de data mining, a coleta do dado que será
...
4. (CESPE / ISS-Aracaju – 2021) De acordo com o modelo CRSP-DM, a seleção das técnicas que
...
Comentários:
 ...
 Entendimento dos dados
   ...
   Preparação dos dados Busca carregar os dados identificados no passo anterior e prepará-los para análise por
...
5. (CESPE / ISS-Aracaju – 2021) O enriquecimento de dados da etapa de pré-processamento e
...
6. (CESPE / PCDF – 2021) Uma das aplicações de Python é o aprendizado de máquina, que pode
...
7. (CESPE / PCDF – 2021) A detecção de novos tipos de fraudes é uma das aplicações comuns da
...
8. (CESPE / APEX – 2021) m data mining revela informações que consultas manuais não poderiam
...
9. (CESPE / TCE-RJ – 2021) A fase de implantação do CRISP-DM (Cross Industry Standard Process
...
10. (CESPE / TCE-RJ – 2021) A descoberta de conhecimento em bases de dados, ou KDD
...
11. (CESPE / TCE-RJ – 2021) Na mineração de dados preditiva, ocorre a geração de um
...
12. (CESPE / TCE-RJ – 2021) As regras de associação adotadas em mineração de dados buscam
...
13. (CESPE / TCE-RJ – 2021) Na primeira fase do CRISP-DM (Cross Industry Standard Process for
...
14. CESPE / TCE-RJ – 2021) No método de classificação para mineração de dados, a filiação dos
...
15. (CESPE / TCE-RJ – 2021) No método de mineração de dados por agrupamento (clustering), são
...
16. (CESPE / TCE-RJ – 2021) O fator de suporte e o fator de confiança são dois índices utilizados
...
17. (CESPE / TCE-RJ – 2021) Os principais métodos de análise de agrupamentos em mineração de
...
18. (CESPE / Polícia Federal – 2021) A análise de clustering é uma tarefa que consiste em agrupar
...
19. (CESPE / ME – 2020) Aprendizagem de máquina pode ajudar a clusterização na identificação de
...
20. (CESPE / ME – 2020) A técnica de associação é utilizada para indicar um grau de afinidade entre
...
21. (CESPE / ME – 2020) No modelo CRISP-DM, a fase na qual se planejam todas as atividades para
...
22. (CESPE / ME – 2020) Na etapa de mineração do data mining, ocorre a seleção dos conjuntos de
...
23. (CESPE / Ministério da Economia – 2020) A técnica de agregação na mineração de dados atua
...
24. (CESPE / Ministério da Economia – 2020) O objetivo da etapa de pré-processamento é diminuir
...
25. (CESPE / Ministério da Economia – 2020) Modelagem preditiva é utilizada para antecipar
...
26. (CESPE / ME – 2020) Outlier ou anomalias são padrões nos dados que não estão de acordo com
...
27. (CESPE / ME – 2020) A análise de regressão em mineração de dados tem como objetivos a
...
28. (CESPE / TJ-AM – 2019) A técnica machine learning pode ser utilizada para apoiar um processo
    de data mining.
...
29. (CESPE / POLÍCIA FEDERAL – 2018) Pode-se definir mineração de dados como o processo de
...
30. (CESPE / FUB – 2018) No Data Mining, uma regra de associação relaciona a presença de um
...
31. (FCC / AL-AP – 2020) Uma financeira possui o histórico de seus clientes e o comportamento
...
32. (FCC / TRF4 – 2019) Um Tribunal pretende analisar fatos (fatores ambientais e perfis
...
33. (FCC / SEFAZ/BA – 2019) Além dos indicadores reativos que, uma vez implantados,
...
34. (FCC / SANASA – 2019) Considere que a SANASA busca realizar a gestão de recursos hídricos
...
35. (FCC / SANASA Campinas – 2019) Considere que a SANASA busca realizar a gestão de recursos
...
36. (FCC / SABESP – 2018) O conceito de Data Mining descreve:
...
37. (FCC / SEFAZ-SC – 2018) Para responder à questão, considere o seguinte caso hipotético:
...
38. (FCC / DPE-RS - 2017) Uma das técnicas bastante utilizadas em sistemas de apoio à decisão é o
    Data Mining, que se constitui em uma técnica:
...
39. (FCC / AL-MS – 2016) Um famoso site de vendas sempre envia ao cliente que acabou de comprar
    um item X, ou o está analisando, a seguinte frase: Pessoas que compraram o item X também
    compraram o Y. Para isso, o site deve estar aplicando a técnica de Data Mining denominada:
...
40. (FCC / CNMP – 2015) Em relação às ferramentas de Data Discovery e os fundamentos de Data
...
41. (FCC / TRF-3R – 2014) Mineração de dados é a investigação de relações e padrões globais que
    existem em grandes bancos de dados, mas que estão ocultos no grande volume de dados. Com
    base nas funções que executam, há diferentes técnicas para a mineração de dados, dentre as
    quais estão:
...
42. (FCC / TCE-RS – 2014) A revista da CGU − Controladoria Geral da União, em sua 8ª edição,
...
43. (FCC / BANESE – 2012) Data Mining é parte de um processo maior denominado:
...
44.(FCC / TRT/14ª Região – 2011) No contexto de DW, é uma categoria de ferramentas de análise
   denominada open-end e que permite ao usuário avaliar tendências e padrões não conhecidos
...
45. (FCC / INFRAERO – 2011) No âmbito da descoberta do conhecimento (KDD), a visão geral das
    etapas que constituem o processo KDD (Fayyad) e que são executadas de forma interativa e
...
46.(FCC / TRT/4ª Região – 2010) Sobre data mining, é correto afirmar:
...
47. (FCC / TCE-SP – 2010) NÃO é um objetivo da mineração de dados (mining), na visão dos diversos
    autores,
...
48.(FCC / TCE-SP – 2010) Considere uma dada população de eventos ou novos itens que podem ser
   particionados (segmentados) em conjuntos de elementos similares, tal como, por exemplo, uma
   população de dados sobre uma doença que pode ser dividida em grupos baseados na
...
49.(FCC / TCM-PA – 2010) Especificamente, um data mining onde as tendências são modeladas
...
50. (FGV / Câmara dos Deputados – 2023) Uma escola está planejando um sistema de
...
51. (FGV / SMF-RJ – 2023) O fiscal de rendas Renan está explorando a base de dados sobre a
...
52. (FGV / SMF-RJ – 2023) Observe a seguinte estrutura do conjunto de dados PESSOA que contém
    dados sobre pessoas e a sua renda anual.
...
53. (FGV / EPPGG - 2023) A mineração de dados ou data mining é uma disciplina interdisciplinar e
    multidisciplinar que envolve diversas áreas de conhecimento. Assinale a alternativa que
    enumera corretamente dois tipos de modelagem para análise de dados:
...
54. (FGV / Receita Federal - 2023) A Análise de Componentes Principais (PCA) é uma técnica de
...
55. (FGV / TCE-TO – 2022) Ao analisar um grande volume de dados, João encontrou algumas
...
56. (FGV / TJDFT – 2022) Maria está explorando a seguinte tabela da base de dados de vendas do
    mercado HortVega:
...
57. (FGV / SEFAZ-AM – 2022) Leia o fragmento a seguir. “CRISP-DM é um modelo de referência
...
58. (FGV / SEFAZ-AM – 2022) O tipo de aprendizado máquina, que consiste em treinar um sistema
    a partir de dados que não estão rotulados e/ou classificados e utilizar algoritmos que buscam
    descobrir padrões ocultos que agrupam as informações de acordo com semelhanças ou
...
59. (FGV / SEFAZ-AM – 2022) Leia o fragmento a seguir.
...
60.(FGV / SEFAZ-ES – 2021) Maria está preparando um relatório sobrea as empresas de serviços
...
61. (FGV / DETRAN-RN – 2010) Sobre Data Mining, pode-se afirmar que:
...
62. (FGV / Senado Federal – 2008 – Letra A) Em Regras de Associação, confiança refere-se a
...
63. (FEPESE / ISS-Criciúma – 2022) Quais tipos de conhecimento podem ser descobertos
...
64.(FEPESE / ISS-Criciúma – 2022) São técnicas de Inteligência Artificial de Data Mining:
...
65. (CESGRANRIO / BB – 2021) Um banco decidiu realizar uma ação de marketing de um novo
...
66. (AOCP / MJSP – 2020) Dentre os métodos de mineração de dados, existem aqueles que são
...
67. (IBADE / Prefeitura de Vila Velha – 2020) O processo de explorar grandes quantidades de dados
    a procura de padrões consistentes, para detectar relacionamentos sistemáticos entre variáveis,
    detectando assim novos subconjuntos de dados é chamado de:
...
68. (NC-UFPR / Itaipu – 2019) Os algoritmos de Mineração de Dados podem ser classificados
...
69. (CESGRANRIO / BANCO DA AMAZÔNIA – 2018) As ferramentas e técnicas de mineração
...
70. (COPESE / UFT – 2018 – Item III) Diversos modelos de Redes Neurais Artificiais podem ser
...
71. (FAURGS / FAURGS – 2018) Uma nuvem de palavras é um recurso gráfico (usado
...
72. (CESGRANRIO / Petrobrás – 2018) Dois funcionários de uma empresa de crédito discutiam
...
73. (ESAF / STN – 2018) Uma técnica de classificação em Mineração de Dados é uma abordagem
    sistemática para:
...
74. (CESGRANRIO / TRANSPETRO – 2018) Um desenvolvedor recebeu um conjunto de dados
...
75. (FEPESE / CIASC – 2017) Assinale a alternativa que contém as principais fases do processo de
    Data Minning CRISP-DM.
...
76. (NC-UFPR / Itaipu Binacional – 2015) Qual é a funcionalidade do Oracle Data Mining que
...
77. (AOCP / TCE-PA – 2014) O processo de explorar grandes quantidades de dados à procura de
...
78. (VUNESP / TJ-PA – 2014) Uma das tarefas implementadas por uma ferramenta de Data
...
79. (FUNDEP / IFN/MG – 2014) Ao se utilizar a técnica de data mining (mineração de dados), como
    é conhecido o resultado dessa mineração, em que, por exemplo, se um cliente compra
...
80.(FAURGS / TJ-RS – 2014) O resultado da mineração de dados pode ser a descoberta de tipos de
   informação “nova”. Supondo-se que um cliente compre uma máquina fotográfica e que, dentro
   de três meses, compre materiais fotográficos, há probabilidade de que, dentro dos próximos
   seis meses, ele comprará um acessório. Um cliente que compra mais que duas vezes, em um
   período de baixa, deverá estar propenso a comprar, pelo menos uma vez, no período do Natal.
   Esse tipo de informação pode ser verificado através de:
...
81. (CESGRANRIO / LIQUIGÁS – 2014) As empresas possuem grandes quantidades de dados. Em
    geral, a maioria delas é incapaz de aproveitar plenamente o valor que eles têm. Com o intuito
...
82. CCV-UFC / UFC / 2013) Sobre Mineração de Dados, assinale a alternativa correta.
...
83. (FMP CONCURSOS / MPE-AC – 2013) Processo de explorar grandes quantidades de dados à
...
84.(IBFC / EBSERH – 2013) Processo de explorar grandes quantidades de dados à procura de
...
85. (FUNRIO / MPOG – 2013) Qual o tipo de descoberta de conhecimento através de mineração de
    dados (do inglês “data mining”), em que se relaciona a presença de conjuntos de itens diversos,
    como por exemplo: “Quando uma mulher compra uma bolsa em uma loja, ela está propensa a
    comprar sapatos”?
...
---
 ...
 Aula 07
                                               ...
                                               GABARITO
1. CORRETO                              30. CORRETO                              59. LETRA D
2. LETRA D                              31. LETRA C                              60. LETRA B
3. LETRA B                              32. LETRA E                              61. LETRA E
4. LETRA A                              33. LETRA E                              62. ERRADO
5. LETRA E                              34. LETRA B                              63. LETRA C
6. CORRETO                              35. LETRA B                              64. LETRA A
7. ERRADO                               36. LETRA A                              65. LETRA C
8. LETRA B                              37. LETRA D                              66. LETRA D
9. CORRETO                              38. LETRA A                              67. LETRA E
10. ERRADO                              39. LETRA B                              68. LETRA A
11. CORRETO                             40. LETRA A                              69. LETRA D
12. CORRETO                             41. LETRA C                              70. CORRETO
13. ERRADO                              42. LETRA B                              71. LETRA A
14. ERRADO                              43. LETRA C                              72. LETRA A
15. CORRETO                             44.LETRA E                               73. LETRA B
16. CORRETO                             45. LETRA A                              74. LETRA B
17. CORRETO                             46.LETRA A                               75. LETRA C
18. CORRETO                             47. LETRA A                              76. LETRA D
19. CORRETO                             48. LETRA D                              77. LETRA E
20. CORRETO                             49. LETRA E                              78. LETRA D
21. ERRADO                              50. LETRA B                              79. LETRA A
22. ERRADO                              51. LETRA D                              80.LETRA E
23. ERRADO                              52. LETRA D                              81. LETRA B
24. CORRETO                             53. LETRA A                              82. LETRA C
25. CORRETO                             54. LETRA B                              83. LETRA C
26. CORRETO                             55. LETRA D                              84.LETRA B
27. CORRETO                             56. LETRA C                              85. LETRA C
28. CORRETO                             57. LETRA D
29. CORRETO                             58. LETRA E
