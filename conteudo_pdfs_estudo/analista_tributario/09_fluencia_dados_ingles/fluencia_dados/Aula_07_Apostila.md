...
2) Análise de Informações - Modelagem Lógica - Tabelas


3) Análise de Informações - Modelagem Lógica - Álgebra Relacional


4) Análise de Informações - Modelagem Lógica - Visões (Views)


5) Análise de Informações - Modelagem Lógica - Índices (Index)


6) Análise de Informações - Modelagem Lógica - Chaves


7) Análise de Informações - Modelagem Lógica - Relacionamentos


8) Análise de Informações - Modelagem Lógica - Regras de Codd


9) Análise de Informações - Modelagem Lógica - IDEF1X


10) Resumo - Análise de Informações - Modelagem Lógica


11) Mapa Mental - Análise de Informações - Modelagem Lógica


12) Questões Comentadas - Análise de Informações - Modelagem Lógica - Multibancas


13) Lista de Questões - Análise de Informações - Modelagem Lógica - Multibancas
...
Aula 05
   ...
   d) Relação, domínio e registro                          ==219a34==
...
Aula 05
   ...
   (TCE/SC – 2022) O índice secundário é empregado quando se utiliza um campo de
   indexação que não seja a chave primária da tabela.
   _______________________
...
as tabelas, como é apresentado no esquema seguinte:
 ...
 222.222.222-22    RENATO DA COSTA                     TABELA associativa
                                                              ==219a34==
...
Em uma tabela de banco de dados, atributos referem-se às colunas, enquanto registros ou linhas
representam as entradas de dados individuais. Logo, uma tabela com 205 atributos significa que ela
tem 205 colunas, cada uma podendo conter uma categoria de dado diferente. O número de
registros (linhas) na tabela é independente do número de atributos (colunas) e precisa ser
determinado separadamente. A quantidade de registros é a quantidade de entradas de dados na
tabela, enquanto o número de atributos é a quantidade de diferentes tipos de informação que cada
registro pode conter.
...
O termo "hiperchave" não é comumente usado na literatura padrão de banco de dados. Na teoria
de banco de dados, especialmente no modelo relacional, uma “superchave” é um conjunto de
atributos (ou colunas) em uma tabela que pode ser usado para identificar de forma única cada tupla
(ou linha) na tabela. Ela pode incluir um ou mais atributos que, em combinação, são suficientes para
garantir a unicidade de cada registro. Uma chave primária é um tipo especial de superchave, que é
minimamente suficiente para garantir a unicidade, ou seja, não contém atributos desnecessários.

Em suma: não existe o conceito de hiperchave e não faz sentido “recuperar uma relação de uma
...
45. (CESPE / TJDFT – 2015) Em um banco de dados relacional, a chave estrangeira que existe em
...
46.(CESPE / MPU – 2013) Uma chave primária não existe sem uma chave estrangeira
   correspondente.
...
47. (CESPE / TRT-ES – 2013) Chave estrangeira é o atributo ou conjunto de atributos que se refere
...
48.CESPE / Banco da Amazônia – 2012) A operação da álgebra relacional SELECT extrai as tuplas
...
49. (CESPE / TJ-RO – 2012) Associado a uma tabela, sempre existe um índice, que é uma estrutura
...
50. (CESPE / BASA – 2012) O valor de uma chave estrangeira que apareça em uma tabela deve,
...
valor de uma chave primária pode ser nulo. Esse era o entendimento até cerca de 2014!

                                                                                       Gabarito: Errado

51. (CESPE / CORREIOS – 2011) No acesso aos dados de tabelas em um banco de dados, a
...
52. (CESPE / MEC – 2011) Quando se transforma um modelo conceitual em um modelo lógico, os
...
53. (CESPE / EBC – 2011) O modelo relacional de banco de dados possui uma estrutura de dados
...
54. (CESPE / MEC – 2011) A restrição de integridade de entidade estabelece que nenhum valor de
...
55. (FCC / SEFAZ-AP – 2022) Considere que durante a modelagem de um banco de dados relacional
...
57. (FCC / SEFAZ-AP – 2022) Com base nessas informações, é correto afirmar:
...
58. (FCC / TRF4 – 2019) Dentre as regras de Codd que caracterizam Bancos de Dados Relacionais, a
...
59. (FCC / SEFAZ - SP – 2009) Considere a seguinte regra de Codd, aplicada aos bancos de dados
...
60.(FCC/ TRF – 4 REGIÃO(RS) – 2011) No contexto de banco de dados relacional, das 12 regras
...
61. (FCC / TRE-AP – 2015) Leia, abaixo, a descrição das propriedades de um modelo lógico de dados
...
62. FCC / TJ-APP – 2014) Uma das formas de se garantir a integridade em um banco de dados é por
...
63. (FCC / TJ-AP – 2014) Em um banco de dados, uma maneira de aumentar a segurança é a
...
64.(FCC / SEFAZ-PE – 2014) Um Sistema de Gerenciamento de Banco de Dados (SGBD) é um
...
65. (FGV / SEAD-AP – 2022) Considere a tabela TABX, implementada num banco de dados
...
66. (FGV / SEFAZ-BA – 2022) Com relação aos conceitos de banco de dados relacionais, analise
...
67. (FGV / SEFAZ-AM – 2022) A estrutura de dados usada em índices multiníveis dinâmicos em
...
68. (FGV / IBGE - 2017) Na década de 80, Edgar Frank Codd definiu um conjunto de regras para
...
aplicativos; (d) Correto, trata-se da Regra 00; (e) Correto, trata-se da Regra 11.
                                                                       ...
                                                                       Gabarito: Letra C
69. (FGV / MPE-AL – 2018) Em um banco de dados relacional, um nome da tabela, uma chave
...
70. (FGV / AL-RO – 2018) No processo de otimização e processamento de consultas em bancos de
...
71. (FGV / MPE-AL – 2018) No contexto da otimização de consultas para bancos de dados, a
...
72. (FGV / AL-RO – 2018) O diagrama IDEF1X exibido a seguir será referenciado na questão
    seguinte.
...
73. (FGV / AL-RO – 2018) Na representação de esquemas para bancos de dados relacionais por
...
74. (FGV / AL-RO – 2018) Com relação ao diagrama IDEF1X, considere as afirmativas a seguir sobre
...
75. (FGV / IBGE – 2017) Em relação a banco de dados relacionais, analise as afirmativas abaixo:
...
76. (FGV / COMPESA – 2016) A teoria de consultas para bancos de dados relacionais supõe cinco
...
77. (FGV / COMPESA – 2016) Analise o diagrama ER, exibido a seguir com a notação IDEF1X pé-
    de-galinha.
...
78. (FGV / TCE-SE – 2015) Diagramas entidade-relacionamento na notação IDEF1X distinguem
...
79. (FGV / TJ-PI – 2015) Analise o diagrama ER construído sob a notação IDEF1X.
...
80.(FGV / AL-MT – 2013) Com relação às definições dos diferentes tipos de chaves em um projeto
...
81. (FGV / Senado Federal – 2012) Fabricantes de armas são obrigados a imprimir um número de
...
82. (FGV / BADESC – 2010) A chave estrangeira se encontra na própria tabela de um
...
83. (FGV / BADESC – 2010) No intuito de determinar, entre duas entidades, se um relacionamento
...
84.(FGV / DETRAN-RN – 2010) Assinale a alternativa que corresponde ao recurso do modelo de
...
85. (FGV / BADESC – 2010) Considere o seguinte texto.
...
86. (FGV / MEC – 2009) No contexto de Banco de Dados, um conceito assegura que um valor que
...
87. (FGV / MEC – 2009) As restrições de integridade resguardam o Banco de Dados contra danos
...
88. (FGV / Senado Federal – 2008) Com relação ao conceito de chave estrangeira, é correto
   afirmar que:
...
89. (QUADRIX / CRF-GO – 2022) A técnica IDEF (Integrated Definition), a exemplo da técnica
...
90.(FEPESE / ISS-Criciúma – 2022) Sobre restrições no modelo relacional, associe o tipo de
...
91. (FEPESE / ISS-Criciúma – 2022) São todos tipos de restrições ou constraints que podem ser
...
92. (IFB / IFB – 2017) Segundo Elmasri (2011), na terminologia formal do modelo relacional, uma
    linha, um cabeçalho de coluna e a tabela, são chamados, respectivamente, de:
...
93. (IBFC / Polícia Científica – 2017) No modelo relacional, cada registro de uma tabela tem um
...
94.(IF-CE / IF-CE – 2017) Do ponto de vista de um banco de dados relacional, um ou mais campos
...
95. (CS-UFG / DEMAE-GO – 2017) O principal objetivo dos índices em bancos de dados relacionais
    é:
...
96.    (IF/PA / IF/PA – 2016) Analise as seguintes afirmações sobre Banco de Dados:
...
97. (FCM / IFF-RS – 2015) Em um banco de dados relacional, algumas regras são aplicadas às
   chaves, assim:
...
98. (IESES / MSGAS – 2015) No projeto de banco de dados relacional, a integridade de entidades
...
99. (CETAP / MPCM – 2015) Sobre o conceito de chave primária, relacionado a um registro em
...
100. (NC-UFPR / ITAIPU BINACIONAL – 2015) Quando uma chave primária de uma tabela é
...
101. (CESGRANRIO / Banco da Amazônia – 2014) Para responder à questão, tenha como
...
Note que a Entidade Cliente tem arestas retas e a Entidade Conta tem arestas arredondadas, logo
...
102. (VUNESP / PRODEST-ES – 2014) Sobre a chave primária de uma tabela de um banco de
...
103. (VUNESP / DESENVOLVESP – 2014) Em um banco de dados relacional deve haver, em cada
...
104. (CESGRANRIO / PETROBRAS – 2014) A álgebra relacional fornece um alicerce formal para
...
105. (UEPA / SEAD - 2013) A estrutura de planejamento na maior parte das bases de dados segue
...
106. (SELECON / EMGEPRON - 2012) Considere:
...
107. (FIP / Câmara Municipal De São José Dos Campos/SP – 2009) Em um banco de dados
...
1. CORRETO                              38. LETRA E                              75. LETRA A
2. ERRADO                               39. ERRADO                               76. LETRA E
3. ERRADO                               40. CORRETO                              77. LETRA C
4. ERRADO                               41. CORRETO                              78. LETRA C
5. ERRADO                               42. ERRADO                               79. LETRA B
6. CORRETO                              43. ERRADO                               80.LETRA B
7. ERRADO                               44.CORRETO                               81. LETRA C
8. LETRA A                              45. CORRETO                              82. LETRA A
9. CORRETO                              46.ERRADO                                83. LETRA B
10. LETRA B                             47. CORRETO                              84. LETRA B
11. LETRA A                             48. CORRETO                              85. LETRA C
12. LETRA C                             49. ERRADO                               86. LETRA E
13. CORRETO                             50. ERRADO                               87. LETRA C
14. CORRETO                             51. CORRETO                              88. LETRA D
15. ERRADO                              52. CORRETO                              89. ANULADA
16. ERRADO                              53. CORRETO                              90.LETRA D
17. ERRADO                              54. ERRADO                               91. LETRA C
18. ERRADO                              55. LETRA E                              92. LETRA B
19. CORRETO                             56. LETRA C                              93. LETRA C
20. CORRETO                             57. LETRA D                              94.LETRA E
21. CORRETO                             58. LETRA A                              95. LETRA B
22. LETRA E                             59. LETRA A                              96. LETRA D
23. ERRADO                              60.LETRA B                               97. LETRA B
24. CORRETO                             61. LETRA C                              98. LETRA B
25. CORRETO                             62. LETRA D                              99. LETRA E
26. ERRADO                              63. LETRA E                              100. LETRA D
27. ERRADO                              64.LETRA C                               101. LETRA B
28. CORRETO                             65. LETRA B                              102. LETRA B
29. ERRADO                              66. LETRA B                              103. LETRA B
30. CORRETO                             67. LETRA D                              104. LETRA C
31. ERRADO                              68. LETRA C                              105. LETRA A
32. ERRADO                              69. LETRA A                              106. LETRA C
33. LETRA D                             70. LETRA B                              107. LETRA E
34. LETRA B                             71. LETRA B
35. CORRETO                             72. LETRA C
36. ERRADO                              73. LETRA D
37. ERRADO                              74. LETRA B
