...
aula_numero: '05'
titulo_aula: '▪ Propriedade #1: um banco de dados representa algum aspecto do mundo
  real – algumas'
---
...
▪ Administrador de Dados:
   ...
   desenvolver o projeto e modelagem de banco de dados; manter atualizados os dados
   corporativos.
