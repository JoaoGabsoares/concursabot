...
5) Funções Comunicativas do Discurso


6) Resumo Aula 02 Teoria


7) Questões Comentadas (A2) e Textos Traduzidos FGV


8) Quadros de Vocabulários (A2) e Sinônimos FGV


9) Lista de Questões (A2) FGV
...
Neste tópico, vamos aprender sobre os adjetivos em inglês, que são palavras que modificam ou
caracterizam os substantivos. Vamos ver cada uma das suas características em detalhes: a
posição, a formação e o grau dos adjetivos.
...
Quando compostos e vêm antes de um substantivo são separados por um hífen:


Part-time jobs – empregos de meio período
Full-time students – estudantes em tempo integral
Kid-friendly stores – lojas próprias/adequadas para crianças
Eco-friendly companies – empresas que respeitam o meio-ambiente, ecológicas
Environmentally-friendly processes – processos ecologicamente corretos
...
Existe plural de adjetivos? Como já dito anteriormente, em inglês, adjetivos são invariáveis, ou
...
pessoas que possuem uma determinada característica. Então, as palavras são substantivadas, ou
...
The Rich Cut Their Spending (newyorktime.com) – Os Ricos Cortam/Reduzem Seus Gastos
...
language prompts. ChatGPT then offers conversational, if somewhat stilted, responses.
                                                        ==219a34==
...
conversacionais, se bem que um tanto forçadas.
...
DICA: Quando um adjetivo termina com o sufixo “–ING”, ele costuma expressar a ideia de
causa, e quando ele termina com “-ED” (particípio), ele costuma expressar uma consequência.
Observe a lista e a tradução dos adjetivos:
...
Judge the following item, according to the preceding comic strip.
Julgue o item seguinte, de acordo com a tirinha cômica precedente.


28 The words “beautiful” (third box) and “lucky” (fifth box) belong to the same word class.
28 As palavras "lindo" (terceiro quadro) e "sortudo" (quinto quadro) pertencem à mesma classe
de palavras.


Ambas as palavras são adjetivos, que são palavras que modificam ou descrevem substantivos.
Por exemplo, na tirinha, "beautiful" (lindo) modifica o substantivo "May"(Maio) e
"lucky"(sortudo) modifica o pronome "you"(você). Adjetivos podem ter diferentes formas, como
comparativo (por exemplo, more beautiful, luckier) ou superlativo (por exemplo, most beautiful,
luckiest), e eles também podem ser usados como substantivos (por exemplo, the beautiful, the
lucky).


GABARITO: CERTA

        1.3. Graus dos Adjetivos: Comparativos e Superlativos
...
This book is less interesting than the one I read yesterday.
Este livro é menos interessante do que o que eu li ontem.
...
Question number 23 was easy. It was easier than question 22.
...
Question 22 is more difficult than question 23.
...
The keenest linguistic sleuth won an award.
...
quanto a que formato do adjetivo da frase do texto é igual ao de uma das frases das opções. No
tópico “Adjetivos” vemos que geralmente o adjetivo em Inglês vem antes do substantivo. Os
graus dos adjetivos também estão em detalhes lá na parte teórica. Vemos que quando o adjetivo
está no grau Superlativo, se a palavra for curta há a terminação EST no final. Se o adjetivo base
...
for uma palavra longa se coloca o “most” antes dele. Portanto, nesse pequeno segmento de
duas palavras, “countries” é o substantivo e “poorest” é o adjetivo no grau Superlativo. Essa é a
opção que também tem um adjetivo no grau superlativo: most comfortable. Essa é a correta.
...
Os advérbios de lugar indicam onde algo acontece. Eles não modificam adjetivos ou outros
...
Embora a maioria dos advérbios de modo terminem em –ly, existem algumas exceções. Sempre
analise o contexto pois algumas delas podem ser adjetivo em alguns casos e em outros são
advérbios:
...
hard (adjetivo ou advérbio)                                    duramente, muito; dedicado, esforçado

                                                 Hard vs Hardly
Cuidado: É comum os alunos confundirem o hard (muito, duramente) com o hardly
...
Mark is a hard worker. He works hard. But Tim hardly works.
Marcos é um trabalhador esforçado. Ele trabalha muito. Mas o Tim quase não trabalha.


No exemplo acima, na primeira frase o hard é adjetivo e na segunda frase o hard é advérbio. E
na terceira frase hardly é advérbio. Porém, memorize seu significado para não confundir com o
...
Atenção! Algumas palavras que terminam em –ly deve se analisar o contexto para ver se são
adjetivos ou advérbios:

friendly                                                          amigável, amigavelmente/amistosamente

lively                                                            animado, alegre; com ânimo
...
Na primeira frase acima a palavra “friendly” é adjetivo pois descreve um substantivo: person
...
Observe no quadro de resumo abaixo a classificação dos advérbios de acordo com o seu uso.
 ...
 Intensidade                       enough (suficiente), rather             (deveras),   equally   (igualmente),
...
---
  ...
  Aula 02
                         ...
                         2.7. Adjuncts; Disjuncts, Conjuncts


Os advérbios são freqüentemente colocados em vários lugares em uma frase. Um advérbio é um
adjunto (adjunct) se estiver bem colocado (nitidamente) dentro da oração.


We often study English in the afternoon.
Geralmente estudamos Inglês à tarde.


Um advérbio é um disjunto (disjunct) se for separado do resto da oração e age como um tipo de
avaliador para ela.
...
Por fim, um advérbio age como uma oração conjunta (conjunct), se estiver separado de uma
oração, geralmente com uma vírgula, e serve como conexão entre duas idéias.


If they start fighting again, then we’re not staying.
Se eles começarem a brigar novamente, então iremos embora.
...
training data for it to learn from.
...
(Analista Tecnológico - Banco do Brasil - FGV – 2023)
It's not omniscient or smart enough to replace all humans yet, but it can be creative, and its
answers can sound downright authoritative.
...
(Professor de Inglês – SEDUC-TO- FGV – 2023)

47. The adverb “really” in the first sentence indicates
...
Boy: I am really hungry. How do I enlarge the font in my alphabet soup?
Garoto: Estou com muita fome. Como aumento o tamanho das letras na minha sopa de
letrinhas?


47. The adverb “really” in the first sentence indicates
47. O advérbio “muita” na primeira frase indica:
...
Errada. Um advérbio de tempo é uma palavra que indica quando, por quanto tempo ou com que
frequência algo acontece. Exemplos: agora (now), ontem (yesterday).


(B) place. - lugar


Errada. Um advérbio de lugar é uma palavra que indica onde algo acontece. Exemplos: aqui
(here), lá (there).
...
Certa. Um advérbio de intensidade é uma palavra que modifica um adjetivo, um verbo ou outro
advérbio, expressando o grau ou a quantidade de algo. Neste caso, o advérbio "muita" modifica
o adjetivo "fome", indicando que o menino tem um alto nível de fome.


(D) negation. – negação


Errada. Um advérbio de negação é uma palavra que nega ou contradiz algo. Exemplos: não (no),
jamais (never).
...
Errada. Um advérbio de frequência é uma palavra que indica com que frequência algo acontece.
Exemplos: sempre (always), às vezes (sometimes).
...
His decision was unfair and unacceptable.
...
OVER (excessivo, demais)                 overdue (atrasado), overflow (inundação)
                                                        ==219a34==
...
---
  ...
  Aula 02
    ...
    F UNÇÕES C OMUNICATIVAS DO D ISCURSO

A função comunicativa do discurso é o propósito por trás da comunicação. Pode ser informar,
persuadir, entreter ou instruir. É sobre o "porquê" da comunicação. Por exemplo, um discurso
instrucional seria uma receita: "First, preheat the oven to 350°F. Then, mix the flour and sugar."
(Primeiro, pré-aqueça o forno a 180°C. Em seguida, misture a farinha e o açúcar.) Um discurso
persuasivo pode ser um comercial: "Buy our new product and experience the difference!"
(Compre nosso novo produto e sinta a diferença!). Dentro desse discurso instrucional, podem
estar presentes várias funções da linguagem, como a referencial (informar os passos da receita) e
a conativa (influenciar o leitor a seguir as instruções).

                                     Funções da Linguagem


As funções da linguagem são categorias que descrevem a intenção do discurso. As principais
são:


• Referencial: Informar ou referir-se a algo. Ex: Brazil is the largest country in South America. (O
Brasil é o maior país da América do Sul.)


• Emotiva: Expressar sentimentos ou emoções. Ex: I am so happy today!" (Estou tão feliz hoje!)


• Conativa: Influenciar o comportamento do receptor. Ex: "Please, close the door." (Por favor,
feche a porta.)


• Fática: Estabelecer ou manter a comunicação. Ex: "Hello? Can you hear me?" (Alô? Você está
me ouvindo?)


• Metalinguística: Falar sobre a própria linguagem. Ex: "The word 'love' is a noun." (A palavra
'amor' é um substantivo.)


• Poética: Focar na estética da mensagem. Ex: "The starry sky lights up the night." (O céu
estrelado ilumina a noite.)
...
Portanto, enquanto as funções da linguagem são categorias amplas que descrevem diferentes
aspectos da comunicação, a função comunicativa do discurso é mais específica e contextual,
focando no objetivo particular de uma interação comunicativa.

                                         Registro Discursivo


O registro discursivo (discourse register) refere-se ao estilo ou nível de formalidade ou
informalidade da linguagem usada em diferentes contextos. Pode variar de formal a informal,
dependendo da situação, do público e do propósito da comunicação. É sobre o "como" a
comunicação é feita. O registro discursivo é uma ferramenta que ajuda a cumprir a função
comunicativa do discurso. Dependendo do público e do contexto, o registro pode variar para
melhor alcançar o objetivo da comunicação. Por exemplo, um discurso persuasivo pode usar um
registro mais formal em um contexto profissional e um registro mais informal em um contexto
casual. Portanto, o registro discursivo é uma parte integrante da função comunicativa do
discurso, adaptando-se ao contexto para melhor realizar o propósito da comunicação.


Por exemplo, em uma reunião de negócios, você pode usar um registro formal: "Good
afternoon, everyone. Let's commence our discussion on the quarterly financial report." (Boa
tarde a todos. Vamos começar nossa discussão sobre o relatório financeiro trimestral.) Em um
ambiente casual com amigos, você usaria um registro informal: "Hey, what's up? Let's talk about
how much we've spent this month." (E aí, pessoal? Vamos falar sobre quanto gastamos este
mês.)

                                        Variação Linguística


A variação linguística na língua inglesa é um fenômeno que reflete as diferenças na forma como
o inglês é falado e escrito em diferentes regiões, contextos sociais, históricos e situacionais.
Essas variações podem ser observadas em aspectos como vocabulário, pronúncia, gramática e
uso de expressões idiomáticas.


Variação Geográfica:
A variação geográfica refere-se às diferenças regionais no uso do inglês. Por exemplo, o inglês
britânico e o inglês americano têm várias diferenças de vocabulário e ortografia. Por exemplo,
no inglês britânico, usa-se "lift" para o que os americanos chamam de "elevator." Outros
exemplos:
...
• Inglês Britânico: "Flat" (apartamento), "Colour" (cor).
• Inglês Americano: "Apartment" (apartamento), "Color" (cor).


Variação Histórica:
A variação histórica mostra como a língua evolui ao longo do tempo. Termos e expressões que
eram comuns no passado podem cair em desuso ou mudar de significado. Exemplo:


• Antigo: "Thou art" (Tu és).
• Moderno: "You are" (Você é).

                                                        ==219a34==

Variação Social:
A variação social refere-se às diferenças no uso da língua entre diferentes grupos sociais. Isso
pode incluir gírias, jargões profissionais e formas de tratamento. Exemplo:


• Gíria Jovem: "Lit" (Incrível, animado).
• Linguagem Formal: "Excellent" (Excelente).


Variação Situacional:
A variação situacional depende do contexto em que a comunicação ocorre. A linguagem pode
ser mais formal ou informal dependendo da situação.


• Formal: "I would like to request your assistance." (Gostaria de solicitar sua ajuda.)
• Informal: "Can you help me out?" (Você pode me ajudar?)


A variação linguística na língua inglesa demonstra a riqueza e a diversidade da comunicação,
adaptando-se às necessidades e contextos dos falantes. Essas variações são essenciais para a
compreensão e a eficácia da comunicação em diferentes situações.

                                        Pluralidade Cultural


A pluralidade cultural na língua inglesa refere-se à coexistência de diversas culturas, crenças e
práticas dentro das comunidades de falantes de inglês ao redor do mundo. Essa diversidade
...
enriquece a língua, trazendo variações no vocabulário, expressões idiomáticas, pronúncia e até
mesmo na gramática.


Nos Estados Unidos, a pluralidade cultural é evidente na celebração de vários festivais culturais,
como o Ano Novo Chinês, Diwali e Cinco de Mayo. A pluralidade cultural pode ser vista na
diversidade de culinárias disponíveis em cidades como Nova York e Londres onde você pode
encontrar restaurantes que servem comida italiana, mexicana, indiana, chinesa, etíope, e do
Oriente Médio.


No Canadá, a pluralidade cultural é refletida no bilinguismo oficial do país, reconhecendo tanto
o inglês quanto o francês como línguas oficiais. Exemplos: Toronto Caribbean Carnival e o
Vancouver International Film Festival. Escolas em sociedades multiculturais frequentemente
incluem currículos que ensinam sobre diferentes culturas e histórias, promovendo a
conscientização e a sensibilidade cultural entre os alunos.


Empresas que abraçam a pluralidade cultural frequentemente têm equipes diversificadas, o que
pode levar a soluções mais inovadoras e a uma melhor compreensão dos mercados globais. A
pluralidade cultural na língua inglesa não só enriquece a comunicação, mas também promove a
inclusão e o respeito às diferenças. Ela permite que os falantes de inglês ao redor do mundo
aprendam uns com os outros, troquem experiências e desenvolvam uma maior compreensão e
empatia.
...
Leia o texto I e responda às questões 01 a 03.
...
fazer perguntas antes de usar o YouTube.
...
Muito pelo contrário, na opinião do autor, o usuário do YouTube como ferramenta de
...
Observe que a frase citada no enunciado, “It’s tempting see tools like this” = “É tentador ver
...
Observe no segmento do texto acima que a avaliação/análise sustentável tem um campo de
ação mais amplo/maior do que a avaliação/análise ambiental, visto que apenas a ambiental não é
suficiente para proteger o patrimônio da mineração. Correta.
...
conhecida. Agora já fica mais fácil deduzir que a palavra significa desterrar. Mas não reflete o
significado do texto. Errada.
...
Dica da Ena: Aprenda o uso desses verbos modais, pois eles caem aos montes em concursos
de todas as bancas.
...
eliminação de resíduos. Certamente esses impactos vão precisar ser gerenciados em toda a vida
...
6successionary drama: fistfights, lawsuits, power struggles, and disinheritances.
        The early tugs were expensive to staff and almost comically difficult to steer. A twelve-
hundred-horsepower boat might burn twenty tons of coal in a day and require ten men to shovel
it. Every time the tug needed to reverse direction, the engine had to be stopped and restarted,
by which point the boat might well have run aground.
...
22 currents intersect and wind barrel down from surrounding slopes, when a narrow channel
must be negotiated
...
accelerated dramatically. Tugs that could once afford to lie at port for a week or two now have
turn-arounds of less than twenty-four hours. It is a new era for tugboats!
...
Disinheritance = deserdação, exclusão de um testamento ou herança
...
Rebocar navios é um negócio dinástico, difícil de estabelecer e mais difícil ainda para desistir. Ele
é construído em profunda fidelidade e margens acirradas, e seu funcionamento interno está
cheio de intrigas e dramas sucessivos: brigas, processos, lutas de poder e exclusões de heranças.
...
Dica da Ena: numa questão como essa, se você conseguir entender o que diz as opções,
marque aquela única que tem informação oposta a todas as outras.
...
a narrow channel must be negotiated under bridges, between breakwaters, and into a crowded
port - the tug captain assumes control.
...
As opções têm significados similares e são opostos ao texto. Erradas.
...
Os rebocadores não continuam os mesmos, eles têm mudado em alguns aspectos. O texto deixa
...
Opção E: a tug captain must be an exceptional seaman = Um capitão de rebocador deve ser um
...
effectiveness. Bill Gates is quoted as stating, “The first rule of any technology used in a business
...
opções, que são antônimas: bênção ou maldição, ou seja, é apresentada uma dúvida.
...
Bill Gates is quoted as stating, “The first rule of any technology used in a business is that
...
com exceção da B, refletem algo negativo e elas são sinônimos entre si, só por isso já não
podem ser corretas.
...
frequentemente questionam o retorno do investimento através de uma maior eficiência e maior
...
Leia o texto 2 e responda às questões 21 a 24:
...
Observe os sinônimos entre as palavras do título e do texto. É justamente isso que o título
...
(F) Government auditors work less than other auditors.
...
(F) Os auditores governamentais trabalham menos que outros auditores.
...
(T) The work of government auditors is more demanding.
(T) O trabalho dos auditores governamentais é mais exigente.
...
(F) Private sector auditors feel as much pressure as other auditors.
(F) Os auditores do setor privado sentem tanta pressão quanto os outros auditores.
...
23. When the author qualifies the role of auditors as “pivotal”, he means it is:
23. Quando o autor qualifica o papel dos auditores como “essencial”, ele quer dizer que é
...
In other words = em outras palavras = put simply = dito de maneira simples
...
A expressão usada reflete “tempo”. Não tem o mesmo significado daquela do enunciado.
Errada.
...
governo seja bem fundamentada e não abusada.
...
e aprovaram pelo menos 27 leis de privacidade online regulando os mercados de dados e
...
fevereiro de 2022 – Recuperado em 6 de setembro de 2022
                                                 ...
                                                 TEXTO 7
AGENTE DA FISCALIZAÇÃO – TI – TCE-SP – FGV -2023


READ THE TEXT AND ANSWER QUESTIONS 21 TO 26:
LEIA O TEXTO E RESPONDA ÀS QUESTÕES 21 A 26:


                                       Is It Live, or Is It Deepfake?


It’s been four decades since society was in awe of the quality of recordings available from a
cassette recorder tape. Today we have something new to be in awe of: deepfakes. Deepfakes
include hyperrealistic videos that use artificial intelligence (AI) to create fake digital content that
looks and sounds real. The word is a portmanteau of “deep learning” and “fake.” Deepfakes are
everywhere: from TV news to advertising, from national election campaigns to wars between
states, and from cybercriminals’ phishing campaigns to insurance claims that fraudsters file. And
deepfakes come in all shapes and sizes — videos, pictures, audio, text, and any other digital
material that can be manipulated with AI. One estimate suggests that deepfake content online is
growing at the rate of 400% annually.


There appear to be legitimate uses of deepfakes, such as in the medical industry to improve the
diagnostic accuracy of AI algorithms in identifying periodontal disease or to help medical
professionals create artificial patients (from real patient data) to safely test new diagnoses and
treatments or help physicians make medical decisions. Deepfakes are also used to entertain, as
seen recently on America’s Got Talent, and there may be future uses where deepfake could help
teachers address the personal needs and preferences of specific students.
...
Unfortunately, there is also the obvious downside, where the most visible examples represent
malicious and illegitimate uses. Examples already exist.


Deepfakes also involve voice phishing, also known as vishing, which has been among the most
common techniques for cybercriminals. This technique involves using cloned voices over the
phone to exploit the victim’s professional or personal relationships by impersonating trusted
individuals. In March 2019, cybercriminals were able to use a deepfake to fool the CEO of a U.K.-
based energy firm into making a US$234,000 wire transfer. The British CEO who was victimized
thought that the person speaking on the phone was the chief executive of the firm’s German
parent company. The deepfake caller asked him to transfer the funds to a Hungarian supplier
within an hour, emphasizing that the matter was extremely urgent. The fraudsters used AI-based
software to successfully imitate the German executive’s voice. [...]


What can be done to combat deepfakes? Could we create deepfake detectors? Or create laws
or a code of conduct that probably would be ignored?


There are tools that can analyze the blood flow in a subject’s face and then compare it to human
blood flow activity to detect a fake. Also, the European Union is working on addressing
manipulative behaviors.


There are downsides to both categories of solutions, but clearly something needs to be done to
build trust in this emerging and disruptive technology. The problem isn’t going away. It is only
increasing.


Authors
Nit Kshetri, Bryan School of Business and Economics, University of North Carolina at Greensboro,
Greensboro, NC, USA
Joanna F. DeFranco, Software Engineering, The Pennsylvania State University, Malvern, PA, USA
- Jeffrey Voas, NIST, USA
Adapted from: https://www.computer.org/csdl/magazine/co/2023/07/10154234/


Comentários:
31 Based on the text, mark the statements below as true (T) or false (F).
...
31 Based on the text, mark the statements below as true (T) or false (F).
31 Com base no texto, marque as afirmações abaixo como verdadeiras (V) ou falsas (F).


(F) Deepfakes are circumscribed to certain areas of action.
(F) Deepfakes estão circunscritos a certas áreas de atuação.


Falsa. Deepfakes não estão limitados a certas áreas de atuação, mas podem ser usados em
diversos contextos, como política, entretenimento, jornalismo, etc.


(F) The sole aim of deepfake technology is to spread misinformation.
(F) O único objetivo da tecnologia deepfake é espalhar desinformação.


Falsa. A tecnologia deepfake não tem um único objetivo, mas pode ter diversas finalidades,
tanto benignas quanto maliciosas. Por exemplo, pode ser usada para criar efeitos especiais,
dublagem, sátira, etc.


(V) Evidence shows that even high-ranking executives can be easy targets to vishing techniques.
(V) Evidências mostram que até executivos de alto escalão podem ser alvos fáceis de técnicas de
vishing.
...
Verdadeira. Evidências mostram que executivos de alto escalão podem ser vítimas de vishing,
que é uma forma de engenharia social que usa voz sintética para enganar as pessoas. Por
exemplo, em 2019, um executivo de uma empresa britânica foi enganado por um falso chefe
que usou uma voz gerada por inteligência artificial para pedir uma transferência urgente de 243
mil dólares.
...
32 In the 1st sentence (“It’s been four decades since society was in awe of the quality of
recordings available from a cassette recorder tape”), the reaction of society is described as being
one of:
...
recordings available from a cassette recorder tape”), the reaction of society is described as being
one of:
32 Na 1ª frase (“Já se passaram quatro décadas desde que a sociedade ficou admirada com a
qualidade das gravações disponíveis em uma fita cassete”), a reação da sociedade é descrita
como sendo uma de:
...
(A) woe; - desgraça, calamidade;
(B) mishap; - infortúnio, azar;
(C) sorrow; - tristeza, aflição;
(D) wonder; - maravilha;
(E) distress. – angústia, ansiedade.


Dica: Numa questão como essa, nem precisa você ir ao texto. Observe que quase todas as
opções são sinônimas entre si, a única que é o oposto delas é a resposta do gabarito.


A palavra "awe" significa "admiração", "espanto" ou "assombro", e indica uma reação de
surpresa e encantamento diante de algo impressionante ou extraordinário. Portanto, o termo
mais adequado para descrever essa reação é "maravilha", que tem o mesmo sentido. As outras
alternativas são incorretas, pois têm conotações negativas que não correspondem ao contexto
da frase. Não faz sentido usar palavras negativas para descrever a reação da sociedade às
gravações em fita cassete, que eram uma novidade tecnológica positiva na época.


GABARITO: D


33 When the authors refer to the use of deepfake in education (2nd paragraph), they state that
ultimately teachers may find it:
...
33 When the authors refer to the use of deepfake in education (2nd paragraph), they state that
ultimately teachers may find it:
33 Quando os autores se referem ao uso de deepfake na educação (2º parágrafo), eles afirmam
que, em última análise, os professores podem achar isso:
...
suitable= adequado, apropriado, conveniente, satisfatório


Correta. O texto diz que pode haver usos futuros onde o deepfake poderia ajudar os
professores a atender às necessidades e preferências pessoais de alunos específicos. Portanto, é
correto concluir que os autores afirmam que, em última análise, os professores podem achar isso
apropriado. Isso indica uma reação de aprovação e conformidade diante de algo que atende
às expectativas ou necessidades.


(B) dubious; - duvidoso;
(C) harmful; - prejudicial;
(D) threatening; - ameaçador;                           ==219a34==

(E) questionable. – questionável;


Dica: Numa questão como essa, nem precisa você ir ao texto. Observe que quase todas as
opções expressam algo negativo, a única que é o oposto delas é a resposta do gabarito.


GABARITO: A


34 In the question “Or create laws or a code of conduct that probably would be ignored?” (5th
paragraph), the authors imply that these laws and code of conduct may be:
...
34 In the question “Or create laws or a code of conduct that probably would be ignored?” (5th
paragraph), the authors imply that these laws and code of conduct may be:
34 Na questão “Ou criar leis ou um código de conduta que provavelmente seriam ignorados?”
(5º parágrafo), os autores sugerem que essas leis e código de conduta podem ser:


(A) implemented; - implementados;
...
Errada. Um sinônimo dessa palavra é executed (executado). Ex: The government has
implemented a new policy to reduce pollution (O governo tem executado uma nova política para
reduzir a poluição).


(B) overlooked; - desconsiderados;


What can be done to combat deepfakes? Could we create deepfake detectors? Or create laws
or a code of conduct that probably would be ignored?
O que pode ser feito para combater os deepfakes? Poderíamos criar detectores de deepfake?
Ou criar leis ou um código de conduta que provavelmente seriam ignorados?


Overlooked = desconsiderado, ignorado, desprezado, esquecido = Ignored


Correta. Ambas as palavras indicam uma reação de indiferença e negligência diante de algo que
não se considera importante ou relevante. Portanto, os autores sugerem que essas leis e código
de conduta podem ser "desconsiderados".


(C) sustained; - mantidos;


Errada. Um sinônimo dessa palavra é maintained (mantido). Ex: The judge praised the lawyer
for his well-maintained arguments and evidence. (O juiz elogiou o advogado por seus
argumentos e provas bem mantidos).


(D) imposed; - impostos;


Errada. Um sinônimo dessa palavra é enforced (imposto). Ex: The enforced law caused a lot of
protests and riots among the people who opposed it. (A lei imposta causou muitos protestos e
tumultos entre as pessoas que a opuseram).


(E) revised. - revisados.


Errada. Um sinônimo dessa palavra é reviewed (revisado). Ex: The student revised his essay
before submitting it. (O aluno revisou sua redação antes de enviá-la).
...
35 The word “downsides” in “There are downsides to both categories” (7th paragraph) means:
...
35 The word “downsides” in “There are downsides to both categories” (7th paragraph) means:
35 A palavra "desvantagens" em "Há desvantagens para ambas as categorias de soluções " (7º
parágrafo) significa:


(A) backgrounds; - fundos;


Errada. Um dos seus sinônimos é context (contexto). Ex: The context of the story is very
important to understand its meaning. (O contexto da história é muito importante para entender
seu significado).


(B) countdowns; - contagens regressivas;


Errada. Um dos seus sinônimos na linguagem figurada é prepare for (se preparar para). Ex: She
had to prepare for the exam by studying hard. (Ela tinha que se preparar para o exame
estudando muito).


(C) drawbacks; - desvantagens;


“There are downsides to both categories”
"Há desvantagens para ambas as categorias de soluções"


downsides = desvantagens, aspectos negativos, inconvenientes = drawbacks
...
Correta. Ambas as palavras indicam os problemas ou dificuldades que podem surgir de uma
situação ou escolha.


(D) backshifts; - retrocessos;


Errada. Um dos seus sinônimos é reversal (reversão). Ex: The court ordered a reversal of the
previous decision (O tribunal ordenou uma reversão da decisão anterior).


(E) sidelights. – informações adicionais.


Errada. Um dos seus sinônimos na linguagem figurada é insight (perspectiva). Ex: The research
offers some new insights into the causes of the disease. (A pesquisa oferece algumas novas
perspectivas sobre as causas da doença.


GABARITO: C


36 The aim of the last paragraph is to:
...
36 The aim of the last paragraph is to:
36 O objetivo do último parágrafo é:
...
Há desvantagens para ambas as categorias de soluções, mas claramente algo precisa ser feito
para construir confiança nesta tecnologia emergente e disruptiva. O problema não vai
desaparecer. Está apenas aumentando.


Correta. Está claro que o objetivo do último parágrafo é advertir. A palavra "warn" significa
"avisar", "alertar" ou "prevenir", e indica um objetivo de comunicar um perigo ou risco
potencial, ou de aconselhar ou recomendar uma ação ou precaução.


(B) boast; - gabar-se;


Errada. Boast significa "vangloriar-se", "jactar-se" ou "ostentar", e indica um objetivo de exibir
ou enaltecer as próprias qualidades, habilidades e realizações, ou de menosprezar e humilhar os
outros. Não faz sentido usar essa palavra para expressar o objetivo do último parágrafo, que é
apresentar uma reflexão crítica e cautelosa sobre o uso do deepfake.


(C) amuse; - divertir;


Errada. Amuse significa "entreter", "alegrar" ou "distrair", e indica um objetivo de proporcionar
prazer, diversão ou humor. Também não se aplica ao caso do último parágrafo, que é expor um
problema sério e complexo que envolve questões diversas.


(D) survey; - pesquisar;


Errada. Pesquisar significa "investigar", "estudar" ou "analisar", e indica um objetivo de buscar
ou obter informações, conhecimentos ou dados sobre um assunto ou fenômeno, ou de examinar
ou avaliar algo com critérios ou métodos. Mais uma vez, não é adequada para expressar o
objetivo do último parágrafo.


(E) abridge. - resumir.


Errada. Abridge significa "sintetizar", "condensar" ou "abreviar", e indica um objetivo de
reduzir ou simplificar o conteúdo ou a extensão de um texto ou discurso, ou de apresentar as
ideias principais ou essenciais de algo. Também não se encaixa no contexto do último parágrafo,
que é formular uma questão aberta e incerta sobre o futuro do deepfake.
...
Translation
                                       ...
                                       Is It Live, or Is It Deepfake?
                                        É Ao Vivo, ou É Deepfake?


It’s been four decades since society was in awe of the quality of recordings available from a
cassette recorder tape. Today we have something new to be in awe of: deepfakes. Deepfakes
include hyperrealistic videos that use artificial intelligence (AI) to create fake digital content that
looks and sounds real. The word is a portmanteau of “deep learning” and “fake.”


Já se passaram quatro décadas desde que a sociedade ficou maravilhada com a qualidade das
gravações disponíveis em uma fita cassete. Hoje temos algo novo para nos maravilhar: os
deepfakes (vídeos manipulados). Deepfakes incluem vídeos hiperrealistas que usam inteligência
artificial (IA) para criar conteúdo digital falso que parece e soa real. A palavra é uma junção de
"aprendizagem profunda" e "falso".


Deepfakes are everywhere: from TV news to advertising, from national election campaigns to
wars between states, and from cybercriminals’ phishing campaigns to insurance claims that
fraudsters file. And deepfakes come in all shapes and sizes — videos, pictures, audio, text, and
any other digital material that can be manipulated with AI. One estimate suggests that deepfake
content online is growing at the rate of 400% annually.


Os deepfakes estão em toda parte: desde notícias de TV até publicidade, desde campanhas
eleitorais nacionais até guerras entre estados, e desde campanhas de phishing de
cibercriminosos até reclamações de seguro que fraudadores arquivam. E os deepfakes vêm em
todas as formas e tamanhos - vídeos, imagens, áudio, texto e qualquer outro material digital que
possa ser manipulado com IA. Uma estimativa sugere que o conteúdo deepfake online está
crescendo à taxa de 400% ao ano.
...
Parece haver usos legítimos de deepfakes, como na indústria médica para melhorar a precisão
diagnóstica de algoritmos de IA na identificação de doenças periodontais ou para ajudar
profissionais médicos a criar pacientes artificiais (a partir de dados reais de pacientes) para testar
com segurança novos diagnósticos e tratamentos ou ajudar médicos a tomar decisões médicas.
Os deepfakes também são usados para entreter, como visto recentemente no America's Got
Talent, e pode haver usos futuros onde o deepfake poderia ajudar os professores a atender às
necessidades e preferências pessoais de alunos específicos.
...
Infelizmente, há também o lado negativo óbvio, onde os exemplos mais visíveis representam
usos maliciosos e ilegítimos. Já existem exemplos disso.
...
phone to exploit the victim’s professional or personal relationships by impersonating trusted
individuals. In March 2019, cybercriminals were able to use a deepfake to fool the CEO of a U.K.-
based energy firm into making a US$234,000 wire transfer.


Os deepfakes também envolvem phishing por voz, também conhecido como vishing, que tem
sido uma das técnicas mais comuns para cibercriminosos. Essa técnica envolve o uso de vozes
clonadas por telefone para explorar as relações profissionais ou pessoais da vítima, se passando
por indivíduos confiáveis. Em março de 2019, cibercriminosos foram capazes de usar um
deepfake para enganar o CEO de uma empresa de energia sediada no Reino Unido a fazer uma
transferência bancária de $234.000 dólares.


The British CEO who was victimized thought that the person speaking on the phone was the
chief executive of the firm’s German parent company. The deepfake caller asked him to transfer
the funds to a Hungarian supplier within an hour, emphasizing that the matter was extremely
urgent. The fraudsters used AI-based software to successfully imitate the German executive’s
voice. [...]


O CEO britânico que foi vítima pensou que a pessoa que falava ao telefone era o executivo-
chefe da empresa matriz alemã. A pessoa que telefonou, o deepfake, pediu-lhe para transferir os
fundos para um fornecedor húngaro dentro de uma hora, enfatizando que o assunto era
extremamente urgente. Os fraudadores usaram um software baseado em IA para imitar com
sucesso a voz do executivo alemão. [...]
...
Existem ferramentas que podem analisar o fluxo sanguíneo no rosto de um sujeito e depois
compará-lo com a atividade do fluxo sanguíneo humano para detectar uma farsa. Além disso, a
União Europeia está trabalhando para enfrentar comportamentos manipuladores.
...
desaparecer. Está apenas aumentando.
                                                 ...
                                                 TEXTO 8
Gestão Governamental – Seplag Niterói - FGV - 2024
...
difficult to measure objectively, such as inclusion, ethical behavior, corporate culture, and
embracing sustainability across the organization.
...
Additional risk areas associated with ESG are varied and can include reliance on third-party data,
potential reputational damage from faulty reporting, and the real possibility that an
organization’s explicit commitments to meet specific sustainability goals could grow into a
material weakness.
...
efforts relate to each other, the organization’s finances, and value creation. […] Seeking out
objective assurance on all ESG-related risk management processes from a qualified,
independent, and properly resourced internal audit function should be part of any ESG strategy.
...
Comentários:
37. Based on Text I, mark the statements below as true (T) or false (F).
...
37. Based on Text I, mark the statements below as true (T) or false (F).
37. Com base no Texto I, marque as afirmações abaixo como verdadeiras (V) ou falsas (F).


(F) Social inequalities have prevented endeavors toward change in ESG.
(F) As desigualdades sociais impediram os esforços para mudanças no ESG.


Falsa. O texto menciona que os esforços para mitigar as mudanças climáticas e abordar as
desigualdades sociais históricas percebidas estão impulsionando mudanças globais. Isso significa
que essas desigualdades não impediram os esforços, mas sim os incentivaram.


(F) The standards for ESG reporting should be less rigid than those for financial reporting.
(F) Os padrões para relatórios ESG devem ser menos rígidos do que os para relatórios
financeiros.


Falsa. O texto afirma que a elaboração de relatórios ESG deve ser tratada com o mesmo cuidado
que a elaboração de relatórios financeiros. Portanto, os padrões não devem ser menos rígidos.


(T) Proper internal auditing requires precise ESG reporting.
(V) A auditoria interna adequada requer relatórios ESG precisos.

Verdadeira. O texto sugere que a auditoria interna deve buscar uma garantia objetiva sobre
todos os processos de gestão de riscos relacionados ao ESG, o que implica a necessidade de
relatórios ESG precisos.
...
38. The phrasal verb that may replace “mitigate” in “Efforts to mitigate” (1st paragraph), without
significant change in meaning, is
...
38. The phrasal verb that may replace “mitigate” in “Efforts to mitigate” (1st paragraph), without
significant change in meaning, is
38. O verbo frasal que pode substituir "mitigar" em "Esforços para mitigar" (1º parágrafo), sem
mudança significativa no significado, é


(A) play down. - minimizar ou reduzir


Correta. Play down significa “minimizar ou reduzir a importância de algo”, o que é semelhante a
"mitigate" (mitigar), que significa reduzir a severidade ou o impacto de algo.


(B) play along. - cooperar


Errada. Um sinônimo de “play along” é “cooperate” (cooperar). Ex: She decided to cooperate
with the plan even though she had some doubts. (Ela decidiu cooperar com o plano, embora
tivesse algumas dúvidas.)
...
(C) play back. - reproduzir


Errada. Um sinônimo de “play back” é “rewind” (rebobinar). Ex: She decided to rewind the
recording to hear the conversation again. (Ela decidiu rebobinar a gravação para ouvir a conversa
novamente.)


(D) play out. - desenrolar


Errada. Um sinônimo de “play out” é “unfold” (desenrolar). Ex: Let's see how the situation will
unfold before making any decisions. (Vamos ver como a situação vai se desenrolar antes de
...
Errada. Um sinônimo de “play off” é “compete” (competir). Ex: The two teams will compete in
the finals next week. (Os dois times vão competir nas finais na próxima semana.)


GABARITO: A


39. The word “address” in “address perceived historical social inequities” (1st paragraph) is a (n)
...
39. The word “address” in “address perceived historical social inequities” (1st paragraph) is a (n)
39. A palavra "abordar" em "abordar as desigualdades sociais históricas percebidas" (1º
parágrafo) é um (a)


(A) preposition. – preposição
...
Errada. Preposições são palavras que indicam a relação entre outras palavras em uma frase,
como "in", "on", "at".
...
Errada. Advérbios modificam verbos, adjetivos ou outros advérbios, indicando como, quando,
onde ou em que medida algo acontece.


(C) article. - artigo


Errada. Artigos são palavras que definem um substantivo como específico ou inespecífico, como
"a", "an", "the".
...
Errada. Substantivos são palavras que nomeiam pessoas, lugares, coisas ou ideias. Embora
"address" possa ser um substantivo (como em "endereço"), no contexto da frase "address
perceived historical social inequities", "address" está sendo usado como verbo..


(E) verb. - verbo


Certa. Verbos são palavras que expressam ações, estados ou ocorrências. Na frase "address
perceived historical social inequities", "address" é usado como verbo, significando "abordar".


GABARITO: E


40. When the text informs that the efforts have “spurred organizations” (2nd paragraph), this
means that the organizations have been
...
40. When the text informs that the efforts have “spurred organizations” (2nd paragraph), this
means that the organizations have been
40. Quando o texto informa que os esforços "incentivaram as organizações" (2º parágrafo), isso
significa que as organizações foram


(A) threatened. – ameaçaram.


Errada. Um sinônimo de “threatened” é “intimidated” (intimidaram). Ex: The new management
policies threatened the workers. (As novas políticas de gestão ameaçaram os trabalhadores.)


(B) prompted. - incentivaram.


Certa. "Spurred" significa “incentivar ou estimular”, o que é sinônimo de "prompted".


(C) hindered. – impediram, impediu.


Errada. Um sinônimo de “hindered” é “obstructed” (obstruídas). Ex: The heavy traffic hindered
our timely arrival at the meeting. (O trânsito intenso dificultou nossa chegada à reunião no
horário previsto.)


(D) thwarted. – frustraram.


Errada. Um sinônimo de “thwarted” é “foiled” (frustradas). Ex: Unforeseen circumstances
thwarted their plans. (Circunstâncias imprevistas frustraram seus planos.)


(E) curbed. - contiveram.


Errada. Um sinônimo de “curbed” é “restrained” (restritas). Ex: The new regulations curbed the
company's ability to expand. (As novas regulamentações contiveram a capacidade da empresa
de expandir.)
...
41. The opposite of the adjective in “faulty reporting” (4th paragraph) is
...
41. The opposite of the adjective in “faulty reporting” (4th paragraph) is
41. O oposto do adjetivo em "relatório falho" (4º parágrafo) é
...
Erradas. Todas as opções acima são sinônimas entre si, assim como são sinônimas de “faulty”. A
questão pede que você escolha a opção que tem um significado oposto.


(E) flawless. - impecável.


Certa. A palavra “flawless” (impecável) significa “sem falhas ou perfeito”, o que é o oposto
direto de “faulty” (falho).


GABARITO: E


42. The text concludes with a
...
42. The text concludes with a
42. O texto conclui com um (a)


(A) protest. - protesto.


Errada. O texto não termina com uma manifestação contra algo.


(B) warning. - aviso.


Errada. O texto não termina com um aviso.


(C) complaint. - reclamação.


Errada. O texto não termina com uma reclamação.


(D) suggestion. - sugestão.


As ESG reporting becomes increasingly common, it should be treated with the same care as
financial reporting.
À medida que os relatórios ESG se tornam cada vez mais comuns, eles devem ser tratados com
o mesmo cuidado que os relatórios financeiros.


Certa. No contexto da frase que inicia o último parágrafo do texto, o uso de "should" indica
uma recomendação ou sugestão forte sobre como algo deve ser feito. Aqui, a frase sugere que,
à medida que os relatórios ESG se tornam mais comuns, eles devem ser tratados com o mesmo
cuidado que os relatórios financeiros.


(E) admonishment. - advertência.
...
Errada. O texto não termina com uma advertência.
...
Translation
                                     ...
                                     Embarking on the ESG journey
                    Iniciando a jornada ESG (Ambiental, Social e Governança)
...
desigualdades sociais históricas percebidas são duas questões poderosas que impulsionam
mudanças globalmente. Esses movimentos aumentaram a conscientização sobre como todas as
...
Eles também incentivaram as organizações a reconhecer e gerenciar melhor os riscos ESG (ou
seja, riscos associados à forma como as organizações operam em relação ao seu impacto no
mundo ao seu redor). Esta ampla categoria de riscos inclui áreas que são dinâmicas e muitas
vezes impulsionadas por fatores que podem ser difíceis de medir objetivamente, como inclusão,
comportamento ético, cultura corporativa e adoção da sustentabilidade em toda a organização.
...
Ainda assim, há uma urgência crescente para que as organizações compreendam e gerenciem os
riscos ESG, particularmente à medida que investidores e reguladores se concentram em
organizações que produzem relatórios de alta qualidade sobre esforços de sustentabilidade.
Além disso, essa pressão está sendo refletida cada vez mais no desempenho executivo, à
medida que mais organizações vinculam métricas de compensação de incentivos a metas ESG.
...
As áreas de risco adicionais associadas ao ESG são variadas e podem incluir a dependência de
dados de terceiros, possíveis danos à reputação devido a relatórios falhos e a real possibilidade
de que os compromissos explícitos de uma organização para atingir metas específicas de
sustentabilidade possam se tornar uma fraqueza material.
...
relatórios ESG devem ser construídos com um sistema estrategicamente elaborado de controles
internos e refletir com precisão como os esforços ESG de uma organização se relacionam entre
si, com as finanças da organização e com a criação de valor. [...] Buscar uma garantia objetiva em
todos os processos de gestão de riscos relacionados ao ESG de uma função de auditoria interna
qualificada, independente e devidamente equipada deve fazer parte de qualquer estratégia
ESG.
...
While many firms wanted their technology investment to be a blessing, it just hasn’t turned out
that way. The good news is that it is not too late. You can turn the tide and have technology
utilization become a tremendous asset in audit process.     ==219a34==
...
Texto 7: AGENTE DA FISCALIZAÇÃO – TI – TCE-SP – FGV -2023
...
Texto 8: Gestão Governamental – Seplag Niterói - FGV - 2024


                                     Embarking on the ESG journey


       Efforts to mitigate the accelerating effects of climate change and address perceived
historical social inequities are two powerful issues driving change globally. These movements
...
particularly as investors and regulators focus on organizations producing high-quality reporting
on sustainability efforts. What’s more, that pressure is being reflected increasingly in executive
performance as more organizations tie incentive compensation metrics to ESG goals.
      Additional risk areas associated with ESG are varied and can include reliance on third-
party data, potential reputational damage from faulty reporting, and the real possibility that an
organization’s explicit commitments to meet specific sustainability goals could grow into a
material weakness.
...
Aula 02
                       ...
                       Texto 7                               31-E; 32-D; 33-A; 34-B; 35-C; 36-A;

                       Texto 8                               37-B; 38-A; 39-E; 40-B; 41-E; 42-D;
...
Aula 02
          ...
          •       Nessa aula 100% dos textos tiveram assuntos com vocabulário pertinente
                  ou ao cargo ou a instituição do concurso. Portanto, ao revisar escolha os
                  textos que têm o vocabulário pertinente à sua área, pois é assim que a FGV
                  elabora as provas. Ex: fiscal, financeiro, econômico, área de TI, saúde,
                  administrativo, etc.
