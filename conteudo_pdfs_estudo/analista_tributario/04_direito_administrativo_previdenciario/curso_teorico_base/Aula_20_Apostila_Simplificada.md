...
INTRODUÇÃO
Olá, amigos (as)!
Nesta aula, do curso “simplificado”, iremos abordar a Lei 12.527/2011, conhecida como Lei de
...
O próprio texto constitucional já indica que a regra geral é a transparência, de sorte que o acesso
à informação pode ser negado ao público em geral apenas em casos específicos.
...
O art. 4º da LAI prevê importantes definições, a saber:
     ...
     informação sigilosa             aquela submetida temporariamente à restrição de acesso público
                                     em razão de sua imprescindibilidade para a segurança da
                                     sociedade e do Estado
     informação pessoal              aquela relacionada à pessoa natural identificada ou identificável
          tratamento da              conjunto de ações referentes à produção, recepção, classificação,
            informação               utilização, acesso, reprodução, transporte, transmissão,
  ...
  Aula 19
               ...
               disponibilidade             qualidade da informação que pode ser conhecida e utilizada por
                  ...
                  autenticidade            qualidade da informação que tenha sido produzida, expedida,
                                           recebida ou modificada por determinado indivíduo, equipamento
                                           ou sistema
...
1
  Informações custodiadas são aquelas que, embora não sejam produzidas pelo próprio órgão público,
...
---
  ...
  Aula 19
      ...
      acesso à                                                                 garantindo-se sua
   informação -                   proteção da informação                        disponibilidade,
   entes devem                                                             autenticidade e integridade
     assegurar                                                                 sua disponibilidade,
                                  proteção da informação                   autenticidade, integridade e
                                  sigilosa e da informação
                                     pessoal, observada                    eventual restrição de acesso
...
entidades públicos, por qualquer meio legítimo, devendo o pedido conter a duas informações
essenciais (art. 10):
...
prorrogáveis por mais 10 (prorrogação justificada).
...
dos serviços e dos materiais utilizados (art. 12). Por outro lado, se o solicitante fizer “declaração
de pobreza” (Lei 7.115/1983), estará isento de ressarcir os respectivos custos.
...
Se o poder público alegar que a informação solicitada pelo interessado foi extraviada:
        Art. 7º, § 5º Informado do extravio da informação solicitada, poderá o interessado requerer
...
No caso de indeferimento de pedido de acesso a informação, é facultado ao interessado interpor recurso,
que deverá ser dirigido à mesma autoridade que proferiu a decisão. Caso a referida autoridade não
reconsidere sua decisão no prazo de cinco dias, o pedido deverá ser encaminhado a autoridade superior.
...
de classificação as informações cuja divulgação ou acesso irrestrito possam (art. 23):
            ...
            hipóteses de sigilo
                                  ...
                                  prejudicar/causar risco             científico ou tecnológico
                                             a                  sistemas, bens, instalações ou áreas de
                                                                     interesse estratégico nacional
                                                                                instituições
                                      pôr em risco a
                                      segurança de            altas autoridades nacionais ou estrangeiras
                                                                            e seus familiares
                                                                                inteligência
                                      comprometer              investigação/fiscalização em andamento,
                                      atividades de          relacionadas com a prevenção ou repressão
                                                                              de infrações
...
graus de sigilo e, a cada um destes graus de sigilo, foi associado um prazo máximo para a duração
da restrição de acesso, da seguinte forma (art. 24, §1º):
...
Reparem que tais prazos são contados a partir da produção da informação.
Vejam a questão abaixo a este respeito:
SLU DF/Administração/2019
De acordo com dispositivo da Lei de Acesso à Informação, é de quinze anos o prazo máximo de restrição de
acesso a informações classificadas como ultrassecretas.
Gabarito (errada). Para ultrassecretas o prazo máximo é de 25 anos.
...
respectivo grau de sigilo, encontrando-se distribuída da seguinte forma:
                                        ...
                                        ultrassecreto                       mesmas prerrogativas)
                                           (25 anos)                   Comandantes da Marinha, do
       ...
       classificar o grau de                                           autoridades mencionadas acima
                                            secreto
                sigilo                     (15 anos)               titulares de autarquias, fundações
                                                                           públicas ou estatais

                                                                       autoridades mencionadas acima
                                          reservado
                                            (5 anos)             autoridades que exerçam funções de
                                                                  direção, comando ou chefia, nível
                                                                        DAS 101.5, ou superior
...
SLU DF/Modernização da Gestão das Atividades de Resíduos Sólidos/2019
Informações pessoais relativas à intimidade, à vida privada, à honra e à imagem são de acesso restrito,
apenas podendo ser disponibilizadas a agentes públicos se houver consentimento expresso da pessoa a que
elas se referirem.
Gabarito (errada), em razão do “apenas”. Mesmo sem o consentimento a lei poderá autorizar sua divulgação.
Além disso, o consentimento é desnecessário nas hipóteses acima destacadas.
  ...
  condutas ilícitas
                          ...
                          acessar, divulgar ou permitir a divulgação indevida de
                                       ...
                                       informação sigilosa / pessoal
                                                                                                de terceiro
                                         impor sigilo à informação para                  para fins de ocultação de
                           ...
                           entidades privadas sem fins
                             ...
                             Sistema S (serv. sociais                  quantitativo de empregados e
                                  autônomos)                          funções e lista de parcelas por
                                                                                faixas salariais
                                                                     divulgar parcelas remuneratórias
                            Conselhos de fiscalização                     e indenizatórias de seus
                                  profissional                          empregados (lista nominal e
                                                                               individualizada)
