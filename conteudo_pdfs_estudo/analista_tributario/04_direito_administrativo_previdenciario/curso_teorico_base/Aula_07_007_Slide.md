...
REGIME DE
                   ...
                   ORGANIZAÇÕES DA
                 SOCIEDADE CIVIL (OSC) -
                    LEI 13.019/2014                          Prof. Antonio Daud
...
---
   ...
   Art. 2º, III - parceria: conjunto de direitos, responsabilidades e obrigações
...
---
 ...
 ❑ Não se aplica a transferência de recursos a (Lei 13.019/2014, art. 3º):
         ...
         ❑ Homologadas pelo CN ou autorizadas pelo Senado (tratados internacionais)
         ❑ Convênios com entidades filantrópicas
         ❑ Termos de compromisso cultural (Lei 13.018/2014 - Política Nacional de Cultura Viva)
         ❑ Anuidades a organismos internacionais por diversas autoridades
         ❑ Programas específicas da área educacional (complementação de estudo a PcD e PDDE)
...
---
   ...
   Parcerias          Termo de                  - proposta de parceria é feita pelo particular
   com OSC            fomento                 - envolve transferência de recursos financeiros
...
---
    ...
    Termo de colaboração         Termo de fomento                   Acordo de cooperação
             ...
             Administração              OSC
                                                                             OSC
       Recursos financeiros     Recursos financeiros                     Não envolve
                                                                       transferência de
                     (T = $)                  (T = $)                recursos financeiros
...
---
               ...
               Outros requisitos para celebração de parcerias
 ...
 e social; [exceto organizações religiosas e cooperativas / único requisito exigido dos acordos de coop.]
 ...
 extinta;
 IV - escrituração [contábil] de acordo com os princípios fundamentais de
 contabilidade e com as Normas Brasileiras de Contabilidade; [exceto organizações
...
---
 ...
 Art. 33. Para celebrar as parcerias previstas nesta Lei, as organizações da
 sociedade civil deverão ser regidas por normas de organização interna que
 prevejam, expressamente: (..) V - possuir:
...
---
                     ...
                     Quem NÃO pode celebrar parceria (arts. 39-41)
...
---
   ...
   em chamamento público e impedimento de celebrar parceria];
...
---
   ...
   Art. 39, VII - tenha entre seus dirigentes pessoa:
...
---
                     ...
                     Outra vedação à celebração de parceria

  Art. 40. É vedada a celebração de parcerias previstas nesta Lei que tenham por
...
---
                     ...
                     Chamamento Público (art. 24)
                         ...
                         seleção da OSC que vai firmar a parceria
  ...
  Chamamento          Termo de
    público                                      Necessário (regra)
                      fomento
                                                                         celebração de
                                                                           comodato
                                                  Necessário
                      Acordo de                 apenas quando           doação de bens
                     cooperação                 objeto envolver
                                                   envolver              outra forma de
                                                                      compartilhamento de
Ent. Paraestatais
Prof. Antonio Daud
                                                                       recurso patrimonial
  ...
  Chamamento
    ...
    público                                                       guerra, calamidade ...
                      ...
                      exceções                                        parlamentares
                                                                    ...
                                                                    Art. 31: previsão em
                                                Inexigibilidade   acordo internacional ou
Ent. Paraestatais
Prof. Antonio Daud
                                                                              lei
...
---
    ...
    inciso I do § 3º do art. 12 da Lei nº 4.320, de 17 de março de 1964,
...
---
 ...
 § 1º Sob pena de nulidade do ato de formalização de parceria prevista nesta Lei, o extrato da
 justificativa previsto no caput deverá ser publicado, na mesma data em que for efetivado, no
 sítio oficial da administração pública na internet e, eventualmente, a critério do administrador
 público, também no meio oficial de publicidade da administração pública.
 § 2º Admite-se a impugnação à justificativa, apresentada no prazo de cinco dias a contar de
 sua publicação, cujo teor deve ser analisado pelo administrador público responsável em até
 cinco dias da data do respectivo protocolo.
 § 3º Havendo fundamento na impugnação, será revogado o ato que declarou a dispensa ou
 considerou inexigível o chamamento público, e será imediatamente iniciado o procedimento
 para a realização do chamamento público, conforme o caso.
 § 4º A dispensa e a inexigibilidade de chamamento público, bem como o disposto no art. 29,
 não afastam a aplicação dos demais dispositivos desta Lei.
Ent. Paraestatais
Prof. Antonio Daud
...
---
 ...
 ❑ Plano de Trabalho: parte integrante e indissociável do instrumento celebrado
         - É um anexo do instrumento de parceria.
 ❑ Plano de Trabalho: pode ser alterado, mediante termo aditivo ou apostilamento do plano
...
---
                     ...
                     Aplicação de recursos pela OSC

 ❑ Não precisam licitar p/ contratar terceiros
      - STF: procedimentos objetivos de contratação e observem aos deveres de
 transparência e rastreabilidade (na execução de emendas parlamentares)


 ❑ OSC estão proibidas de (art. 45):
      - utilizar recursos para finalidade alheia ao objeto da parceria
      - pagar servidor ou empregado público com recursos vinculados à parceria,
...
---
 ...
 ❑ recursos públicos recebidos pela OSC (art. 51):
         - depositados em conta corrente específica
         - conta isenta de tarifa bancária
     - rendimentos financeiros dos depósitos ativos: aplicados no próprio objeto da
 parceria

 ❑ movimentação de recursos/pagamentos (art. 53):
 ...
 obrigatoriedade de depósito em sua conta bancária;
       - exceção (pagamento em espécie): somente quando houver impossibilidade
 física de transferência bancária (devidamente demonstrada)
Ent. Paraestatais
Prof. Antonio Daud
...
---
 ...
 ❑ caso a OSC deixe de pagar encargos trabalhistas, previdenciários, fiscais e
   comerciais relacionados à execução da parceria, a Administração Pública não se
   responsabiliza pelos pagamentos (art. 42, XX).


 ❑ a Administração não responde por ônus incidentes sobre o objeto da parceria ou
...
---
                              ...
                              Transparência (arts. 10-12)

                         Poder
                                                parceria               OSC
                        público

manter, em seu site na internet:                         divulgação na internet e em locais visíveis de
- a relação das parcerias celebradas e                  suas sedes sociais e dos estabelecimentos em
- respectivos planos de trabalho                        que exerça ações das parcerias (STF/ADPF 854).
- até 180 dias após o respectivo encerramento
...
---
     ...
     para a sua apresentação, a data em que foi apresentada, o prazo para a sua análise e
     o resultado conclusivo.
     VI - quando vinculados à execução do objeto e pagos com recursos da parceria, o
