...
9) Questões Comentadas - Proposições Compostas - FGV


10) Questões Comentadas - Tabela Verdade - FGV


11) Aviso importante - Orientação de estudo


12) Questões Comentadas - Introdução às proposições - Inéditas


13) Questões Comentadas - Proposições Simples - Inéditas


14) Questões Comentadas - Conversão de Linguagem - Inéditas


15) Questões Comentadas - Tabela-Verdade - Inéditas


16) Questões Comentadas - Tautologia, Contradição e Contingência - Inéditas


17) Lista de Questões - Proposições Compostas - FGV


18) Lista de Questões - Tabela Verdade - FGV


19) Lista de questões - Introdução às proposições - Inéditas


20) Lista de questões - Proposições Simples - Inéditas


21) Lista de questões - Conversão de Linguagem - Inéditas


22) Lista de Questões - Tabela Verdade - Inéditas


23) Lista de Questões - Tautologia, Contradição e Contingência - Inéditas

                Receita Federal (Analista Tributário) Raciocínio Lógico Matemático                                                                                                        2
                www.estrategiaconcursos.com.br                                                                                                                                          213
...
Os professores Eduardo Mocellin, Francisco Rebouças e Vinicius Veleda ficarão responsáveis pelo Livro
Digital.

Antes de continuarmos, vamos apresentar os professores do material escrito:
       Eduardo Mocellin: Fala, pessoal! Meu nome é Eduardo Mocellin, sou professor de Matemática e de Raciocínio
       Lógico do Estratégia Concursos e engenheiro Mecânico-Aeronáutico pelo Instituto Tecnológico de Aeronáutica
       (ITA). Sinto-me feliz em poder contribuir com a sua aprovação! Não deixe de me seguir no Instagram:
            @edu.mocellin
                                                       ==219a34==
...
INTRODUÇÃO ÀS PROPOSIÇÕES
    ...
    1.Oração: sentido completo, presença de verbo.
...
(CARRIS/2021) Dentre as sentenças abaixo, aquela que podemos afirmar ser uma proposição lógica é:
...
Comentários:
Sabemos que uma proposição lógica é uma oração declarativa à qual pode ser atribuída um, e apenas um,
dos dois possíveis valores lógicos: verdadeiro ou falso. Conhecida a definição, vamos analisar as alternativas.
a) A filha de Telma é bonita. ERRADO.
Em um primeiro momento, a frase apresentada nessa alternativa pode parecer que é uma proposição.
                                                       ==219a34==

Ocorre, porém, que essa frase carrega uma alta carga de subjetividade. Como seria possível afirmar
categoricamente que a filha de Telma é bonita?
Veja que não é possível atribuir um valor lógico V ou F para essa frase, pois ela emite uma opinião, que não
pode ser valorada de modo objetivo. Logo, não se trata de uma proposição.
b) João é pai de Maria? ERRADO.
Trata-se de uma sentença interrogativa. Logo, a frase em questão não é uma proposição.
c) Porto Alegre é muito longe. ERRADO.
Essa alternativa apresenta o mesmo caso apresentado na alternativa A. Veja que atribuir a característica
"longe" a Porto Alegre é algo subjetivo. O que é longe? 100 km? 1.000 km?
Novamente, não é possível atribuir um valor lógico V ou F para essa frase, pois ela emite uma opinião, que
não pode ser valorada de modo objetivo.
d) Isso é verdade? ERRADO.
Trata-se de uma sentença interrogativa. Logo, a frase em questão não é uma proposição.
e) Marcio é mais alto do que Júlio. CERTO.
Observe que a sentença apresentada é uma proposição lógica.
• Temos uma oração, que pode ser identificada com a presença do verbo "ser";
• A oração em questão é declarativa. No caso em questão, declara-se algo sobre a altura de Marcio
comparativamente à altura de Júlio;
• Pode-se atribuir um, e apenas um, dos dois possíveis valores lógicos à oração declarativa em questão: ou
é verdadeiro que "Marcio é mais alto do que Júlio", ou então é falso que "Marcio é mais alto do que Júlio".
...
(PGE-PE/2019) A lógica bivalente não obedece ao princípio da não contradição, segundo o qual uma
...
Para fechar a parte introdutória, vamos resolver uma questão que traz diversos pontos aprendidos.

(CDC/2023) Denomina-se proposição a toda frase declarativa, expressa em palavras ou símbolos, que
exprima um juízo ao qual se possa atribuir, dentro de certo contexto, somente um dos dois valores lógicos
possíveis: verdadeiro ou falso. Diante desse conceito, assinale a alternativa que representa uma proposição.
a) João, que horas são?
b) A cidade linda.
c) Letícia joga futebol aos domingos.
d) Faça uma excelente prova!
e) Que o ser divino a cubra.
Comentários:
Vamos comentar cada alternativa.
a) João, que horas são? ERRADO.
Trata-se de uma sentença interrogativa. Logo, a frase em questão não é uma proposição.
b) A cidade linda. ERRADO.
A frase em questão não apresenta sentido completo, pois não apresenta verbo. Trata-se de uma expressão.
Logo, não estamos diante de uma proposição.
c) Letícia joga futebol aos domingos. CERTO.
Observe que a frase em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso.
d) Faça uma excelente prova! ERRADO.
A frase acima é uma sentença imperativa (indica ordem, sugestão, pedido ou conselho), bem como é uma
sentença exclamativa (apresenta ponto de exclamação). Não se trata, portanto, de uma proposição.
e) Que o ser divino a cubra. ERRADO.
Trata-se de uma sentença optativa (exprime desejo). Logo, a frase em questão não é uma proposição.
Gabarito: Letra C.
...
Comentários:
Originalmente, temos a seguinte proposição:            ==219a34==
...
Na língua portuguesa, é comum utilizarmos uma dupla negação para enfatizar uma negação. Como exemplo,
uma pessoa que diz "não vou comer nada" normalmente quer dizer que ela realmente não vai comer. Essa
dupla negação da língua portuguesa com sentido de afirmação gera um certo descompasso com a linguagem
proposicional. Veja:
...
Para evitar esses problemas de descompasso relacionado à dupla negação na língua portuguesa, podemos
utilizar outras expressões como "não vou comer coisa alguma".

(PCSP/2014) Um antropólogo estadunidense chega ao Brasil para aperfeiçoar seu conhecimento da língua
...
Comentários:
Observe que, no caso apresentado, a língua portuguesa está em descompasso com a linguagem matemática.
As palavras "não" e "nenhuma" são negações que, em conjunto, formariam uma dupla negação. Observe:
                                           p: "Vou fazer alguma coisa."
                                        ~p: "Vou fazer coisa nenhuma."
                                    ~(~p): "Não vou fazer coisa nenhuma."
Ocorre que, na língua portuguesa, é comum utilizarmos a dupla negação para reforçar a negação.
Assim, na língua portuguesa, o significado da frase "não vou fazer coisa nenhuma" não leva em conta a
dupla negação, sendo uma outra forma de escrever "vou fazer coisa nenhuma."
Gabarito: Letra B.
...
PROPOSIÇÕES COMPOSTAS
    ...
    • A recíproca de p→q é dada pela troca entre o antecedente e o consequente: q→p.
    • A recíproca é uma proposição completamente diferente da condicional original.
...
Em outras palavras, basta que a proposição p seja falsa ou que a proposição q seja verdadeira.
Gabarito: Letra B.
...
A palavra "mas", assim como outras expressões adversativas como "entretanto", é utilizada para representar
uma conjunção. Logo, para a Lógica de Proposições, a proposição em questão corresponde a:
...
A sua recíproca é dada por q→p:
        ...
        A recíproca de uma condicional é uma proposição completamente distinta da condicional
        original. Em outras palavras, a recíproca da condicional não corresponde à condicional
        original.

        Ao estudarmos equivalências lógicas, veremos que p→q não é equivalente a q→p.
...
Considere as seguintes proposições simples:
                                       ...
                                       d: "Seus dentes ficam mais claros."


A condicional apresentada no enunciado corresponde a p→d:
             p→d: “Se [você usar a pasta dental XYZ], então [seus dentes ficarão mais claros].”
...
A recíproca da condicional p→d, dada por d→p, é:
            d→p: "Se [seus dentes ficaram mais claros], então [você usou a pasta dental XYZ]."
Gabarito: Letra D.


(CEFET MG/2022) Dada a seguinte proposição:
...
a) Um jovem não lê mais de dois livros por mês se não é considerado estudioso.
b) Um jovem não é considerado estudioso somente se não gosta de Matemática.
c) Um jovem que lê mais de dois livros por mês e gosta de Matemática é considerado estudioso.
d) Se um jovem é considerado estudioso então ele lê mais de dois livros por mês ou gosta de Matemática.
e) Se um jovem lê mais de dois livros por mês ou ele gosta de Matemática então ele é considerado estudioso.
Comentários:
Considere as seguintes proposições simples:
                                 l: “Um jovem lê mais de dois livros por mês.”
                                       m: “Um jovem gosta de Matemática.”
                                    e: “Um jovem é considerado estudioso.”


Note que a proposição composta sugerida é uma condicional escrita na forma “q, se p”. Essa forma de se
escrever a condicional na língua portuguesa inverte o antecedente e o consequente de posição, de modo
que o antecedente é l∨m e o consequente é e. Trata-se da condicional (l∨m)→e:
(l∨m)→e: “[Um jovem é considerado estudioso] se [(ele lê mais de dois livros por mês) ou ((se) ele gosta de
                                          Matemática)].”


Essa condicional pode ser escrita por meio do conectivo tradicional “se...então”:
   (l∨m)→e: “Se [(um jovem lê mais de dois livros por mês) ou (ele gosta de Matemática)], então [(ele é
                                       considerado estudioso)].”


Para obter a recíproca da condicional (l∨m)→e, devemos trocar o antecedente e o consequente de posição.
Logo, a recíproca é a condicional e→(l∨m):
e→(l∨m): “Se [um jovem é considerado estudioso], então [(ele lê mais de dois livros por mês) ou (gosta de
                                          Matemática)].”
Gabarito: Letra D.
...
(SEAD GO/2022) Considere as seguintes proposições:
...
P4: "(2%)2 = 4%".
P5: “A equação 𝑥 2 + 𝑥√2 = 0 não admite raiz real”.
Sabendo que as proposições P1 e P2 são, respectivamente, falsa e verdadeira, os valores das proposições
P4→P2; P1∨P5 e P1∧P3 são, respectivamente:
a) V, V e V.
b) V, F e V.
c) V, F e F.
d) F, F e V.
...
Feitas as observações, vamos ao problema.
P4→P2 – Como P2 é verdadeira, temos uma condicional no formato P4→V. Essa condicional é verdadeira,
qualquer que seja o valor de P4. Isso porque a condicional é falsa somente no caso V→F.
...
Portanto, os valores das proposições P4→P2; P1∨P5 e P1∧P3 são, respectivamente, V, F e F.
Gabarito: Letra C.
...
CONVERSÃO DA LINGUAGEM NATURAL PARA A PROPOSICIONAL
    ...
    Em regra, os termos “não é verdade que” e “é falso que” costumam negar a proposição composta
    como um todo.
...
seguinte.
A sentença “Hoje não choveu então Maria não foi ao comércio e José não foi à praia” pode ser
corretamente representada por:
                                                  ~P→(~R∧~Q)
Comentários:
Observe que a banca omitiu o "Se" da condicional apresentada, de modo que podemos entender a
sentença original do seguinte modo:
...
Como não há qualquer indicativo na frase original de que a condicional deve ser executada primeiro,
devemos seguir a ordem de precedência dos conectivos, que nos diz que a conjunção "e" precede a
condicional "se...então". Nesse caso, a representação correta é ~P→(~R∧~Q):
   ~P→(~R∧~Q): “Se [hoje não choveu], então [(Maria não foi ao comércio) e (José não foi à praia)].”


O gabarito, portanto, é CERTO.
Caso a banca quisesse como resposta (~P→~R)∧~Q, ela deveria dar um indicativo de que a condicional
deveria ser executada antes. Esse indicativo poderia ser uma vírgula, conforme exemplificado a seguir:
...
A linguagem simbólica da proposição “t: É falso que Ana fala alemão ou português, mas que não fala
inglês” é:
a) ∼q∨∼r∧∼p
b) ∼(q∨r)∧p
c) ∼((q∨r)∧∼p)
...
Nesse caso, perceba que "Ana fala alemão ou português, mas não fala inglês" pode ser descrita como
(q∨r)∧∼p:
...
Para negar essa última proposição composta e chegarmos a ~(p∧~q), podemos incluir o termo "não é
verdade que" no início da proposição composta:
             ~(p ∧~q): “Não é verdade que [(Tony fala inglês) e (Antônio não fala português)].”


Observação: Será visto na aula de equivalências lógicas, se for pertinente ao seu edital, que existe uma
...
essas proposições são iguais! Isso significa que as três frases abaixo são exatamente a mesma proposição:
   ...
   •     p: "John drank coffee." (Em português: João bebeu café.)

          Utilize esse entendimento de analisar o significado das proposições como último recurso.

          Quando em uma questão aparecer os conectivos tradicionais, não fique tentando
          entender o significado da proposição composta. Apenas aplique a regra.
...
Outra forma de se escrever esse condicional é utilizar a forma “Como p, q”:
 P4:“Como [(o atual aquecimento global é apenas mais um ciclo do fenômeno) e (a presença humana no
...
compõem.
     ...
     Exemplo: queremos determinar os valores lógicos assumidos pela proposição composta a
     seguir em função dos valores atribuídos a p, q e r.
...
Número de linhas de uma tabela-verdade
    ...
    O número de possíveis combinações para p, q e r será exatamente o número de linhas da tabela-
    verdade do exemplo.

    Observe que a inserção do operador de negação "~" na expressão ~(p→~q)∨(~r→q) em nada
    alterou o número de linhas da tabela-verdade.
...
e) 32
Comentários:
Para resolver a questão, vamos assumir que P, Q, R e S são proposições simples. Seria melhor que a questão
tivesse explicitado isso.
Note que, na proposição composta apresentada, temos um total de 𝒏 = 4 proposições simples distintas: P,
Q, R e S. Portanto, o número de linhas da tabela-verdade é:
                                            2𝑛 = 24 = 2 × 2 × 2 × 2 = 16
Gabarito: Letra D.
...
Antes de desenharmos a estrutura da tabela-verdade, precisamos fragmentar a proposição composta em
partes para entendermos as operações necessárias para se chegar ao resultado desejado:
~(p→~q)∨(~r→q). Para tanto, utilizaremos uma "engenharia reversa", isto é, partindo desta proposição
composta aparentemente complexa, chegaremos nas proposições simples (p, q e r). Este passo é
fundamental, pois organiza o raciocínio de maneira simples e fácil.

Observe como aplicar esta "engenharia reversa”:

     Para determinar ~ (p→~q)∨(~r→q), precisamos obter ~ (p→~q) e (~r→q).

     Para determinar ~ (p→~q), precisamos obter (p→~q).
...
O número de linhas corresponde ao passo 1, isto é, 2𝑛 , sendo 𝑛 o número de proposições simples. No
presente caso, temos 3 proposições simples, p, q e r, portanto, teremos 8 linhas na tabela-verdade. Vejamos:
...
Passo 2: desenhar o esquema da tabela-verdade.
Note que:
Para determinar p→a∧j, precisamos obter p e a∧j.
...
Passo 4: obter o valor das demais proposições.
A conjunção a∧j é verdadeira somente para os casos em que a é verdadeiro e j é verdadeiro. Nos outros
casos, a∧j é falso.
...
Passo 4: obter o valor das demais proposições.
A disjunção inclusiva (Q∨R) é falsa quando Q e R são ambos falsos. Nos demais casos, a disjunção inclusiva
(Q∨R) é verdadeira.
...
(CBM AL/2021) Considere os conectivos lógicos usuais e assuma que as letras maiúsculas representam
proposições lógicas e que o símbolo ~ representa a negação. Considere também que as três primeiras
colunas de uma tabela-verdade que envolve as proposições lógicas P, Q e R sejam as seguintes.

Com base nas informações apresentadas, julgue o item a seguir.
A última coluna da tabela-verdade relacionada à expressão (P∧Q)(~R) apresenta valores V ou F na
seguinte sequência, de cima para baixo: F V V F V F V F.
Comentários:
Devemos obter a tabela-verdade de (P∧Q)(~R).
Perceba que o Passo 1, "determinar o número de linhas da tabela-verdade", já está feito. O mesmo ocorre
com o Passo 3, "atribuir V ou F às proposições simples de maneira alternada".
...
Passo 2: desenhar o esquema da tabela-verdade.
Para determinar (P∧Q)(~R), precisamos obter (P∧Q) e (~R).
Para determinar P∧Q, precisamos obter P e Q.
Para determinar (~R), precisamos obter R.
Logo, temos o seguinte esquema da tabela-verdade:

Passo 4: obter o valor das demais proposições.
~R apresenta o valor lógico contrário de R.

A conjunção P∧Q é verdadeira quando P e Q são ambos verdadeiros. Nos demais casos, a conjunção é falsa.
...
Por fim, a bicondicional (P∧Q)(~R) é verdadeira quando (P∧Q) e (~R) apresentam o mesmo valor lógico.
Caso contrário, a bicondicional em questão é falsa.

Note, portanto, que é correto afirmar que a última coluna da tabela-verdade relacionada à expressão
(P∧Q)(~R) apresenta a sequência F V V F V F V F.
Gabarito: CERTO.
...
Comentários:
Observe que:
• A última coluna da tabela I mostra que a proposição ~(p∧q)(~p∨~q) é sempre verdadeira. Logo, a
tabela I representa uma tautologia.
• A última coluna da tabela II mostra que a proposição (p∧~q)(~p∨q) é sempre falsa. Logo, a tabela II
representa uma contradição.
• A última coluna da tabela III mostra que a proposição p∨qp pode ser tanto V quanto F. Logo, a tabela
III representa uma contingência.
O gabarito, portanto, é letra B.
Gabarito: Letra B.
...
Informalmente, costuma-se representar essa proposição sempre falsa com o valor lógico F.
     ...
     Em algumas questões de Lógica de Proposições, vamos utilizar, informalmente, as letras c e t
     para representar proposições simples quaisquer, sem que elas sejam uma tautologia ou uma
     contradição.
...
O terceiro método, equivalências lógicas/álgebra de proposições, será abordado na aula de Equivalências
Lógicas.
...
Vamos construir a tabela-verdade da proposição [(p∧q)∧r]→[p(q∨r)] seguindo os quatro passos vistos no
tópico anterior.
...
resultados:
   ...
   •   Se na última coluna da tabela-verdade obtivermos apenas valores verdadeiros, trata-se de uma
       tautologia;
   •   Se na última coluna da tabela-verdade obtivermos apenas valores falsos, trata-se de uma
       contradição; e
   •   Se na última coluna da tabela-verdade obtivermos valores verdadeiros e falsos (V e F), trata-se de
       uma contingência.
...
Para determinar [(p∧q)∧r]→[p(q∨r)], precisamos obter [(p∧q)∧r] e [p(q∨r)].

Para determinar [(p∧q)∧r], precisamos obter (p∧q) e r.

Para determinar (p∧q), precisamos obter p e q.

Para determinar [p(q∨r)], precisamos obter p e (q∨r).
...
(CRO RS/2022) Considerando as proposições p e q, assinale a alternativa que apresenta um exemplo de
contradição.
a) (p∧q)→(p∨q)
b) p∨~p
c) p→(q→p)
...
Temos duas proposições simples distintas. Logo, o número de linhas é 22 = 2 × 2 = 4.
Passo 2: desenhar o esquema da tabela-verdade.
Para determinar (p∨~q)(~p∧q), precisamos obter (p∨~q), (~p∧q), ~p, ~q, p e q.
...
Passo 1: determinar o número de linhas da tabela-verdade.
Temos três proposições simples distintas (t, f e z). Logo, o número de linhas é 23 = 2 × 2 × 2 = 8.


Passo 2: desenhar o esquema da tabela-verdade.
Para determinar (t∧f)→(z∨f), precisamos obter (t∧f), (z∨f), t, z e f.
...
(PETROBRAS/2022) A proposição [(p→r)∧(q→r)]→[r→(p∨q)] é sempre verdadeira, independentemente do
valor-verdade das proposições p, q e r.
Comentários:
A questão pergunta se a proposição [(p→r)∧(q→r)]→[r→(p∨q)] é sempre verdadeira. Em outras palavras,
queremos saber se essa proposição composta é uma tautologia.
Passo 1: determinar o número de linhas da tabela-verdade.
Temos três proposições simples distintas (p, q e r). Logo, o número de linhas é 23 = 2 × 2 × 2 = 8.


Passo 2: desenhar o esquema da tabela-verdade.
Para determinar [(p→r)∧(q→r)]→[r→(p∨q)], precisamos obter [(p→r)∧(q→r)] e [r→(p∨q)].
Para determinar [(p→r)∧(q→r)], precisamos obter (p→r), (q→r), p, q e r.
Para determinar [r→(p∨q)], precisamos obter (p∨q), p, q e r.
...
Passo 4: obter o valor das demais proposições.
• (p→r) é falso somente quando o antecedente p é verdadeiro e o consequente r é falso.
• (q→r) é falso somente quando o antecedente q é verdadeiro e o consequente r é falso.
• (p∨q) é falso somente quando p e q são ambos falsos.
Até o momento, temos o seguinte preenchimento:

• [(p→r)∧(q→r)] é verdadeiro somente quando (p→r) e (q→r) são ambos verdadeiros.
...
• [r→(p∨q)] é falso somente quando o antecedente r é verdadeiro e o consequente (p∨q) é falso.

• [(p→r)∧(q→r)]→[r→(p∨q)] é falsa somente quando [(p→r)∧(q→r)] é verdadeiro e [r→(p∨q)] é falso.

Observe que a tabela-verdade nos mostra que a condicional é falsa na sétima linha. Logo, não se trata de
uma tautologia.
Gabarito: ERRADO.
...
caso, a proposição em questão é uma contingência!
                              ...
                              Certo, professor. Mas o que é esse tal de absurdo?
...
Arbitrariamente, vamos inicialmente supor que [(p∧q)∧r]→[p(q∨r)] é uma contradição.
...
---
  ...
  Aula 00
        ...
        Para fins de resolução de questões de tautologia, contradição e contingência, provar por
        absurdo costuma ser a melhor opção quando comparada com a tabela-verdade. Isso
        porque a construção de uma tabela-verdade costuma levar mais tempo.
...
e) P∨Q∨R∨¬S∨¬P
Comentários:
Pessoal, note que as alternativas de A até D são contingências. Isso porque, nesses quatro casos, as
proposições simples de cada proposição composta não se repetem.
Veja que, nesses quatro casos, podemos atribuir valores lógicos às proposições simples de modo que a
proposição composta pode ser tanto verdadeira quanto falsa a depender dos valores lógicos atribuídos às
proposições simples.
...
As questões a seguir já foram resolvidas utilizando o método da tabela-verdade. Resolveremos, nesse
momento, utilizando o método da prova por absurdo.
...
A questão pergunta se a proposição [(p→r)∧(q→r)]→[r→(p∨q)] é sempre verdadeira. Em outras palavras,
queremos saber se essa proposição composta é uma tautologia.
Como a questão pergunta por uma tautologia, a nossa suspeita é de que [(p→r)∧(q→r)]→[r→(p∨q)] é uma
tautologia.
Nesse caso, vamos tentar aplicar o valor lógico falso à proposição.
Para a condicional [(p→r)∧(q→r)]→[r→(p∨q)] ser falsa, devemos ter o caso V→F. Logo:
• O antecedente [(p→r)∧(q→r)] deve ser verdadeiro; e
• O consequente [r→(p∨q)] deve ser falso.
Vamos analisar primeiro o consequente, pois, a partir da falsidade do consequente, obteremos alguns
valores lógicos que as proposições simples devem ter.
                                                   Consequente
...
• q deve ser falso.
                                                   Antecedente
Para que a conjunção [(p→r)∧(q→r)] seja verdadeira, ambas as parcelas da conjunção devem ser
verdadeiras. Logo:
• (p→r) deve ser verdadeiro; e
• (q→r) deve ser verdadeiro.
Veja que isso não contradiz os valores já obtidos para p, q e r. Isso porque, com r verdadeiro, p falso e q
falso, (p→r) e (q→r) são ambos verdadeiros.


Note, portanto, que para r verdadeiro, p falso e q falso, temos que o antecedente [(p→r)∧(q→r)] é
verdadeiro e o consequente [r→(p∨q)] é falso. Portanto, é possível fazer com que a condicional
[(p→r)∧(q→r)]→[r→(p∨q)] seja falsa!
Isso significa que para esses valores lógicos de r, p e q, temos que a condicional [(p→r)∧(q→r)]→[r→(p∨q)]
é falsa. Logo, não se trata de uma tautologia.
Gabarito: ERRADO.
...
Proposições compostas
1.​   (FGV/TRF1/2024) Sabe-se que a sentença “Se a calça é verde e a camisa é rosa, então o
sapato é branco ou o cinto é marrom” é FALSA.
...
Note que a proposição composta do enunciado pode ser descrita pela condicional v∧r→b∨m:
  v∧r→b∨m: “Se [(a calça é verde) e (a camisa é rosa)], então [(o sapato é branco) ou (o cinto é
                                          marrom)]”
Como essa condicional é falsa, devemos ter o antecedente verdadeiro e o consequente falso
(caso V→F). Logo:
   ●​ v∧r é verdadeiro; e
   ●​ b∨m é falso.
Note que:
   ●​ Para que a conjunção v∧r seja verdadeira, ambas as parcelas devem ser verdadeiras.
      Logo, v e r são ambos verdadeiros.
   ●​ Para a disjunção inclusiva b∨m ser falsa, ambas as parcelas devem ser falsas. Logo, b e m
      são ambos falsos.
...
c) ~b→~r – condicional falsa, pois o antecedente ~b é verdadeiro e o consequente ~r é falso
(caso V→F).
...
d) ~m→b − condicional falsa, pois o antecedente ~m é verdadeiro e o consequente b é falso
(caso V→F).
e) ~v→~m – condicional verdadeira, pois temos o caso F→V, que é uma condicional verdadeira.
Gabarito: Letra E.


2.​     (FGV/CVM/2024) Considere a sentença: Se 𝑥 ≤ 𝑦, então 𝑥 + 2𝑦 < 5.
...
e) 𝑥 = 0 e 𝑦 = 2.
Comentários:
Sabemos que uma condicional só é falsa no caso V→F. Logo, devemos verificar os valores de 𝑥 e
de 𝑦 que fazem com que o antecedente "𝑥 ≤ 𝑦” seja verdadeiro e o consequente "𝑥 + 2𝑦 < 5"
seja falso.
a) 𝑥 = 3 e 𝑦 = 2. ERRADO.
   ...
   ●​ Consequente:
                                                  0 + 2×2 < 5
                                                    0+4 <5
                                                       ...
                                                       (Verdadeiro)
Gabarito: Letra B.
3.​    (FGV/CMSP/2024) Sabe-se que a sentença “Se faz sol e o mar está calmo, então vou
remar” é FALSA.
...
Sejam as proposições simples:
                                            ...
                                            m: "O mar está calmo."
                                                 r: "Vou remar."
A sentença do enunciado corresponde a f∧m→r:
                     f∧m→r: "Se [(faz sol) e (o mar está calmo)], então [vou remar]."
Sabemos que a condicional é falsa somente no caso V→F. Para a condicional em questão, temos
que:
...
e) ~r∧m – Conjunção verdadeira, pois ambos os termos, ~r e m, são verdadeiros. Esse é o
gabarito.
Gabarito: Letra E.
4.​   (FGV/AGENERSA/2023) Sabe-se que a sentença “Paulo não é louro ou Margarida é
morena” é falsa.
É correto concluir que
...
Note que a sentença original é dada por ~p∨m:
                         ~p∨m: "[Paulo não é louro] ou [Margarida é morena]."
Para a disjunção inclusiva ser falsa, ambas as parcelas devem ser falsas. Logo, ~p e m são ambos
falsos. Consequentemente, p é V e m é F.
Com base nisso, vamos avaliar a alternativa que apresenta uma proposição verdadeira:
...
5.​   (FGV/PGM Niterói/2023) Sabe-se que a sentença “Se o sapato é marrom, então a calça é
bege ou a camisa é azul” é FALSA.
É correto concluir que:
...
Considere as proposições simples:
                                           m: "O sapato é marrom."
                                              b: "A calça é bege."
                                              a: "A camisa é azul."
Note que a sentença apresentada corresponde a m→b∨a:
            m→b∨a: “Se [o sapato é marrom], então [(a calça é bege) ou (a camisa é azul)].”
O enunciado afirma que a condicional anterior é falsa. Isso significa que o antecedente da
condicional é verdadeiro e o consequente da condicional é falso. Logo:
...
Para que a disjunção inclusiva b∨a seja falsa, é necessário que ambos os termos sejam falsos.
Logo:
...
6.​    (FGV/MPE SP/2023) Sejam p, q, r, s e t proposições simples e ~p, ~q, ~r, ~s e ~t as suas
respectivas negações.
...
Comentários:
Sabemos que uma disjunção inclusiva "ou" com dois termos é falsa somente quando ambas as
parcelas são falsas. Em outras palavras, uma disjunção inclusiva genérica p∨q é falsa quando p e
q são ambos falsos.
A questão informa que a sequência de disjunções inclusivas p∨q∨~r∨s∨~t é falsa. Nesse caso, é
necessário que todos os termos que compõem essa sequência de "ous" sejam falsos. Logo:
...
Consequentemente, pode-se afirmar que r é verdadeiro e s é falso. O gabarito, portanto, é letra
C.
...
Veja que essa proposição pode ser entendida como (p∨q)∨r, ou seja, como uma disjunção
inclusiva "ou" entre o termo (p∨q) e o termo r.
...
Veja que, se sequência de "ous" p∨q∨r for falsa, concluímos que todos os termos devem ser
falsos.

                             "Ok, professor. E se nós tivermos mais termos?"

Podemos seguir o mesmo raciocínio incluindo mais termos. Considere, por exemplo, que a
seguinte proposição composta é falsa: p∨q∨r∨s.

Veja que essa proposição pode ser entendida como (p∨q∨r)∨s, ou seja, como uma disjunção
inclusiva "ou" entre o termo (p∨q∨r) e o termo s.
...
Note que, se a sequência de "ous" p∨q∨r∨s for falsa, concluímos novamente que todos os
termos devem ser falsos.

Gabarito: Letra C.


7.​    (FGV/BANESTES/2023) Sejam p, q, r e t proposições simples e ∼p, ∼q, ∼r e ∼t,
respectivamente, as suas negações. Se as seguintes proposições compostas têm valor lógico
falso:
                                                           p∨~q
                                                           q∧~r
                                                            r→t
...
e) q, r e t.
Comentários:
O enunciado apresenta três proposições compostas que apresentam valor lógico falso: uma
disjunção inclusiva "ou", uma conjunção "e" e uma condicional "se...então". Sabemos que:

    ●​ A conjunção "e" é verdadeira somente quando ambas as parcelas são verdadeiras. Caso
       contrário, a conjunção é falsa;
...
Para que a disjunção inclusiva p∨~q seja falsa, p e ~q devem ser ambos falsos. Logo, p é F e q é
V.
Para que a condicional r→t seja falsa, o antecedente r deve ser verdadeiro e o consequente t
deve ser falso. Logo, r é V e t é F.
Veja que, a partir da análise das proposições compostas p∨~q e r→t, temos a garantia de que a
proposição composta restante q∧~r é falsa. Isso porque, de acordo com os valores lógicos já
obtidos, a conjunção em questão é falsa, pois temos a conjunção de um termo verdadeiro (q)
com um termo falso (~r).
Portanto, dentre as proposições simples p, q, r e t, conclui-se que são logicamente verdadeiras
apenas as proposições simples q e r.
Gabarito: Letra C.
...
A proposição composta em questão é a conjunção m∧~o. Trata-se de uma conjunção falsa, pois
um dos termos, ~o, é falso.
...
A proposição composta em questão é a disjunção inclusiva p∨~m. Trata-se de uma disjunção
inclusiva falsa, pois ambos os termos, p e ~m, são falsos.
c) Se [Priscila é professora], então [Marlene não é médica]. CERTO. Esse é o gabarito.
A proposição composta em questão é a condicional p→~m. Trata-se da condicional F→F, que é
uma condicional verdadeira. Isso porque a condicional só é falsa quando o antecedente é
verdadeiro e o consequente é falso (caso V→F).
d) Se [Priscila não é professora], então [Olga não é oftalmologista]. ERRADO.
A proposição composta em questão é a condicional ~p→~o. Trata-se da condicional V→F, que é
uma condicional falsa.
e) Se [Olga é oftalmologista], então [Marlene não é médica]. ERRADO.
A proposição composta em questão é a condicional o→~m. Trata-se da condicional V→F, que é
uma condicional falsa.
Gabarito: Letra C.
...
O enunciado nos diz que a segunda sentença, s→p, é falsa. Sabemos que uma condicional é falsa
somente no caso V→F. Logo, temos que: s é verdadeiro e p é falso.
Além disso, o enunciado nos diz que a primeira sentença, p∨b, é verdadeira. Para uma disjunção
inclusiva ser verdadeira, ao menos um dos termos deve ser verdadeiro. Como p é falso, devemos
ter que                            b é verdadeiro.
...
10.​ (FGV/SEFAZ BA/2022) Sabe-se que a sentença “Se João não é vascaíno, então Júlia é
tricolor ou Marcela não é botafoguense.” é falsa.
É correto concluir que
...
Como ~v é verdadeiro, v é falso. Além disso, para que a disjunção inclusiva t∨~b seja falsa, é
necessário que ambos os termos sejam falsos. Logo:
...
Temos uma conjunção em que um dos termos, v, é falso. Logo, a alternativa apresenta uma
conjunção falsa.
b) Se [Marcela é botafoguense], então [Júlia é tricolor] − b→t. FALSO.
Temos uma condicional em que o antecedente b é verdadeiro e o consequente t é falso. Logo, a
alternativa apresenta uma condicional falsa (caso V→F).
c) [João é vascaíno] ou [Marcela não é botafoguense] − v∨~b. FALSO.
Temos uma disjunção inclusiva em que ambos os termos, v e ~b, são falsos. Logo, a alternativa
apresenta uma disjunção inclusiva falsa.
d) Se [Júlia não é tricolor], então [Marcela é botafoguense] − ~t→b. VERDADEIRO. Esse é o
gabarito.
Temos uma condicional em que o antecedente ~t é verdadeiro e o consequente b é verdadeiro.
Logo, a alternativa apresenta uma condicional verdadeira (V→V). Esse é o gabarito.
e) [João não é vascaíno], [Júlia não é tricolor] e [Marcela não é botafoguense] − ~v∧~t∧~b.
FALSO.
Temos uma sequência de conjunções em que um dos termos, ~b, é falso. Logo, a conjunção em
questão é falsa. Note que, realizando as conjunções na ordem em que aparece, temos:
                                                   (~v∧~t)∧~b
                                                      (V∧V)∧F
                                                        V∧F
...
---
  ...
  Aula 00
                                                          ...
                                                          F
Gabarito: Letra D.
11.​    (FGV/CM Taubaté/2022) Sabe-se que a sentença “Se a camisa é verde, então a calça é
azul ou o sapato não é preto” é falsa. É correto concluir que
...
Sabemos que a condicional apresentada é falsa. Nesse caso, o antecedente v deve ser
verdadeiro e o consequente (a∨~p) deve ser falso (caso V→F).
Para que a disjunção inclusiva (a∨~p) seja falsa, os termos a e ~p devem ser ambos falsos. Logo,
a é falso e p é verdadeiro.
Em resumo:
...
- Marlene é médica – m é verdadeiro;

- Olga é oftalmologista – o é verdadeiro

- Priscila não é professor − ~p é verdadeiro e, portanto, p é falso.

Com base nisso, vamos avaliar a alternativa que apresenta uma proposição composta verdadeira:
a) [Marlene é médica] e [Olga não é oftalmologista] − m∧~o – trata-se de uma conjunção falsa,
pois um de seus termos, ~o, é falso.
b) [Priscila é professora] ou [Marlene não é médica]. − p∨~m – trata-se de uma disjunção inclusiva
falsa, pois ambos os termos, p e ~m, são falsos.
c) Se [Priscila é professora], então [Marlene não é médica]. − p→~m – trata-se de uma condicional
F→F, que é uma condicional verdadeira. Isso porque a condicional é falsa somente no caso V→F.
O gabarito, portanto, é letra C.
d) Se [Priscila não é professora], então [Olga não é oftalmologista]. − ~p→~o – trata-se de uma
condicional falsa, pois temos o caso V→F.
e) Se [Olga é oftalmologista], então [Marlene não é médica]. − o→~m – trata-se de uma
condicional falsa, pois temos o caso V→F.

Gabarito: Letra C.

13.​ (FGV/PM AM/2022) Sabe-se que a sentença “Se o sapato é preto, então a meia é preta ou
o cinto é preto” é FALSA.
É correto concluir que
...
Para que a disjunção inclusiva m∨c seja falsa, é necessário que ambos os termos sejam falsos.
Logo:
...
Gabarito: Letra A.
14.​   (FGV/PC AM/2022) Sabe-se que a sentença “Se a camisa é azul, então a calça não é
branca ou o boné é preto” é FALSA.
...
Para que a disjunção inclusiva ~b∨p seja falsa, é necessário que ambos os termos sejam falsos.
Logo:
...
Gabarito: Letra D.
15.​   (FGV/PC RN/2021) Sabe-se que a sentença “Se a camisa é branca, então a calça é
branca” é FALSA e a sentença “Se o sapato é preto, então a camisa não é branca” é
VERDADEIRA.
É correto concluir que:
...
Considere as proposições simples:
                                           m: "A camisa é branca."
                                             l: "A calça é branca."
                                             s: "O sapato é preto."
Note que a primeira sentença é dada por m→l:
                        m→l: "Se [a camisa é branca], então [a calça é branca]."
Por outro lado, a segunda sentença é dada por s→~m:
                     s→~m: Se [o sapato é preto], então [a camisa não é branca].
O enunciado nos diz que a primeira sentença, m→l, é falsa. Sabemos que uma condicional é falsa
somente no caso V→F. Logo, temos que: m é verdadeiro e l é falso.
Além disso, o enunciado nos diz que a segunda sentença, s→~m, é verdadeira. Para a
condicional ser verdadeira, não podemos recair no caso V→F. Como o consequente ~m é falso,
devemos ter que o antecedente s é falso.
Em resumo, temos os seguintes valores lógicos:
...
Sendo l falso, temos que ~l é verdadeiro. Além disso, sendo s falso, temos que ~s é verdadeiro.
Logo:
...
Comentários:
Note que a proposição simples "30% de 120 = 36" é verdadeira, pois 0,3 × 120 = 36. Além
disso, a proposição simples "25% de 140 = 36" é falsa, pois 0,25 × 140 = 35.
Com base nisso, vamos analisar as proposições compostas I, II e III.
I. 30% de 120 = 36 e 25% de 140 = 36.
FALSA. A proposição composta apresentada é uma conjunção (∧), pois liga duas proposições por
meio do conectivo "e". Com base nos valores lógicos das proposições simples, temos:
                                  (30% de 120 = 36) ∧ (25% de 140 = 36)
                                                       V∧F
Trata-se de uma conjunção falsa, pois para uma conjunção ser verdadeira ambas as proposições
devem ser verdadeiras.
II. 30% de 120 = 36 ou 25% de 140 = 36.
VERDADEIRA. A proposição composta apresentada é uma disjunção inclusiva (∨), pois liga duas
proposições por meio do conectivo "ou". Com base nos valores lógicos das proposições simples,
temos:
                                  (30% de 120 = 36) ∨ (25% de 140 = 36)
                                                       V∨F
Trata-se de uma disjunção inclusiva verdadeira, pois para ela ser verdadeira basta que uma das
proposições seja verdadeira.
III. Se 25% de 140 = 36, então 30% de 120 = 36.
VERDADEIRA. A proposição composta apresentada é uma condicional (→), pois liga duas
proposições por meio do conectivo "se... então". Com base nos valores lógicos das proposições
simples, temos:
                                  (25% de 140 = 36) → (30% de 120 = 36)
                                                       F→V
Trata-se de uma condicional verdadeira, pois o único caso em que a condicional é falsa ocorre
quando antecedente é verdadeiro e o consequente é falso (V→F).
...
17.​ (FGV/BANESTES/2018) Considere a sentença: “Se Emília é capixaba, então ela gosta de
moqueca”. Um cenário no qual a sentença dada é falsa é:
...
Sejam as proposições simples:
                                            p: "Emília é capixaba."
                                       q: "Emília gosta de moqueca."
A sentença apresentada consiste na condicional p→q:
                      p→q: "Se Emília é capixaba, então ela gosta de moqueca."
Para a sentença em questão ser falsa, o antecedente p deve ser verdadeiro e o consequente q
deve ser falso, pois o único caso em que temos uma condicional falsa é o caso V→F.
Logo, o cenário no qual a sentença dada é falsa é Emília é capixaba (p é V) e não gosta de
moqueca (q é F).
Gabarito: Letra C.
...
Comentários:
A sentença apresentada é uma condicional, pois apresenta o conectivo "se... então". Para a
condicional ser falsa, devemos ter o antecedente "Jorge é torcedor do Vitória" verdadeiro e o
consequente "Jorge é soteropolitano" falso.
Assim, Jorge deve ser torcedor do Vitória e não deve ser soteropolitano. Essa situação é
apresentada na alternativa D: "Jorge é torcedor do Vitória e é paulista".
...
19.​ (FGV/MPE MS/2013) Um contra‐exemplo para uma determinada afirmativa é um exemplo
que a contradiz, isto é, um exemplo que torna a afirmativa falsa.
No caso de afirmativas do tipo “SE antecedente ENTÃO consequente”, um contra‐exemplo
...
e) x = 21
Comentários:
Seguindo o comando da questão, devemos selecionar dentre as alternativas um valor para 𝑥 que
torne o antecedente "𝑥 é múltiplo de 7" verdadeiro e que torne o consequente "𝑥 é um número
ímpar" falso. Isto é, devemos selecionar um número que seja múltiplo de 7 e que não seja ímpar.
Trata-se do número 14, presente na alternativa D.
Gabarito: Letra D.


20.​ (FGV/TJ AM/2013) Antônio utiliza exclusivamente a regra a seguir para aprovar ou não os
possíveis candidatos a namorar sua filha:
...
Definidas as proposições simples, podemos descrever o critério de Antônio por ~v → (r∨m).
   ~v → (r∨m): "Se [não for torcedor do Vasco] então [(tem que ser rico) ou (gostar de música
                                          clássica)]. "
Vamos ver o valor lógico de ~v → (r∨m) para cada um dos candidatos a namorar a filha de
Antônio, lembrando que um condicional é falso somente quando o antecedente é verdadeiro e o
consequente é falso.
Pedro: torcedor do Flamengo (v é F), não é rico (r é F), não gosta de música clássica (m é F).
Temos o antecedente ~v verdadeiro e o consequente r∨m falso. Logo, o condicional ~v → (r∨m)
é falso, isto é, Pedro não foi aprovado.
Carlos: torcedor do Vasco (v é V), é rico (r é V), gosta de música clássica (m é V).
Temos o antecedente ~v falso e o consequente r∨m verdadeiro. Logo, o condicional ~v → (r∨m)
é verdadeiro, isto é, Carlos foi aprovado.
Marcos: torcedor do São Raimundo (v é F), é rico (r é V), gosta de música clássica (m é V).
Temos o antecedente ~v verdadeiro e o consequente r∨m verdadeiro. Logo, o condicional ~v →
(r∨m) é verdadeiro, isto é, Marcos foi aprovado.
Tiago: torcedor do Vasco (v é V), não é rico (r é F), não gosta de música clássica (m é F).
Temos o antecedente ~v falso e o consequente r∨m falso. Logo, o condicional ~v → (r∨m) é
verdadeiro, isto é, Tiago foi aprovado.
Bruno: torcedor do Nacional (v é F), não é rico (r é F), gosta de música clássica (m é V).
Temos o antecedente ~v verdadeiro e o consequente r∨m verdadeiro. Logo, o condicional ~v →
(r∨m) é verdadeiro, isto é, Bruno foi aprovado.
...
ou falso) são, a princípio, desconhecidos. No diagrama abaixo, cada célula numerada deve
conter os resultados lógicos das proposições compostas formadas pelo conectivo condicional
(⇒), em que as proposições nas linhas são os antecedentes e nas colunas, os consequentes. Os
resultados das células 3, 4 e 7 já foram fornecidos.
...
e) 8 é verdadeiro.
Comentários:
Note que cada célula numerada contém o valor lógico resultante da condicional formada pelas
seguintes parcelas:

   ●​ Antecedente: proposição correspondente à linha;
   ●​ Consequente: proposição correspondente à coluna.

Lembre-se de que a condicional p→q é falsa somente quando a primeira parcela é verdadeira e a
segunda parcela é falsa. Nos demais casos, a condicional é verdadeira.

Voltando à questão, temos que resultados das células 3, 4 e 7 já foram fornecidos. A partir dessa
informação, podemos extrair alguns resultados:

   ●​ A célula 4 nos diz que a condicional q→p é F. Sabemos que só existe uma possibilidade
      para a condicional ser falsa: o antecedente q é V e o consequente p é F.
   ●​ A célula 7 nos diz que a condicional r→p é V. Já sabemos que o consequente p é F. Para
      que a condicional seja verdadeira, não podemos ter o antecedente r verdadeiro, pois
      nesse caso teríamos a condicional V→F. Logo, r é F.
   ●​ A célula 3 de fato apresenta uma condicional verdadeira, pois se trata da condicional p→r,
      que corresponde à condicional F→F.
...
a) 1 é falso.
ERRADO. A célula 1 corresponde ao condicional p→p, isto é, F→F. Trata-se de um condicional
verdadeiro.
b) 2 é falso.
ERRADO. A célula 2 corresponde ao condicional p→q, isto é, F→V. Trata-se de um condicional
verdadeiro.
c) 5 é falso.
ERRADO. A célula 5 corresponde ao condicional q→q, isto é, V→V. Trata-se de um condicional
verdadeiro.
d) 6 é verdadeiro.
ERRADO. A célula 6 corresponde ao condicional q→r, isto é, V→F. Trata-se de um condicional
falso.
e) 8 é verdadeiro.
CERTO. A célula 8 corresponde ao condicional r→q, isto é, F→V. Trata-se de um condicional
verdadeiro.
Gabarito: Letra E.


22.​ (FGV/MEC/2009) Com relação à naturalidade dos cidadãos brasileiros, assinale a
...
Comentários:
Antes de analisar as alternativas, devemos nos recordar que um condicional da forma p→q pode
ser descrito das seguintes formas:
...
Devemos entender que se alguém é paulista, então essa pessoa é brasileira. O contrário não
podemos dizer, isto é, não podemos dizer que se alguém é brasileiro, então essa pessoa é
paulista. Logo:
...
A alternativa A traz a expressão "condição necessária e suficiente", que remete a um
bicondicional. Portanto, a alternativa está errada.
                                                  Alternativa B
Podemos escrever a condicional a→b: "Se é paranaense, então é brasileiro". As outras formas
alternativas de se representar a→b são:
...
A alternativa erra ao dizer que ser brasileiro é condição suficiente para ser paranaense.
                                                  Alternativa C
Podemos escrever a condicional c→b: "Se é carioca, então é brasileiro". As outras formas
alternativas de se representar c→b são:

   ●​ Ser carioca é condição suficiente para ser brasileiro;
   ●​ Ser brasileiro é condição necessária para ser carioca.

A alternativa C traz a expressão "condição necessária e suficiente", que remete a um
bicondicional. Portanto, a alternativa está errada.
                                                  Alternativa D
Podemos escrever a condicional n→b: "Se é baiano, então é brasileiro". As outras formas
alternativas de se representar n→b são:

   ●​ Ser baiano é condição suficiente para ser brasileiro;
   ●​ Ser brasileiro é condição necessária para ser baiano.

A alternativa D traz a representação correta da situação: "Ser baiano é condição suficiente, mas
não necessária para ser brasileiro".
                                                  Alternativa E
Podemos escrever a condicional m→b: "Se é maranhense, então é brasileiro". As outras formas
alternativas de se representar m→b são:
...
23.​ (FGV/Senado/2008) Cada um dos cartões abaixo tem de um lado um número e do outro
...
A afirmação "todos os cartões que têm um triângulo em uma face têm um número primo na
outra" pode ser entendida, para cada cartão, por meio da seguinte condicional:
  p→q: "Se [o cartão tem um triângulo em uma face], então [o cartão tem um número primo na
                                        outra face]."
...
Voltando à questão, deve-se obter quais cartões precisamos virar para verificar se a condicional
p→q será verdadeira para todos os cartões.
                                                 Primeiro cartão
Note que o cartão tem um triângulo em uma face e, portanto, p é verdadeiro. Com essa
informação, a condicional p→q corresponde a:
                                                      V → (?)
Veja que:

   ●​ Se o consequente q for verdadeiro, a condicional será da forma V→V e, portanto, será
      verdadeira.
   ●​ Se o consequente q for falso, a condicional será da forma V→F e, portanto, será falsa.

Logo, para verificar se a condicional p→q é verdadeira, precisamos virar o primeiro cartão para
verificar se q é verdadeiro ou se é falso, isto é, precisamos virar o primeiro cartão para verificar se
ele tem ou não tem um número primo na outra face.
                                                 Segundo cartão
Note que o segundo cartão tem um pentágono em uma face e, portanto, p é falso, pois não se
trata de um triângulo. Com essa informação, a condicional p→q corresponde a:
                                                      F → (?)
Veja que:

   ●​ Se o consequente q for verdadeiro, a condicional será da forma F→V e, portanto, será
      verdadeira.
   ●​ Se o consequente q for falso, a condicional será da forma F→F e, portanto, também será
      verdadeira.

Logo, a condicional p→q é verdadeira, independentemente do valor de q. Portanto, não
precisamos virar o segundo cartão para verificar se q é verdadeiro ou se é falso, isto é, não
precisamos virar o segundo cartão para verificar se ele tem ou não tem um número primo na
outra face.
                                                 Terceiro cartão
Note que o cartão tem o número 7 em uma face e, portanto, q é verdadeiro, pois 7 é um número
primo. Com essa informação, a condicional p→q corresponde a:
...
Veja que:
   ...
   ●​ Se o antecedente p for verdadeiro, a condicional será da forma V→V e, portanto, será
      verdadeira.
   ●​ Se o consequente p for falso, a condicional será da forma F→V e, portanto, também será
      verdadeira.

Logo, a condicional p→q é verdadeira, independentemente do valor de p. Portanto, não
precisamos virar o segundo cartão para verificar se p é verdadeiro ou se é falso, isto é, não
precisamos virar o segundo cartão para verificar se ele tem ou não tem um triângulo.
                                                  Quarto cartão
Note que o cartão tem o número 6 em uma face e, portanto, q é falso, pois 6 não é primo. Com
essa informação, a condicional p→q corresponde a:
                                                      (?) → F
Veja que:

   ●​ Se o antecedente p for verdadeiro, a condicional será da forma V→F e, portanto, será
      falsa.
   ●​ Se o antecedente p for falso, a condicional será da forma F→F e, portanto, será verdadeira.

Logo, para verificar se a condicional p→q é verdadeira, precisamos virar o quarto cartão para
verificar se p é verdadeiro ou se é falso, isto é, precisamos virar o quarto cartão para verificar se
ele tem ou não tem um triângulo.
Note, portanto, que para garantir que a condicional p→q é válida para todos os cartões, isto é,
para garantir que é verdadeiro que "todos os cartões que têm um triângulo em uma face têm um
número primo na outra", é suficiente virar o primeiro e o último cartão.
Gabarito: Letra E.


24.​ (FGV/SEFAZ MS/2006) Considere verdadeira a proposição "o jogo só será realizado se
não chover". Podemos concluir que:
...
Comentários:
A proposição composta original, dada por "o jogo só será realizado se não chover", corresponde
...
Em outras palavras, podemos escrever:
                             "O jogo será realizado somente se não chover."
Trata-se de uma condicional p→q escrita na forma "p somente se q". Essa mesma condicional
pode ser escrita na forma "Se p, q":
                                    "Se o jogo é realizado, não chove."
Infelizmente, a questão apresentou a negação de "chover" como se fosse o antônimo "o tempo
é bom". Trata-se de um entendimento equivocado que por vezes aparece em questões de
concurso público. O equívoco ocorre porque, como visto na teoria, a negação de "chover" não
corresponde a "o tempo é bom".
Utilizando o entendimento da banca, a condicional pode ser descrita por:
                                 "Se o jogo é realizado, o tempo é bom."
Gabarito: Letra A.
...
Tabela-verdade
 ...
 (FGV/DNIT/2024) Considere a sentença:
...
Para determinar (a∨b)→(c∧~b), precisamos obter (a∨b) e (c∧~b);

Para determinar (a∨b) precisamos obter a e b;

Para determinar (c∧~b), precisamos obter c e ~b;
...
Gabarito: Letra E.
 ...
 (FGV/BANESTES/2023) Sejam p, q e r proposições simples e ∼p, ∼q e ∼r, respectivamente, as suas
negações. As seguintes proposições compostas têm valor lógico verdadeiro:
                                                             p∨q
                                                            q∨~r
                                                            r∨~p
...
A questão apresenta três disjunções inclusivas verdadeiras: p∨q, q∨~r e r∨~p.
...
Passo 2: desenhar o esquema da tabela-verdade.
   ...
   •   Proposição r∨~p:
       ...
       Para determinar r∨~p, precisamos obter r e ~p.
...
Isso significa que p∨q, q∨~r e r∨~p são simultaneamente verdadeiras para os seguintes casos:
   ...
   •   Primeira linha: p verdadeiro, q verdadeiro e r verdadeiro;
   •   Quinta linha: p falso, q verdadeiro e r verdadeiro; e
   •   Sexta linha: p falso, q verdadeiro e r falso.
...
Introdução às proposições
 ...
 (INÉDITA) Assinale a alternativa que apresenta uma proposição.
a) Um caderno cinza.
b) Estuda que a vida muda.
c) Estudar Raciocínio Lógico é muito divertido!
d) João é servidor público.
e) Qual é o seu nome?
...
a) Um caderno cinza. ERRADO.

A frase apresentada não apresenta sentido completo, pois não apresenta verbo. Logo, não se trata de uma
proposição.

b) Estuda que a vida muda. ERRADO.

Trata-se de uma sentença imperativa, pois indica um conselho. Logo, a frase em questão não é uma
proposição, não sendo possível atribuir um valor lógico a ela.

c) Estudar Raciocínio Lógico é muito divertido! ERRADO.

Trata-se de uma sentença exclamativa. Logo, a frase em questão não é uma proposição, não sendo possível
atribuir um valor lógico a ela.

d) João é servidor público. CERTO. Esse é o gabarito.

Observe que a sentença em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso.

e) Qual é o seu nome? ERRADO.

Trata-se de uma sentença interrogativa. Logo, a frase em questão não é uma proposição, não sendo possível
atribuir um valor lógico a ela.
...
---
  ...
  (INÉDITA) Analise as frases a seguir.
I. John Kennedy foi Presidente dos Estados Unidos de 1961 a 1963.
II. Estude para que você seja aprovado.
III. Doze horas, cinquenta minutos e vinte segundos.
IV. Existe uma cidade brasileira que apresenta mais de 10 milhões de habitantes.
V. O estudo das proposições é muito importante!
...
Vamos analisar cada uma das sentenças de I a V.

I. John Kennedy foi Presidente dos Estados Unidos de 1961 a 1963. Proposição lógica.

Observe que a sentença em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso.

II. Estude para que você seja aprovado. Sentença imperativa.

Trata-se de uma sentença imperativa, pois indica uma ordem, um pedido ou um conselho. Logo, a frase em
questão não é uma proposição, não sendo possível atribuir um valor lógico a ela.

III. Doze horas, cinquenta minutos e vinte segundos. Expressão.

A frase apresentada não apresenta sentido completo, pois não apresenta verbo. Logo, não se trata de uma
proposição.

IV. Existe uma cidade brasileira que apresenta mais de 10 milhões de habitantes. Proposição lógica.

Observe que a sentença em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso. Note que, nessa frase,
temos o quantificador "existe", que transforma uma sentença aberta em uma proposição.

V. O estudo das proposições é muito importante! Sentença exclamativa.
...
Portanto são proposições as frases I e IV. O gabarito, portanto, é letra B.
...
Vamos analisar cada uma das sentenças de I a VI.

I. Gatos são répteis. Proposição lógica.

Observe que a sentença em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso.

II. 1331 é múltiplo de 11. Proposição lógica.

Observe que a sentença em questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser
atribuída um, e apenas um, dos dois possíveis valores lógicos: verdadeiro ou falso.

Além disso, se analisarmos a proposição matematicamente, sabemos que se trata de uma proposição
verdadeira, pois 1331 é múltiplo de 11.

III. Não pare de estudar. Sentença imperativa.
...
IV. 86 + 5 < 90. Proposição lógica.

Devemos entender essa proposição como "86 mais 5 é menor do que 90". Observe que a sentença em
questão é uma proposição lógica, pois é uma oração declarativa à qual pode ser atribuída um, e apenas um,
dos dois possíveis valores lógicos: verdadeiro ou falso.

Além disso, se analisarmos a proposição matematicamente, sabemos que se trata de uma proposição falsa,
pois 86 mais 5 é maior do que 90.
...
lógico de "2x < 4" dependeria do valor da variável x. Note, por exemplo, que se x fosse 10, teríamos "20 < 4",
que seria uma proposição falsa. Por outro lado, se x fosse 1, teríamos "2 < 4", que seria uma proposição
verdadeira.                                            ==219a34==
...
Esse quantificador transformou a sentença aberta "2x < 4" em uma proposição. Veja que é possível atribuir
um único valor lógico à proposição apresentada no item V. Ainda, se analisarmos matematicamente a
proposição "Existe um número inteiro x tal que 2x < 4", podemos perceber que ela é verdadeira, pois de
fato existe um inteiro que satisfaz a inequação. Por exemplo, x = 1 é um inteiro x tal que 2x < 4.
...
Portanto são proposições as frases I, II, IV e V. O gabarito, portanto, é letra D.

Gabarito: Letra D.

 (INÉDITA) Julgue o item a seguir:
A frase "Ele ganhou o Prêmio Nobel em 2021" é uma proposição simples.

Comentários:

Note que o pronome "ele" funciona como uma varável na frase apresentada. Trata-se de uma sentença
aberta, cujo valor lógico só poderia ser aferido ao se determinar a variável "ele". Consequentemente, não
temos uma proposição, pois não se pode atribuir um valor lógico à frase apresentada.
...
---
  ...
  (INÉDITA) Julgue o item a seguir:
Na Lógica Proposicional, o Princípio da Não Contradição informa que uma proposição verdadeira é sempre
verdadeira, e uma proposição falsa é sempre falsa.

Comentários:

O item apresentou a definição do Princípio da Identidade. O Princípio da Não Contradição nos diz que uma
proposição não pode ser verdadeira e falsa ao mesmo tempo.

Gabarito: ERRADO.

  (INÉDITA) Um casal de matemáticos se comunica por meio de proposições lógicas. Certa vez, Bernaldo
disse para sua mulher Arnilda:
                                       "Arnilda e Bernaldo vão ao cinema."
Arnilda, indecisa quanto ao fato de ela querer ir ou não ao cinema, atribui à proposição lógica apresentada
pelo seu marido o valor lógico "talvez". Considerando a Lógica Bivalente, Arnilda violou o seguinte
princípio:
a) Princípio do Contraditório.
b) Princípio da Não Contradição.
c) Princípio do Terceiro Incluído.
d) Princípio da Identidade.
e) Princípio do Terceiro Excluído.

Comentários:

Na Lógica Bivalente, o Princípio do Terceiro Excluído nos diz que uma proposição ou é verdadeira ou é falsa,
excluindo-se a possibilidade de um terceiro valor lógico "talvez". O gabarito, portanto, é letra E.
...
Proposições simples
 ...
 (INÉDITA) A negação da proposição "O Flamengo perdeu o jogo contra o Corinthians" é:
a) O Flamengo venceu o jogo contra o Corinthians.
b) O Corinthians perdeu o jogo contra o Flamengo.
c) O Flamengo não venceu o jogo contra o Corinthians.
d) O Corinthians não perdeu o jogo contra o Flamengo.
e) O Flamengo não perdeu o jogo contra o Corinthians.

Comentários:

A forma mais direta de se negar uma proposição simples é negar o verbo da proposição por meio da palavra
"não". Portanto, a negação da proposição original é:

                            "O Flamengo não perdeu o jogo contra o Corinthians."

O gabarito, portanto, é letra E.

Outras expressões equivalentes ao "não" podem ser utilizadas, como "não é verdade que" ou "é falso que".
Portanto, as seguintes negações também estariam corretas, caso houvesse alternativa:

                     "Não é verdade que o Flamengo perdeu o jogo contra o Corinthians."

                        "É falso que o Flamengo perdeu o jogo contra o Corinthians."

A pegadinha da questão está na letra A, que utiliza o antônimo "vencer" para negar o verbo "perder":

                              "O Flamengo venceu o jogo contra o Corinthians."

Veja que é errado negar a proposição original por meio do antônimo "vencer", pois essa suposta negação
não abarca a possibilidade de o jogo ter empatado.
...
---
  ...
  (INÉDITA) A negação da proposição "João não gosta de comer mandioca" é:
a) João come mandioca.
b) João odeia comer mandioca.
c) João gosta de comer tapioca.
d) É falso que João gosta de comer mandioca.
e) Não é verdade que João não gosta de comer mandioca.

Comentários:

Note que a proposição original é uma sentença declarativa negativa:

                                    p: "João não gosta de comer mandioca"

Para negar uma sentença declarativa negativa, a forma mais simples seria remover a palavra "não":

                                       ~p: "João gosta de comer mandioca"

Veja que não temos "João gosta de comer mandioca" nas alternativas. Note, porém, que podemos negar a
proposição original "João não gosta de comer mandioca" inserindo o termo "Não é verdade que":

                        ~p: "Não é verdade que João não gosta de comer mandioca"

O gabarito, portanto, é letra E. Vejamos os erros das demais alternativas:

a) João come mandioca.

A proposição apresentada na alternativa A apresenta uma ideia completamente distinta da proposição
original. Note que na proposição original temos a ideia de "gostar de comer", enquanto na alternativa temos
simplesmente o verbo "comer".

b) João odeia comer mandioca.

Essa alternativa substitui o termo "não gosta" por um termo semelhante: "odeia". Veja que essa troca muda
o sentido da proposição original e, além disso, definitivamente não nega a proposição original.

c) João gosta de comer tapioca.

A proposição apresentada na alternativa C apresenta uma ideia completamente distinta da proposição
original, pois a negação de "não gostar de comer mandioca" não corresponde a "gostar de comer tapioca".

d) É falso que João gosta de comer mandioca.

Essa proposição é uma forma equivalente de se dizer "João não gosta de comer mandioca". Não se trata da
...
---
 ...
 (INÉDITA) Julgue o item a seguir.
A proposição "É falso que não é verdade que Porto Alegre não é a capital do Rio Grande do Sul"
corresponde a "Não é verdade que Porto Alegre é a Capital do Rio Grande do Sul".

Comentários:

Considere a seguinte proposição simples:

                                p: "Porto Alegre é a capital do Rio Grande do Sul".

Podemos negar p da seguinte forma:

                             ~p: "Porto Alegre não é a capital do Rio Grande do Sul".
                                                         ==219a34==

A partir de ~p, podemos negar essa proposição por meio do termo “não é verdade que”, obtendo ~(~p):

               ~(~p): "Não é verdade que [Porto Alegre não é a capital do Rio Grande do Sul]".

A partir de ~(~p), podemos negar essa proposição por meio do termo “é falso que”, obtendo ~(~(~p)):

       ~(~(~p)): "É falso que [não é verdade que [Porto Alegre não é a capital do Rio Grande do Sul]]".

Note, portanto, que a proposição original apresentada no enunciado, ~(~(~p)), é a tripla negação da
proposição p. Sabemos que, quando tivermos várias negações em sequência, podemos utilizar a seguinte
regra:

   •     Se tivermos um número par de negações, temos uma proposição equivalente a original; e
   •     Se tivermos um número ímpar de negações, temos a negação da proposição original.

Logo, a proposição original ~(~(~p)) corresponde a ~p, que pode ser escrita assim:

                    ~p: "Não é verdade que Porto Alegre é a Capital do Rio Grande do Sul".
...
---
 ...
 (INÉDITA) Julgue o item a seguir.
A negação da proposição "Creio que você está equivocado" pode ser expressa por "Creio que você não
está equivocado".

Comentários:

Para negar uma proposição simples formada por uma oração principal e por orações subordinadas, devemos
negar o verbo da oração principal.

                                       p: “Creio que você está equivocado.”

                                                 p: “Creio nisso.”

Nesse caso, podemos negar a proposição do seguinte modo:

                                              ~p: “Não creio nisso.”

Retornando à proposição original:

                                  ~p: “Não creio que você está equivocado.”

Perceba que a negação obtida é diferente da sugerida pelo enunciado.
...
Conversão da linguagem natural para a proposicional
 ...
 (INÉDITA/2022) Considere as seguintes proposições simples:
P: "João come lasanha."
Q: "Pedro gosta de futebol."
R: "Marina toca piano."
A alternativa que representa corretamente a proposição ~R→P∧~Q é:
a) Se Marina não toca piano, então João não come lasanha e Pedro gosta de futebol.
b) Marina não tocar piano é condição necessária para João comer lasanha e Pedro não gostar de futebol.
c) Marina tocar piano é condição suficiente para João não comer lasanha e Pedro gostar de futebol.
d) Marina não toca piano porque João come lasanha e Pedro não gosta de futebol.
e) Marina não toca piano somente se João come lasanha e Pedro não gosta de futebol.

Comentários:

Pela ordem de precedência dos conectivos, devemos executar a conjunção P∧~Q e depois a condicional cujo
antecedente é ~R e o consequente é P∧~Q. Logo, ~R→P∧~Q pode ser descrito por:

  ~R→P∧~Q: "Se [Marina não toca piano], então [(João come lasanha) e (Pedro não gosta de futebol)]."

Note que não temos essa condicional obtida nas alternativas. Note, porém, que a mesma condicional pode
ser descrita por meio do conectivo "somente se".

~R→P∧~Q: " [Marina não toca piano] somente se [(João come lasanha) e (Pedro não gosta de futebol)]."
...
Veja que essa alternativa apresenta a condicional ~R→~P∧Q, que é diferente da requisitada pela questão.

  ~R→~P∧Q: "Se [Marina não toca piano], então [(João não come lasanha) e (Pedro gosta de futebol)]."

b) Marina não tocar piano é condição necessária para João comer lasanha e Pedro não gostar de futebol.

Lembre-se de que o antecedente é a condição suficiente de uma condicional. Logo, para representar
~R→P∧~Q, o correto seria dizer que:
...
---
  ...
  ~R→P∧~Q: "[Marina não tocar piano] é condição suficiente para [(João comer lasanha) e (Pedro não
                                       gostar de futebol)]".

c) Marina tocar piano é condição suficiente para João não comer lasanha e Pedro gostar de futebol.

Veja que essa alternativa apresenta a proposição R→~P∧Q, que é diferente da requisitada pela questão.

R→~P∧Q: " [Marina tocar piano] é condição suficiente para [(João não comer lasanha) e (Pedro gostar de
                                             futebol)]."

d) Marina não toca piano porque João come lasanha e Pedro não gosta de futebol.

Lembre-se de que o conectivo "porque" é do tipo condicional em que se inverte o antecedente e o
consequente. Logo, a proposição apresentada nessa alternativa corresponde a P∧~Q→~R.
                                                       ==219a34==

 P∧~Q→~R: "[Marina
            ⏟      não toca piano] porque [(João
                                            ⏟ come lasanha) 𝐞 (Pedro não gosta de futebol)]."
                      Consequente ~𝐑                                         Antecedente 𝐏∧~𝐐
...
Q: "Fez sol."
R: "Comi hamburguer."
Assinale a alternativa que representa corretamente a proposição "Fui ao parque, pois fez sol e não comi
hamburguer":
a) (P→Q)∧~R
b) P→Q∧~R
c) (Q→P)∧~R
...
Observe que a condicional apresentada está na forma em que ocorre inversão entre o antecedente e o
consequente. Temos:

                           "[Fui ao parque], pois [fez sol e não comi hamburguer]."

Podemos reescrever a frase no modo tradicional:

                        "Se [fez sol e não comi hamburguer], então [fui ao parque]."
...
Note que o antecedente da condicional é a conjunção Q∧~R e o consequente da condicional é P. Logo, a
condicional em questão é dada por Q∧~R→P:

                Q∧~R→P: "Se [(fez sol) e (não comi hamburguer)], então [fui ao parque]."

O gabarito, portanto, é letra D.

Uma dúvida interessante que poderia surgir está presente na alternativa C. Note que ela representa a
conjunção de (Q→P) com ~R.


                                                                        ,
                             ⏟ ao parque], 𝐩𝐨𝐢𝐬 [fez sol]) e (não comi hamburger)."
                 (Q→P)∧~R: "([Fui
                                   Se [fez sol],então [fui ao parque]


Conforme visto na teoria, se a questão quisesse a alternativa C seria necessário indicar os parênteses por
meio da vírgula destacada na proposição anterior.

Como essa vírgula não foi indicada, seguimos a ordem de precedência entre os conectivos, de modo que, em
"fui ao parque, pois [(fez sol) e (não comi hamburguer)]", a conjunção "(fez sol) e (não comi hamburguer)"
foi executada antes da condicional.

Gabarito: Letra D.

 (INÉDITA/2022) Julgue o item subsequente
Considere que as proposições P, Q e R são verdadeiras e que S e T são falsas. Nesse caso, a proposição
P∧~Q→RS∨~T é falsa.

Comentários:

Para resolver a questão, devemos utilizar a ordem de precedência da negação e dos conectivos. A ordem é
a seguinte:
...
Substituindo as proposições pelos seus respectivos valores lógicos, ficamos com:
...
Inicialmente, devemos realizar as negações abrangendo o menor enunciado possível. Nesse caso, ~V
corresponde a F e ~F corresponde a V. Ficamos com:

                                                  V∧F→VF∨V

Na sequência, executamos a conjunção V∧F, que corresponde a F. Ficamos com:

                                                    F→VF∨V

Depois, devemos realizar a disjunção inclusiva F∨V, que corresponde a V. Ficamos com:

                                                      F→VV

Na sequência, executamos a condicional F→V, que corresponde a V. Ficamos com:

                                                       VV

Note que temos uma bicondicional verdadeira, pois ambas as parcelas da bicondicional são iguais. Logo, a
proposição em questão é verdadeira. O gabarito, portanto, é errado.
...
Tabela-verdade
  ...
  (INÉDITA) Considere a proposição "Se Arnaldo é feliz ou Bernaldo não é contente, então Bernaldo é
contente e Cernaldo é serelepe". O número de linhas da tabela-verdade associada a essa proposição é:
a) 2
b) 4
c) 8
d) 16
...
Considere as proposições simples:
                                              ...
                                              b: "Bernaldo é contente."

                                              c: "Cernaldo é serelepe."

A proposição composta apresentada pode ser descrita por a∨~b → b∧c.

       a∨~b → b∧c: "Se [(Arnaldo é feliz) ou (Bernaldo não é contente)], então [(Bernaldo é contente) e
                                           (Cernaldo é serelepe)]."

Sabemos que se uma proposição for composta por 𝒏 proposições simples distintas, o número de linhas da
tabela-verdade será 𝟐𝒏 . Além disso, sabemos que a negação "~" não interfere no número de linhas da
tabela verdade.
Veja que temos três proposições simples distintas: a, b e c. Logo, o número de linhas da tabela-verdade é:
                                                        23 = 8
...
---
  ...
  (INÉDITA) Considere que P é uma proposição composta por 3 proposições simples distintas e que Q é
uma proposição composta pelas mesmas três proposições simples. Assim, o número de linhas da tabela-
verdade de PQ é:
a) 4
b) 8
c) 16
...
A questão quer analisar a tabela-verdade da bicondicional PQ, sendo P uma proposição composta formada
                                                       ==219a34==

por 3 proposições simples e Q uma proposição composta formada pelas mesmas 3 proposições simples.

Sabemos que se uma proposição for composta por 𝒏 proposições simples distintas, o número de linhas da
tabela-verdade será 𝟐𝒏 .

Note, portanto, que a análise da proposição PQ envolve um total de 𝒏 = 𝟑 proposições simples distintas.
Temos, portanto, um total de 2𝑛 = 23 = 𝟖 linhas na tabela-verdade.

Gabarito: Letra B.

  (INÉDITA) Considere a proposição composta (p∧q)→(rp), em que "p", "q" e "r" são proposições
simples. A proposição composta assume o valor lógico falso para:
a) Nenhuma linha da tabela-verdade.
b) Uma linha da tabela-verdade.
c) Duas linhas da tabela-verdade.
d) Três linhas da tabela-verdade.
e) Quatro linhas da tabela-verdade.

Comentários:

Vamos montar a tabela-verdade de (p∧q)→(rp).

Passo 1: determinar o número de linhas da tabela-verdade

Temos 𝑛 = 3 proposições simples. Logo, o número de linhas da tabela-verdade é 23 = 8.
...
Para obter (p∧q)→(rp), devemos determinar (p∧q) e (rp).

Para obter (p∧q), devemos determinar p e q.

Para obter (rp), devemos determinar r e p

Passo 4: obter o valor das demais proposições.

A conjunção p∧q é verdadeira somente quando as proposições simples p e q são ambas verdadeiras. Nos
demais casos, p∧q é falso.
...
A bicondicional rp é verdadeira somente quando r e p apresentam o mesmo valor lógico. Nos demais
casos, rp é falso.

Por fim, a condicional (p∧q)→(rp) é falsa somente quando (p∧q) é verdadeiro ao mesmo tempo em que
(rp) é falso. Nos demais casos, a condicional é verdadeira.

Note que a proposição composta assume o valor lógico falso para apenas uma linha da tabela-verdade. O
...
---
  ...
  (INÉDITA) A tabela a seguir indica o início da construção de uma tabela-verdade de uma proposição
composta que apresenta as proposições simples "p", "q" e "r".

Com base nessa tabela, assinale a alternativa que apresenta a última coluna da tabela-verdade referente
à proposição composta p(q→r), representada na horizontal de cima para baixo:
a) F / F / V / V / F / V / F / F.
b) V / F / V / F / F / V / F / F.
c) V / F / V / V / F / V / F / F.
d) V / F / V / V / F / V / V / F.
...
Passo 4: obter o valor das demais proposições.
A condicional q→r é falsa somente quando q é verdadeiro ao mesmo tempo em que r é falso. Nos demais
casos, a condicional q→r é verdadeira.

Por fim, a bicondicional p(q→r) é verdadeiro somente quando p e (q→r) apresentam o mesmo valor lógico.
Nos demais casos, a bicondicional é falsa.

Note que a última coluna da tabela-verdade, representada na horizontal, de cima para baixo, é
V / F / V / V / F / V / F / F. O gabarito, portanto, é letra C.
...
Tautologia, contradição e contingência
  ...
  (INÉDITA) Assinale a alternativa que apresenta uma tautologia.
a) Fui à praia e tomei chimarrão.
b) Fui à praia ou tomei chimarrão.
c) Fui à praia e não fui à praia.
d) Se fui à praia e não fui à praia, então tomei chimarrão.
e) Se tomei chimarrão, então fui à praia e não fui à praia.
...
Com base nessas proposições simples, vamos analisar as alternativas.

a) Fui à praia e tomei chimarrão. Contingência.

Temos a proposição composta p∧q. Trata-se de uma contingência, pois p∧q pode ser tanto verdadeiro
quanto falso.

b) Fui à praia ou tomei chimarrão. Contingência.

Temos a proposição composta p∨q. Trata-se de uma contingência, pois p∨q pode ser tanto verdadeiro
quanto falso.

c) Fui à praia e não fui à praia. Contradição.

Temos a proposição composta p∧~p. Conforme visto na teoria, trata-se de uma contradição, pois p∧q é
sempre falso.
...
d) Se fui à praia e não fui à praia, então tomei chimarrão. Tautologia. Esse é o gabarito.

Temos a proposição composta (p∧~p)→q. Sabemos da teoria que p∧~p é uma contradição, isto é, sempre
assume o valor falso. Logo, temos uma condicional em que o antecedente é sempre falso.
Consequentemente, temos uma condicional sempre verdadeira, pois para a condicional ser falsa devemos
ter o antecedente verdadeiro e o consequente falso (caso V→F).

Como temos uma condicional sempre verdadeira, estamos diante de uma tautologia. Esse fato pode ser
verificado também por tabela-verdade.

e) Se tomei chimarrão, então fui à praia e não fui à praia. Contingência.

Temos a proposição composta q→(p∧~p). Trata-se de uma contingência, pois pode assumir tanto o valor
verdadeiro quanto o valor falso.
...
Observe que temos apenas duas proposições simples e, portanto, uma tabela-verdade teria apenas
22 = 4 linhas. Vamos montá-la para resolver a questão.

Passo 1: determinar o número de linhas da tabela-verdade.

O número de linhas é 22 = 4.
...
Passos 2 e 3: desenhar o esquema da tabela-verdade e atribuir V ou F às proposições simples de maneira
alternada.

Para obter [P→Q][P∨(~Q)], precisamos determinar [P→Q] e [P∨(~Q)]
Para obter [P→Q], precisamos determinar P e Q.
Para obter [P∨(~Q)], precisamos determinar P e ~Q
Para obter ~Q, precisamos obter Q.

Passo 4: obter o valor das demais proposições.

~Q é obtido pela inversão do valor lógico de Q.

P→Q é falso somente quando P é verdadeiro e Q é falso. Nos demais casos, a condicional é verdadeira.

P∨~Q é falso somente quando P e ~Q são ambos falsos. Nos demais casos, P∨~Q é verdadeiro.
...
[P→Q][P∨(~Q)] é verdadeiro quando [P→Q] e [P∨(~Q)] apresentam o mesmo valor lógico. Nos demais
casos, a bicondicional é falsa.

Note que [P→Q][P∨(~Q)] não é sempre verdadeiro. Logo, não se trata de uma tautologia.
...
Considere as proposições simples:
                                           a: "Arnaldo é concurseiro."
                                           b: "Bernaldo é engenheiro."

Note que a proposição I pode ser descrita por a→(b∨a):

    a→(b∨a): Se [Arnaldo é concurseiro], então [(Bernaldo é engenheiro) ou (Arnaldo é concurseiro)].

Podemos mostrar que a proposição I é uma tautologia realizando a "prova por absurdo".

Vamos supor que a→(b∨a) é falsa. Nesse caso, o antecedente a é verdadeiro e o consequente (b∨a) é falso.
Note, porém, que para (b∨a) ser falso, b deve ser falso e a deve ser falso! Absurdo! Logo, não é possível que
a→(b∨a) seja falsa, de modo que ela é sempre verdadeira.
...
Agora vamos analisar a proposição II. Note que ela pode ser descrita por (a∨b)→b.

   (a∨b)→b: "Se [(Arnaldo é concurseiro) ou (Bernaldo é engenheiro)], então [Bernaldo é engenheiro]."

Note que a proposição II é uma contingência, pois ela pode ser tanto verdadeira quanto falsa:

   •   Se a e b forem verdadeiros, tanto o antecedente quanto o consequente de (a∨b)→b são verdadeiros
       e, portanto, temos um condicional verdadeiro;
   •   Se a for verdadeiro e b for falso, o antecedente é verdadeiro e o consequente é falso, de modo que
       (a∨b)→b é falso.
...
a) Marlene é médica e Olga não é oftalmologista.
b) Priscila é professora ou Marlene não é médica.
c) Se Priscila é professora, então Marlene não é médica.  ==219a34==
...
15.​ (FGV/PC RN/2021) Sabe-se que a sentença “Se a camisa é branca, então a calça é branca”
é FALSA e a sentença “Se o sapato é preto, então a camisa não é branca” é VERDADEIRA.
É correto concluir que:
a) a camisa é branca, a calça não é branca e o sapato não é preto;
b) a camisa é branca, a calça não é branca e o sapato é preto;
c) a camisa não é branca, a calça é branca e o sapato não é preto;
