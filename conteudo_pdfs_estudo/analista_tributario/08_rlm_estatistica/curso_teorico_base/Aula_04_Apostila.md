...
3) Questões Comentadas - Introdução à Lógica de Primeira Ordem - FGV


4) Aviso importante - Orientação de estudo


5) Questões Comentadas - Lógica de Primeira Ordem - Inéditas


6) Lista de Questões - Introdução à Lógica de Primeira Ordem - FGV


7) Lista de Questões - Lógica de Primeira Ordem - Inéditas
...
utilizaremos. Devemos, ao final desse capítulo, ser capazes de traduzir a notação simbólica que permeia a
LPO para o bom e velho português. Para começar, considere a seguinte sentença:
