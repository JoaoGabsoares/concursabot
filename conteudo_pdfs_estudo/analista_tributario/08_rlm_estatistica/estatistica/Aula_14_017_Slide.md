...
- estatistica
- inferencia
arquivo_origem: Aula 14_017_Slide.txt
...
QUESTÃO 1
Considere o modelo de série temporal AR(1) que tenha uma
perturbação com média zero e variância constante.
...
𝑦𝑡 = 200 + 𝜀𝑡 − 0,8𝜀𝑡−1 − 0,7𝜀𝑡−2 + 0,6𝜀𝑡−3
...
OPERADOR DE MÉDIAS MÓVEIS (MA)


𝜃 𝐵 = 1 + 𝜃1 𝐵 + 𝜃2 𝐵2 + ⋯ + 𝜃𝑞 𝐵𝑞
...
O Modelo MA será invertível, se e somente se o módulo das raízes
do operador foram maiores do que 1.
...
𝑦𝑡 = 𝜆 + 𝜙1 𝑦𝑡−1 + 𝜙2 𝑦𝑡−2 + ⋯ + 𝜙𝑝 𝑦𝑡−𝑝 + 𝜀𝑡 − 𝜃1 𝜀𝑡−1 − 𝜃2 𝜀𝑡−2 − ⋯ − 𝜃𝑞 𝜀𝑡−𝑞
...
MODELO ARMA
𝑦𝑡 = 10 + 0,8𝑦𝑡−1 + 𝜀𝑡 − 0,7𝜀𝑡−1 − 0,5𝜀𝑡−2
...
MODELO ARMA
𝑦𝑡 = 8 + 0,9𝑦𝑡−1 + 0,6𝑦𝑡−2 + 𝜀𝑡 − 0,3𝜀𝑡−1
...
𝑦𝑡 = 5 + 0,7𝑦𝑡−1 + 0,6𝑦𝑡−2 + 0,4𝑦𝑡−2 + 𝜀𝑡 − 0,5𝜀𝑡−1 − 0,1𝜀𝑡−2
...
𝑦𝑡 = 5 + 0,7𝑦𝑡−1 + 0,6𝑦𝑡−2 + 0,4𝑦𝑡−2 + 𝜀𝑡
...
MODELO     ESTACIONÁRIO                               INVERTÍVEL
...
Módulo das raízes > 1        Módulo das raízes > 1
...
MODELO ARIMA
É um modelo ARMA que precisou ser transformado em
estacionário.

SÉRIE INICIAL NÃO                                          SÉRIE INICIAL
...
MODELO ARIMA
 ...
 CARACTERÍSTICA     MODELO                                 d=0
Combinação de
termos anteriores

Combinação de
erros anteriores                                   ARIMA   d≠0
...
MEDE A DEPENDÊNCIA LINEAR ENTRE DOIS INSTANTES COM LAG
IGUAL A K.
...
GRÁFICO DA FAC DO MODELO AR

❑ Cai exponencialmente                          Senóides amortecidas
...
GRÁFICO DA FAC DO MODELO MA

❑ Zera abruptamente após a ordem q
...
---
 ...
 GRÁFICO AUTOCORRELAÇÃO PARCIAL AR
...
GRÁFICO AUTOCORRELAÇÃO PARCIAL MA
...
GRÁFICO AUTOCORRELAÇÃO PARCIAL ARMA
...
TABELA
MODELO           FAC                                        FACP
  AR   Decaimento exponencial
       Senóides amortecidas                              Corte brusco

  MA                                            Decaimento exponencial
              Corte brusco                      Senóides amortecidas

 ARMA    Decaimento exponencial Decaimento exponencial
         Senóides amortecidas   Senóides amortecidas
