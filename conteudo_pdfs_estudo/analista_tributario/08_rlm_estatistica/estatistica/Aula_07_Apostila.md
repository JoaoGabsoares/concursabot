...
7) Questões Comentadas - Probabilidade Conceitos Iniciais - FGV


8) Questões Comentadas - Definição Clássica de Probabilidade - FGV


9) Questões Comentadas - Combinações de Eventos e Probabilidade - FGV


10) Questões Comentadas - Axiomas de Probabilidade - FGV


11) Questões Comentadas - Probabilidade Condicional - FGV


12) Lista de Questões - Probabilidade Conceitos Iniciais FGV


13) Lista de Questões - Definição Clássica de Probabilidade - FGV


14) Lista de Questões - Combinações de Eventos e Probabilidade - FGV


15) Lista de Questões - Axiomas de Probabilidade - FGV


16) Lista de Questões - Probabilidade Condicional - FGV

                Receita Federal (Analista Tributário) Estatística                                                                                                                         2
                www.estrategiaconcursos.com.br                                                                                                                                          240
...
Assim, a interseção 𝑋 ∩ 𝐸 corresponde ao próprio evento X, logo:
        ...
        sabemos que ocorreu, permanece como evento a priori.
                                                            ...
                                                            1
        Para o nosso exemplo, temos 𝑃(𝐸 |𝐻 ) = 3. Então, dado que foi selecionado um homem, a
...
1.     (FGV/2025 – TCE/RR) Uma caixa contém nove cartões com as nove letras da palavra MARAVILHA.
Cada cartão apresenta uma das letras (a letra A é a única que aparece repetida; há três cartões com a letra
A). Retiram-se aleatoriamente, em sequência e sem reposição, dois cartões da caixa.
...
Vamos calcular essa probabilidade pela razão entre o número de casos favoráveis e o número total de casos
possíveis.
Para retirar duas vogais diferentes, precisamos retirar um "A" e um "I". Como há 3 cartões com a letra A, há
3 possibilidades de isso ocorrer:
                                               𝑛(𝑐𝑎𝑠𝑜𝑠 𝑓𝑎𝑣𝑜𝑟á𝑣𝑒𝑖𝑠) = 3
E o número total de casos possíveis corresponde à retirada de quaisquer 2 cartões, dentre 9. Como a ordem
não importa, temos a combinação de 9 escolhe 2:
                                                             9!         9 × 8 × 7!
                    𝑛(𝑐𝑎𝑠𝑜𝑠 𝑝𝑜𝑠𝑠í𝑣𝑒𝑖𝑠) = 𝐶9,2 =                       =            = 9 × 4 = 36
                                                        (9 − 2)! × 2!     7! × 2
...
2.    (FGV/2025 – TRT-24ª Região) Seis homens e oito mulheres estão reunidos. Uma comissão de três
pessoas será formada, entre essas pessoas, para compor um grupo de trabalho.
...
A probabilidade é a razão entre o número de casos favoráveis e o número total de casos possíveis:
                                               ...
                                               𝑃=
                                                       𝑛(𝑡𝑜𝑡𝑎𝑙 𝑑𝑒 𝑐𝑎𝑠𝑜)
Em relação aos casos possíveis, temos a seleção de 3 pessoas quaisquer para formar a comissão, dentre
todas as 14 pessoas (6 homens + 8 mulheres). Como a ordem dessa escolha não importa, utilizamos a
combinação:
                                            14!         14 × 13 × 12 × 11! 14 × 13 × 12
   𝑛(𝑡𝑜𝑡𝑎𝑙 𝑑𝑒 𝑐𝑎𝑠𝑜𝑠) = 𝐶14,3 =                        =                   =             = 14 × 13 × 2
                                       (14 − 3)! × 3!        11! × 3!         3×2
Em relação aos casos favoráveis, precisamos selecionar 2 mulheres, dentre 8:
                                                    8!         8 × 7 × 6!
                                      𝐶8,2 =                 =            =4×7
                                               (8 − 2)! × 2!     6! × 2
Também precisamos selecionar um dos 6 homens. Considerando o princípio multiplicativo, o número de
casos favoráveis é:
                                    𝑛(𝑐𝑎𝑠𝑜𝑠 𝑓𝑎𝑣𝑜𝑟á𝑣𝑒𝑖𝑠) = 𝐶8,2 × 6 = 4 × 7 × 6
E a probabilidade é:
                                                        4×7×6       6
                                                 𝑃=               =
                                                       14 × 13 × 2 13
...
3.     (FGV/2024 – Pref. São José dos Campos) Em uma urna, há 6 bolas: 2 brancas, 2 vermelhas e 2 azuis.
A probabilidade de qualquer uma das bolas ser sorteada aleatoriamente é a mesma. Antônia sorteia, em
sequência e aleatoriamente, 2 bolas da urna. A seguir, Beatriz também sorteia, em sequência e
aleatoriamente, 2 bolas das 4 que restaram da urna. Finalmente, Carla retira da urna as 2 bolas que
sobraram.
...
A probabilidade é a razão entre o número de eventos favoráveis e o número total de eventos possíveis.
Em relação ao total de eventos possíveis, temos uma partição de 𝑁 = 6 bolas para 3 pessoas diferentes
(partição ordenada)1, de modo que cada pessoa fica com 2 bolas (𝑛1 = 𝑛2 = 𝑛3 = 2):
...
1
 Temos uma partição quando dividimos os elementos originais (no caso, as 6 bolas) em grupos, sem sobras. A partição ordenada
ocorre quando esses grupos são diferentes, que é o caso, já que as pessoas são diferentes.
O resultado da partição pode ser obtido por sucessivas combinações. Primeiro, temos o sorteio das bolas da Antônia, isto é, uma
combinação de 2 bolas, dentre 6:
                                                          6!         6 × 5 × 4!
                                            𝐶6,2 =                 =            = 15
                                                     (6 − 2)! × 2!     4! × 2
Em seguida, temos o sorteio das bolas de Beatriz, isto é, uma combinação de 2 bolas, dentre 4:
                                                          4!         4 × 3 × 2!
                                            𝐶4,2 =                 =            =6
                                                     (4 − 2)! × 2!     2! × 2
E Carla ficará com as 2 bolas que restaram, o que corresponde a uma única possibilidade.
E o número de maneiras de esses sorteios ocorrerem corresponde ao produto:
                                                       𝑛(𝑈) = 15 × 6 = 90
Que é o mesmo resultado que obtemos, quando aplicamos a fórmula da partição.
...
Em relação aos eventos favoráveis, Carla precisa retirar bolas da mesma cor. Vamos primeiro escolher uma
cor específica, por exemplo, bolas brancas. Para isso ocorrer, as outras 4 bolas precisam ser particionadas
entre Antônia e Beatriz2:

                                            4     4!     4×3×2
                                          (   )=       =       =3×2 =6
                                           2,2   2! 2!    2×2

Se as bolas de Carla forem vermelhas ou azuis, o número de maneiras de distribuir as demais bolas entre
Antônia e Beatriz é o mesmo, logo, precisamos multiplicar esse resultado por 3, pois há 3 possibilidades de
cores para as bolas de Carla:
                                                       𝑛(𝐴) = 3 × 6 = 18
...
4.     (FGV/2023 – TJ/SE) Joaquim jogou um dado de seis faces, não viciado, por duas vezes, uma após a
...
Vamos pensar nos possíveis cenários para resolver essa questão.
Se o resultado do primeiro lançamento for igual a 1, o resultado do segundo lançamento pode ser qualquer
uma das faces de 2 a 6 (5 possibilidades). Se o resultado do primeiro lançamento for igual a 2, o resultado do

2
    Aqui, podemos pensar que Antônia precisa sortear 2 bolas dentre as 4 (combinação de 4 escolhe 2):
                                                            4!         4 × 3 × 2!
                                              𝐶4,2 =                 =            =6
                                                       (4 − 2)! × 2!     2! × 2
Em seguida, Beatriz ficará com as 2 bolas restantes, o que corresponde a uma única possibilidade.
...
segundo pode ser as faces 3 a 6 (4 possibilidades). E assim seguimos, diminuindo uma possibilidade, até que
a face 6 seja a única possibilidade. Assim, o número de casos favoráveis é:
                                           𝑛(𝐴) = 5 + 4 + 3 + 2 + 1 = 15
...
5.    (FGV/2023 – RFB) Uma equipe de trabalho reúne 4 auditores e 6 analistas. Se três pessoas dessa
...
6.     (FGV/2022 – MPE/SC) Há evidências de que uma alta pressão sanguínea esteja associada a um
...
7.     (FGV/2022 – PC/RJ) Treze cadeiras numeradas consecutivamente de 1 a 13 formam uma fila.
...
8.     (FGV/2022 – PM/AM) Em uma fila com 12 cadeiras, três delas foram ocupadas aleatoriamente. A
...
9.     (FGV/2022 – SEMSA Manaus) Lançamos ao acaso dois dados não viciados no chão. Se S é a soma
...
10.    (FGV/2022 – TRT/MA) Dois dados serão lançados aleatoriamente sobre uma mesa e os números
...
11.   (FGV/2022 – TRT/PB) Se escolhemos ao acaso um número de três algarismos, a probabilidade de
...
12.    (FGV/2022 – CBM/RJ) Solange e Marcelo fazem parte de um grupo de 10 pessoas. Sorteiam-se duas
...
13.    (FGV/2022 – CM Taubaté) Em uma urna há 6 bolas numeradas. Retira-se da urna, aleatoriamente,
...
14.    (FGV/2022 – Câmara de Taubaté/SP) Dois números diferentes serão sorteados, aleatoriamente,
...
15.    (FGV/2022 – TCE/TO) Em um saco há 9 bolinhas iguais, numeradas de 1 a 9. Duas bolinhas são
...
16.   (FGV/2022 – TRT/PB) Numa empresa há seis gerentes e quatro superintendentes. Se quatro dessas
...
17.    (FGV/2022 – SEFAZ/AM) Em uma urna há 5 bolas iguais, cada uma com uma letra da sigla SEFAZ.
...
18.    (FGV/2022 – CBM/AM) Uma caixa contém 4 bolas numeradas 1, 2, 3 e 4. Selecionam-se, ao acaso,
...
19.   (FGV/2022 – PM/AM) O soldado Garcia vai liderar uma equipe de 3 soldados (ele incluído) para
...
20.   (FGV/2022 – PC/AM) Um dado comum, com as faces numeradas de 1 a 6, é lançado 3 vezes. A
...
21.    (FGV/2022 – SSP/AM) Duas urnas A e B têm, cada uma, 26 bolinhas. Em cada urna, cada bolinha
...
mutuamente excludentes (um OU outro), devemos somar essas possibilidades (princípio aditivo):
                                                 𝑛(𝐴) = 25 + 24 + ⋯ + 1
Reorganizando os termos, de 1 a 25, temos uma Progressão Aritmética (PA) com termo inicial A 1 = 1, termo
...
22.    (FGV/2022 – SEMSA Manaus) Numa vila moram 20 pessoas, das quais 5 são crianças. Se sortearmos
...
O enunciado informa que 5 pessoas serão selecionadas, dentre 20, das quais 5 são crianças.
A probabilidade de selecionar 3 crianças é a razão entre o número de maneiras de isso ocorrer (casos
favoráveis) e o número total de maneiras de selecionar 5 pessoas quaisquer (total de casos possíveis):
                                                               𝑛(𝐹)
                                                         𝑃=
                                                               𝑛(𝑈)
...
23.    (FGV/2022 – TJDFT) Um analista realiza três plantões noturnos por semana durante um mês. O
...
24.    (FGV/2021 – IMBEL) Quatro pessoas estão sentadas em volta de uma mesa circular. Cada uma delas
...
25.    (FGV/2021 – BANESTES) Marcelo joga, simultaneamente, dois dados cúbicos honestos cujas faces
...
26.    (FGV/2021 – Paulínia) Em uma caixa há 2 bolas brancas e 4 bolas pretas. Retirando, ao acaso 2
...
27.    (FGV/2021 – PM/PB) Considere o conjunto {−3; −2; −1; 0; 1; 2; 3}. Sorteiam-se, aleatoriamente sem
...
28.     (FGV/2021 – TJ/RO) As amigas Alice e Bianca estão entre as 6 pessoas classificadas em um concurso
...
29.   (FGV/2019 – Prefeitura de Angra dos Reis/RJ) Uma pesquisa feita com os alunos de uma sala
...
30.    (FGV/2019 – MP/RJ) Entre as pessoas A, B, C, D, E, duas delas serão escolhidas por sorteio para
...
dentre as possibilidades, restando apenas 4 possibilidades (A, B, C ou E) para satisfazer o diretor. Agora,
basta encontrarmos o número de maneiras de escolher A ou B dentre essas 4 possibilidades. Para isso,
podemos calcular a diferença entre o total de maneiras de escolher 2 pessoas dentre as 4 possibilidades, e
o número de maneiras de não escolher A ou B (isto é, não escolher A e não escolher B).
...
31.   (FGV/2018 – SASDH/RJ) Um dado é lançado duas vezes consecutivas. Considere os seguintes
...
32.    (FGV/2018 – ALE/RO) Em um grupo de 10 deputados, 6 são do Partido A e 4 são do Partido B. Serão
...
33.     (FGV/2018 – SEPLAG/RJ) Considere todas as senhas formadas por três vogais maiúsculas. São
...
34.    (FGV/2018 – ALE/RO) Em uma caixa há 4 cartões amarelos e 6 cartões vermelhos. Foram retirados,
...
35.    (FGV/2018 – ALE/RO) Uma urna contém 10 bolas numeradas de 1 a 10. Três dessas bolas são
...
36.    (FGV/2017 – SEPOG/RO) Para uma premiação, dois funcionários de uma empresa serão sorteados
...
37.    (FGV/2017 – SEFIN/RO) Em cada uma de duas urnas há três bolas: uma vermelha, uma rosa e uma
...
38.     (FGV/2017 – MPE/BA) O Supremo Tribunal Federal é composto por 11 Ministros, sendo um
...
39.     (FGV/2016 – SME – São Paulo/SP) Um jogo de dados tem por objetivo obter as somas de 1 a 9,
...
Logo, há 5 possibilidades, cuja probabilidade é:
                                                            ...
                                                            𝑃=
                                                                 36
                                        1    𝟔
Essa probabilidade é menor do que 6 = 36, que é a probabilidade de obter o resultado 3 com um dado. Logo,
a alternativa A está incorreta e a alternativa E está correta. Em relação à alternativa B, as possibilidades de
se obter 5 com dois dados são:
                                                 {(1,4), (2,3), (3,2), (4,1)}
...
a alternativa B está incorreta. Em relação à alternativa C, as possibilidades de se obter 8 com dois dados são:
                                            {(2,6), (3,5), (4,4), (5,3), (6,2)}
Logo, há 5 possibilidades, cuja probabilidade é:
                                                                  5
                                                            𝑃=
                                                                 36
Portanto, a alternativa C está incorreta. Em relação à alternativa D, as possibilidades de se obter 7 com dois
dados são:
...
40.    (FGV/2016 – MPE/RJ) A figura abaixo mostra uma mesa retangular com 5 cadeiras representadas
...
41.    (FGV/2015 – Prefeitura de Niterói/RJ) O quadro a seguir mostra a distribuição das idades dos
...
1.       (FGV/2023 – Pref. SP) Em um saco, há 50 bolinhas iguais numeradas de 1 até 50.

Retirando uma delas ao acaso, a probabilidade de que seu número não seja nem par nem múltiplo de 3 é
igual a
...
Precisamos calcular a probabilidade de o número não ser par e não ser múltiplo de 3, que corresponde ao
complementar da união:
                                  𝑃(𝑝𝑎𝑟
                                    ̅̅̅̅̅ ∩ ̅̅̅̅)  ̅̅̅̅̅̅̅̅̅̅̅̅
                                            𝑚3 = 𝑃(𝑝𝑎𝑟   ∪ 𝑚3 ) = 1 − 𝑃(𝑝𝑎𝑟 ∪ 𝑚3 )
Por sua vez, a probabilidade da união é dada por:
                                  𝑃(𝑝𝑎𝑟 ∪ 𝑚3 ) = 𝑃(𝑝𝑎𝑟) + 𝑃(𝑚3 ) − 𝑃(𝑝𝑎𝑟 ∩ 𝑚3 )
Metade das bolinhas de 1 a 50 são pares, logo:
                                                                    25
                                                        𝑃(𝑝𝑎𝑟) =
                                                                    50
Para calcular a quantidade de múltiplos de 3, dividimos o número de bolinhas por 3 e consideramos o valor
        50
inteiro 3 = 16,3 … Assim, há 16 bolinhas múltiplas de 3:
                                                                    16
                                                         𝑃(𝑚3 ) =
                                                                    50
Dentre os múltiplos de 3, metade é par. Logo, das 16 bolinhas múltiplas de 3, 8 são pares:
                                                                          8
                                                     𝑃(𝑝𝑎𝑟 ∩ 𝑚3 ) =
                                                                         50
Portanto, a probabilidade da união é:
...
2.       (FGV/2023 – AGENERSA) Em uma caixa há 5 cartas e cada uma delas contém um dos números: 1, 3,
4, 5, 8. Não aparece o mesmo número em duas cartas. Duas cartas são retiradas da caixa ao acaso.
...
3.    (FGV/2022 – PC/AM) Considere dois eventos A e B mutuamente exclusivos e que Prob(.) indica a
...
4.      (FGV/2022 – SSP/AM) Seis cartas estão em uma caixa; em cada uma delas está escrita uma das seis
...
5.     (FGV/2022 – SEMSA Manaus) Suponha que um professor decida escolher aleatoriamente um
...
6.     (FGV/2022 – TRT/PB) Se A, B e C são eventos tais que P[A] = 0,4, P[B] = 0,5 e P[C] = 0,6, então os
...
7.    (FGV/2021 – CREAS) Gabi e Luana têm, cada uma delas, 3 bolas coloridas: uma branca, uma azul e
...
8.     (FGV/2017 – Prefeitura de Salvador/BA) Entre as pessoas A, B, C, D e E, será sorteada uma comissão
...
9.    (FGV/2017 – SEFIN-RO) Dois eventos A e B têm probabilidades iguais a 70% e 80%. Os valores
...
1.    (FGV/2025 – SEEC/RN) Em um jogo, só existe a possibilidade de serem sorteados 3 números: 2, 3 e
4. A probabilidade de que cada um desses números seja o resultado do sorteio é inversamente
proporcional ao quadrado do próprio número. Sorteando-se um desses números aleatoriamente, a
probabilidade de que tal número seja par é
...
O enunciado informa que a probabilidade de cada resultado é proporcional ao inverso do quadrado do
número, ou seja, a probabilidade de sair o número 2 é proporcional a 1/22 , a de sair o número 3 é
proporcional a 1/32 e a de sair o número 4 é proporcional a 1/42 . Vamos considerar que esses fatores
multiplicados por 𝑥 são iguais às respectivas probabilidades.
Sabendo que a soma das probabilidades é igual a 1, temos:
                                                 𝑃(2) + 𝑃(3) + 𝑃(4) = 1
                                             𝑥    𝑥    𝑥   𝑥 𝑥 𝑥
                                              2
                                                + 2+ 2= + +          =1
                                             2    3   4    4 9 16
                                               36𝑥 + 16𝑥 + 9𝑥 61𝑥
                                                    ...
                                                    144         144
                                                       ...
                                                       𝑥=
                                                            61
A probabilidade de sortear um número par pode ser calculada pela probabilidade complementar, que
...
2.     (FGV/2017 – SEFIN-RO) Júlia e Laura são irmãs e fazem parte de um grupo de 5 meninas. Desse
grupo, três serão sorteadas para um passeio. A probabilidade de que uma das irmãs seja sorteada e a outra
não seja sorteada é de.
...
1.     (FGV/2025 – PC-MG) Um perito criminal está investigando o furto, sem arrombamento, do
conteúdo em um cofre que bloqueia automaticamente a sua abertura após três tentativas incorretas e
consecutivas de se digitar a senha. A perícia indica que o suspeito tinha um conjunto de 10 sequências
possíveis de dígitos no momento do sinistro, sendo apenas uma a senha correta. O perito supõe que o
suspeito não tinha qualquer preferência entre as sequências que detinha e, por essa razão, todas teriam a
mesma probabilidade de serem escolhidas. Com base nessas informações e sabendo-se que uma
sequência, uma vez utilizada, foi descartada de novas escolhas, antes de o suspeito fazer qualquer
tentativa, a probabilidade de ele conseguir abrir o cofre, antes do bloqueio, por meio da senha correta era
...
Para abrir o cofre antes do bloqueio, o suspeito precisa acertar a senha na 1ª, na 2ª ou na 3ª tentativa.
Sabendo que ele tem 10 sequências possíveis a serem testadas, sendo uma delas a senha correta, a
probabilidade de ele acertar na 1ª tentativa é:
                                                                   1
                                                           𝑃1 =
                                                                  10
Para acertar na 2ª tentativa, o suspeito precisa errar na 1ª tentativa (9 possibilidades, dentre 10) e acertar
na 2ª, sabendo que restarão 9 sequências possíveis de serem testadas. A probabilidade de isso ocorrer é:
                                                               9 1  1
                                                    𝑃2 =        × =
                                                              10 9 10
Para acertar na 3ª tentativa, o suspeito precisa errar na 1ª tentativa (9 possibilidades, dentre 10), errar na 2ª
tentativa (8 possibilidades, dentre 9) e acertar na 3ª tentativa (1 possibilidade, dentre 8):
                                                          9 8 1  1
                                                  𝑃3 =     × × =
                                                         10 9 8 10
Considerando que esses eventos são mutuamente excludentes, a probabilidade de um desses eventos
ocorrer (união) é a soma das probabilidades:
                                                               1   1   1   3
                                  𝑃 = 𝑃1 + 𝑃2 + 𝑃3 =             +   +   =   = 30%
                                                              10 10 10 10
Gabarito: D
...
2.    (FGV/2025 – CGM-Cuiabá) Uma roleta apresenta todos os números inteiros desde o zero até o 36.
Cada número figura em uma célula distinta e cada célula possui cor única.

Estão em células pretas os seguintes números: {2, 4, 6, 8, 10, 11, 13, 15, 17, 20, 22, 24, 26, 28, 29, 31, 33,
35}.

Estão em células vermelhas os seguintes números: {1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34,
36}.

O número zero é o único a figurar em uma célula verde.

Sorteando-se, ao acaso, um desses números, a probabilidade de que o número esteja em uma célula
vermelha, dado que ele é múltiplo de 5 é
...
A probabilidade condicional de o número estar em uma célula, dado que é múltiplo de 5, é igual à
probabilidade da interseção (estar em uma célula vermelha E ser múltiplo de 5), dividida pela probabilidade
do evento a priori (ser múltiplo de 5).
                                                             𝑃(𝑉 ∩ 𝑀5 )
                                                𝑃(𝑉|𝑀5 ) =
                                                               𝑃(𝑀5 )
Considerando que o Espaço Amostral é o mesmo para as duas probabilidades, temos:
                                                             𝑛(𝑉 ∩ 𝑀5 )
                                                𝑃(𝑉|𝑀5 ) =
                                                               𝑛(𝑀5 )
Os múltiplos de 5 entre 0 e 36 são {0, 5, 10, 15, 20, 25, 30 e 35}, ou seja, há 8 múltiplos de 5.
Pelos dados fornecidos, os múltiplos de 5 que estão em células vermelhas são {5, 25 e 30}, ou seja, há 3
elementos nessas condições. Logo, a probabilidade é:
                                                                   3
                                                      𝑃(𝑉|𝑀5 ) =
                                                                   8
Gabarito: C
...
3.     (FGV/2025 – TCE/RR) Um experimento consiste em lançar dois dados honestos (não viciados)
simultaneamente e observar o resultado da soma de seus valores. Considere os seguintes eventos:
...
1. Qual a probabilidade do evento A?

2. Qual a probabilidade do evento B?

3. Sabendo que A ocorreu, qual é a probabilidade do evento B?
...
O enunciado informa que serão lançados 2 dados não viciados. O evento A corresponde a uma soma par.
Sabendo que há a mesma quantidade de números pares e ímpares, então metade dos totais será par e
metade ímpar, logo:
                                                                1
                                                       𝑃(𝐴) =
                                                                2
O evento B corresponde a uma soma maior que 8, ou seja, a uma soma igual a 9, 10, 11 ou 12.
Para que a soma seja igual a 9, as possibilidades são {(3 e 6), (4 e 5), (5 e 4), (6 e 3)}. Sabendo que há 36
resultados possíveis, a probabilidade de ocorrer um desses 4 é:
                                                                     4
                                                    𝑃(𝑆 = 9) =
                                                                    36
Para que a soma seja igual a 10, as possibilidades são {(4 e 6), (5 e 5), (6 e 4)}. A probabilidade de ocorrer um
desses 3 resultados é:
                                                                     3
                                                   𝑃(𝑆 = 10) =
                                                                    36
Para que a soma seja igual a 11, as possibilidades são {(5 e 6), (6 e 5)}. A probabilidade de ocorrer um desses
2 resultados é:
...
---
  ...
  Aula 06
                                                   ...
                                                   𝑃(𝑆 = 11) =
                                                                 36
Para que a soma seja igual a 12, a possibilidade é {(6 e 6)}, cuja probabilidade é:
                                                                  1
                                                   𝑃(𝑆 = 12) =
                                                                 36
O evento B corresponde à união de todos esses eventos. Como eles são mutuamente excludentes, a
probabilidade da união corresponde à soma:
                                                                               4 + 3 + 2 + 1 10   5
            𝑃(𝐵) = 𝑃(𝑆 = 9) + 𝑃(𝑆 = 10) + 𝑃(𝑆 = 11) + 𝑃(𝑆 = 12) =                           =   =
                                                                                    36        36 18
Em relação à 3ª pergunta, a probabilidade condicional de ocorrer o evento B dado que ocorreu o evento A é
igual à probabilidade da interseção dividida pela probabilidade do evento A:
                                                             𝑃(𝐵 ∩ 𝐴)
                                                 𝑃(𝐵|𝐴) =
                                                               𝑃(𝐴)
A interseção (ser par E maior que 8) ocorre quando a soma é igual a 10 ou 12. A sua probabilidade é a soma:
                                                                           3+1    4   1
                            𝑃(𝐵 ∩ 𝐴) = 𝑃(𝑆 = 10) + 𝑃(𝑆 = 12) =                 =    =
                                                                            36   36 9
                        1
Sabendo que 𝑃(𝐴) = 2, a probabilidade condicional é:
...
4.    (FGV/2025 – TCE/RR) Em uma fábrica, 30% dos funcionários pertencem ao turno da manhã e os
demais pertencem ao turno da tarde. Sabe-se que:

   •   a probabilidade de um funcionário usar transporte público dado que ele pertence ao turno da
       manhã é igual a 0,6.
   •   a probabilidade de um funcionário usar transporte público dado que ele pertence ao turno da tarde
       é igual a 0,6.
...
2. Qual a probabilidade de um funcionário pertencer ao turno da manhã, dado que ele usa transporte
público?
...
O enunciado informa que a probabilidade de um funcionário usar transporte público é igual a 0,6, que é a
mesma probabilidade de ele usar transporte público, dado que é do turno da manhã e dado que é do turno
da tarde:
                                           𝑃(𝑇𝑃|𝑀) = 𝑃(𝑇𝑃|𝑇) = 𝑃(𝑇𝑃)
Como a probabilidade condicionada é igual à probabilidade não condicionada, podemos concluir que esses
eventos são independentes.
Em relação à pergunta 2, a probabilidade de um funcionário pertencer ao turno da manhã, dado que ele usa
transporte público, é igual à probabilidade não condicionada de ele pertencer ao turno da manhã, uma vez
que os eventos são independentes:
                                              𝑃(𝑀|𝑇𝑃) = 𝑃(𝑀) = 30%
Gabarito: B

5.     (FGV/2025 – TCE/RR) Para escapar do rebaixamento em um campeonato de futebol, o time F
precisa ganhar pelo menos um dos dois jogos restantes do campeonato.

Baseado no histórico desse time no campeonato, estima-se que a probabilidade de ele ganhar um jogo,
dado que ele ganhou o jogo anterior, é de 50%, e que a probabilidade de ele ganhar um jogo, dado que
ele não ganhou o jogo anterior, é de 30%.
...
Para que o time F não seja rebaixado, é necessário que ele ganhe pelo menos um de 2 jogos. Vamos calcular
essa probabilidade pelo seu complementar, qual seja, de ele não ganhar ambos os jogos.
Sabendo que a probabilidade de um time ganhar um jogo, dado que ele não ganhou o anterior é igual a 30%,
então a probabilidade de ele não ganhar um jogo, dado que ele não ganhou o anterior é complementar:
                              𝑃(𝑃𝑒𝑟𝑑𝑒𝑟|𝑃𝑒𝑟𝑑𝑒𝑢 𝑎𝑛𝑡𝑒𝑟𝑖𝑜𝑟) = 100% − 30% = 70%
Sabendo que o time vem de uma derrota, a probabilidade de ele não ganhar o primeiro dos 2 jogos restantes
é igual a 70% (0,7). E, sabendo que ele não ganhou o primeiro jogo, a probabilidade de ele não ganhar o
segundo jogo é também igual a 70% (0,7). Portanto, a probabilidade de o time F ser rebaixado é o produto:
                                          𝑃(𝑟𝑒𝑏𝑎𝑖𝑥𝑎𝑑𝑜) = 0,7 × 0,7 = 0,49
E a probabilidade de o time não ser rebaixado é complementar:
                                   𝑃(𝑛ã𝑜 𝑟𝑒𝑏𝑎𝑖𝑥𝑎𝑑𝑜) = 1 − 0,49 = 0,51 = 51%
Gabarito: A

6.     (FGV/2025 – TCE/RR) Uma caixa contém nove cartões com as nove letras da palavra MARAVILHA.
Cada cartão apresenta uma das letras (a letra A é a única que aparece repetida; há três cartões com a letra
A). Retiram-se aleatoriamente, em sequência e sem reposição, dois cartões da caixa.
...
Vamos calcular essa probabilidade pensando nos cartões retirados sequencialmente. Para retirar duas vogais
diferentes, precisamos retirar um "A" e um "I".
Como há 3 cartões com a letra A, dentre 9 no total, a probabilidade de retirar um "A" na primeira extração
é 3/9. E a probabilidade de retirar um "I" na segunda extração, sabendo que há 1 cartão "I", dentre os 8 que
sobraram, é 1/8. E a probabilidade da interseção (um "A" primeiro E um "I" depois) é igual ao produto:
                                                              3 1  1
                                                  𝑃(𝐴, 𝐼) =    × =
                                                              9 8 24
Mas podemos retirar um "I" primeiro, cuja probabilidade é 1/9, e depois um "A", cuja probabilidade é 3/8.
A probabilidade desse cenário é:
...
---
  ...
  Aula 06
                                                  ...
                                                  𝑃(𝐼, 𝐴) =    × =
                                                              9 8 24
Retirar um "A" e um "I" em qualquer ordem corresponde à união desses eventos. Como são mutuamente
exclusivos, a probabilidade corresponde à soma:
                                                     1   1   2
                                               𝑃=      +   =   = 1/12
                                                    24 24 24
Gabarito: E

7.     (FGV/2025 – PC/MG) Uma delegacia recebeu, no mês de dezembro de 2024, denúncias
relacionadas a três tipos de crimes: roubo, fraude eletrônica e tráfico de drogas. Após uma triagem,
constatou-se que:
...
Essa questão trabalha com o teorema de Bayes, porque fornece dados que nos permitem calcular a
probabilidade de uma denúncia ser procedente, dado que é contra roubo, mas pede a probabilidade de uma
denúncia ser contra roubo, dado que é procedente, ou seja, ela inverte os eventos a priori e a posteriori.
Essa probabilidade é dada por:
                            𝑃(𝑅 ∩ 𝑃𝑟)                    𝑃(𝑃𝑟|𝑅) × 𝑃(𝑅)
              𝑃(𝑅|𝑃𝑟) =               =
                              𝑃(𝑃𝑟)     𝑃(𝑃𝑟|𝑅) × 𝑃(𝑅) + 𝑃(𝑃𝑟|𝐹) × 𝑃(𝐹) + 𝑃(𝑃𝑟|𝐷) × 𝑃(𝐷)
O enunciado informa que:
   •     44% das denúncias são sobre roubo, ou seja, 𝑃(𝑅) = 0,44;
   •     36% das denúncias são fraudes eletrônicas, ou seja, 𝑃(𝐹) = 0,36;
...
---
     ...
     Aula 06
      ...
      •   20% das denúncias são sobre tráfico de drogas, ou seja, 𝑃(𝐷) = 0,2;
      •   30% das denúncias contra fraudes são improcedentes, portanto, 70% são procedentes, ou seja,
          𝑃(𝑃𝑟|𝐹) = 0,7;
      •   10% das denúncias contra roubo são improcedentes, portanto, 90% são procedentes, ou seja,
          𝑃(𝑃𝑟|𝑅) = 0,9;
      •   20% das denúncias contra tráfico de drogas são improcedentes, portanto, 80% são procedentes, ou
          seja, 𝑃(𝑃𝑟|𝐷) = 0,8.
Substituindo esses dados na fórmula de Bayes, temos:
                                  0,9 × 0,44                     0,396          0,396
      𝑃(𝑅|𝑃𝑟) =                                          =                    =       ≅ 0,49 = 49%
                      0,9 × 0,44 + 0,7 × 0,36 + 0,8 × 0,2 0,396 + 0,252 + 0,16 0,808
Gabarito: B

8.        (FGV/2025 – TCE/RR) Considere as seguintes afirmações sobre probabilidade e seus axiomas:

I. A probabilidade do espaço amostral S é igual a 1, ou seja, P(S) = 1.

II. Se dois eventos A e B são mutuamente exclusivos, então a probabilidade de sua união é dada por
P(A∪B)=P(A)+P(B).

III. Se A e B são quaisquer eventos no espaço amostral, então P(Ac) = 1 − P(A), em que Ac é o complementar
de A.
...
Vamos analisar as afirmativas. Em relação à primeira, a probabilidade associada a todo o Espaço Amostral é,
de fato, igual a 1. Logo, a afirmativa I está correta.
Em relação à segunda, a probabilidade da união de 2 eventos A e B quaisquer é:
                                         𝑃(𝐴 ∪ 𝐵) = 𝑃(𝐴) + 𝑃(𝐵) − 𝑃(𝐴 ∩ 𝐵)
...
Se A e B forem mutuamente exclusivos, a probabilidade da interseção é nula, logo, a probabilidade da união
é igual à soma das probabilidades:
                                                 𝑃(𝐴 ∪ 𝐵) = 𝑃(𝐴) + 𝑃(𝐵)
Portanto, a afirmativa II está correta.
Em relação à terceira, a probabilidade do evento complementar é igual a 1 menos a probabilidade do evento:
                                                     𝑃(𝐴𝑐 ) = 1 − 𝑃(𝐴)
Logo, a afirmativa III está correta.
Em relação à quarta, se A e B forem independentes, então a probabilidade da interseção é igual ao produto
das probabilidades. A probabilidade da interseção é nula para eventos mutuamente excludentes. Logo, a
afirmativa IV está errada.
Gabarito: A

9.      (FGV/2025 – TCE/RR) Considere dois eventos A e B em um espaço amostral S. Sobre esses eventos,
...
Vamos analisar as afirmativas. Em relação à primeira, se dois eventos são independentes, então a
probabilidade da interseção é igual ao produto das probabilidades. E vice-versa! Se a probabilidade da
interseção de 2 eventos é igual ao produto das probabilidades, podemos concluir que os eventos são
independentes. Portanto, a afirmativa I está correta.
...
Em relação à segunda, para eventos independentes, a probabilidade condicionada é igual à não
condicionada. Portanto, se 𝑃(𝐴|𝐵) = 𝑃(𝐴), podemos concluir que A e B são independentes. Logo, a
afirmativa II está correta.
Em relação à terceira, a probabilidade condicional de A dado B é igual à probabilidade da interseção dividida
pela probabilidade do evento a priori (B):
                                                               𝑃(𝐴 ∩ 𝐵)
                                                    𝑃(𝐴|𝐵) =
                                                                 𝑃(𝐵)
Isso vale sempre que 𝑃(𝐵) > 0, porque para 𝑃(𝐵) = 0, a razão se torna infinita. Logo, a afirmativa III está
correta.
Em relação à quarta, para eventos mutuamente exclusivos, a probabilidade da interseção é nula, logo a
probabilidade condicional também é:
                                                         𝑃(𝐴 ∩ 𝐵)    0
                                            𝑃(𝐴|𝐵) =              =      =0
                                                           𝑃(𝐵)     𝑃(𝐵)
De fato, se ocorreu um dos eventos, o outro não pode ocorrer. Portanto, a afirmativa IV está correta.
Em relação à quinta, para eventos mutuamente exclusivos, a probabilidade da interseção é nula; e para
eventos independentes, a probabilidade da interseção é igual ao produto das probabilidades:


                                𝑃(𝐴 ∩ 𝐵) = 0,          𝑠𝑒 𝐴 𝑒 𝐵 𝑚𝑢𝑡𝑢𝑎𝑚𝑒𝑛𝑡𝑒 𝑒𝑥𝑐𝑙𝑢𝑠𝑖𝑣𝑜𝑠
                              𝑃(𝐴 ∩ 𝐵) = 𝑃(𝐴) × 𝑃(𝐵),           𝑠𝑒 𝐴 𝑒 𝐵 𝑖𝑛𝑑𝑒𝑝𝑒𝑛𝑑𝑒𝑛𝑡𝑒𝑠
Portanto, eventos mutuamente exclusivos são necessariamente dependentes (a menos que a probabilidade
de um dos eventos seja nula, para que o produto seja igual a zero). Logo, a afirmativa V está errada.
Gabarito: D

10.   (FGV/2024 – Pref. São José dos Campos) Uma moeda é viciada de modo que, cada vez que ela é
...
Para resolver essa questão, precisamos calcular a interseção de eventos independentes. Sabendo que a
probabilidade de ocorrer CARA é 1/4, então a probabilidade de ocorrer CARA nos 3 lançamentos é o produto:
                                                              1 1 1  1
                                           𝑃(𝐶𝐴, 𝐶𝐴, 𝐶𝐴) =     × × =
                                                              4 4 4 64
E, sabendo que a probabilidade de ocorrer COROA é 3/4, então a probabilidade de ocorrer COROA nos 3
lançamentos é o produto:
                                                              3 3 3 27
                                           𝑃(𝐶𝑂, 𝐶𝑂, 𝐶𝑂) =     × × =
                                                              4 4 4 64
Por fim, a probabilidade de que os 3 resultados sejam iguais, sejam eles CARA ou COROA, que corresponde
à união de eventos mutuamente excludentes, é dada pela soma:
                                                       1 27 28   7
                                                𝑃=      +  =   =
                                                      64 64 64 16
Gabarito: C

11.   (FGV/2024 – Pref. São José dos Campos) Sempre que o dia é frio, Tebaldo bebe chá. A probabilidade
de que amanhã seja um dia frio é de 40%. A probabilidade de que Tebaldo beba chá amanhã é de 58%. A
probabilidade de que Tebaldo beba chá amanhã mesmo que não seja um dia frio é de
...
O enunciado fornece as probabilidades de Tebaldo beber chá condicionada ao dia de amanhã, bem como a
não condicionada. Assim, para resolver essa questão, devemos utilizar o Teorema da Probabilidade Total:
                                                                  ̅̅̅̅̅̅) × 𝑃(𝐹𝑟𝑖𝑜
                          𝑃(𝐶ℎá) = 𝑃 (𝐶ℎá|𝐹𝑟𝑖𝑜) × 𝑃(𝐹𝑟𝑖𝑜) + 𝑃(𝐶ℎá|𝐹𝑟𝑖𝑜        ̅̅̅̅̅̅)

O enunciado informa que:
   •     Sempre que o dia é frio, Tebaldo bebe chá, ou seja, a probabilidade de Tebaldo beber chá, dado que
         o dia é frio é 𝑃(𝐶ℎá|𝐹𝑟𝑖𝑜) = 1;
   •     A probabilidade de que amanhã seja um dia frio é 𝑃(𝐹𝑟𝑖𝑜) = 0,4;
         Logo, a probabilidade de que amanhã não seja um dia frio é complementar:
                                                ̅̅̅̅̅̅) = 1 − 0,4 = 0,6
                                             𝑃(𝐹𝑟𝑖𝑜
   •     A probabilidade de que Tebaldo beba chá amanhã é 𝑃(𝐶ℎá) = 0,58.
...
Substituindo esses dados na fórmula da Probabilidade Total, podemos calcular a probabilidade de Tebaldo
beber chá, dado que o dia não seja frio:
                                                                 ̅̅̅̅̅̅) × 0,6
                                          0,58 = 1 × 0,4 + 𝑃(𝐶ℎá|𝐹𝑟𝑖𝑜
                                                    ̅̅̅̅̅̅) = 0,58 − 0,4 = 0,18
                                        0,6 × 𝑃(𝐶ℎá|𝐹𝑟𝑖𝑜
                                                               0,18
                                                 ̅̅̅̅̅̅) =
                                           𝑃(𝐶ℎá|𝐹𝑟𝑖𝑜               = 0,3 = 30%
...
12.   (FGV/2024 – Pref. São José dos Campos) Sejam A, B e C três eventos quaisquer e P(.) a função
...
13.       (FGV/2023 – TJ/SE) Se P(B) = P(A|B) = P(C|A∩B) = 1/2 , então P(A ∩ B ∩ C) é igual a:
...
Para resolver essa questão, podemos utilizar o teorema da multiplicação, para calcular a probabilidade da
interseção, pelo produto da probabilidade condicional pela probabilidade do evento a priori:
                                    𝑃(𝐴 ∩ 𝐵 ∩ 𝐶) = 𝑃(𝐶|𝐴 ∩ 𝐵) × 𝑃(𝐴 ∩ 𝐵)
                                1
Sabemos que 𝑃(𝐶|𝐴 ∩ 𝐵) = 2. Para calcular 𝑃(𝐴 ∩ 𝐵), utilizamos o teorema da multiplicação novamente:

                                             𝑃(𝐴 ∩ 𝐵) = 𝑃(𝐴|𝐵) × 𝑃(𝐵)
                           1             1
Sabendo que 𝑃(𝐴|𝐵) = 2 e 𝑃(𝐵) = 2, temos:
                                                             1 1 1
                                                𝑃(𝐴 ∩ 𝐵) =    × =
                                                             2 2 4
E a probabilidade da interseção dos 3 eventos é:
                                                              1 1 1
                                             𝑃(𝐴 ∩ 𝐵 ∩ 𝐶) =    × =
                                                              2 4 8
Gabarito: C

14.     (FGV/2023 – Pref. SP) A professora da turma do 4º ano propôs um jogo de “Par ou Ímpar” diferente.
...
Ao final de 10 rodadas, ganha o jogo quem tiver sucesso em mais rodadas. Sobre esse jogo, é correto
afirmar que
...
15.    (FGV/2023 – RFB) Ana vai passar o fim de semana em sua casa de praia. A previsão do tempo diz
...
16.    (FGV/2023 – BANESTES) A figura a seguir ilustra duas urnas onde estão depositadas bolas brancas
e pretas.
...
17.    (FGV/2023 – BANESTES) Uma seguradora trabalha com 2 tipos de seguros de saúde: um básico e
...
18.    (FGV/2023 – BANESTES) Considere o lançamento de um dado equilibrado (ou seja, todas as seis
...
19.     (FGV/2023 – RFB) A partida decisiva Maiorais x Geniais envolve uma grande incógnita. O goleiro
...
20.    (FGV/2023 – TCE/ES) Um certo tipo de componente eletrônico tem 0,2% de chance de chegar
...
21.    (FGV/2023 – BANESTES) Para determinado teste que visa a diagnosticar a presença de defeitos em
...
22.     (FGV/2023 – BANESTES) Em relação a probabilidade de eventos, avalie se as afirmativas a seguir
...
23.    (FGV/2022 – SEMSA Manaus) Se A e B são dois eventos quaisquer com probabilidades maiores do
...
24.    (FGV/2022 – SEFAZ/ES) As probabilidades de dois eventos A e B são P[A] = 0,5, P[B] = 0,8. A
...
25.   (FGV/2022 – TCE/TO) Dois eventos A e B têm probabilidades iguais a 0,5 e 0,6, respectivamente. A
probabilidade condicional de A ocorrer dado que B ocorre é igual a 0,8. Assim, a probabilidade de B ocorrer
dado que A ocorre é igual a:
...
26.   (FGV/2022 – SEMSA Manaus) Suponha que um estatístico jogue dois dados não viciados. Ele
...
27.    (FGV/2022 – SEMSA Manaus) A urna I contém quatro bolas brancas e seis pretas; a urna II contém
...
28.    (FGV/2022 – SEMSA Manaus) Suponha que temos cinco salas cujas portas estão numeradas de 1 a
...
mulher, condicionadas às salas:
   ...
   •     Na sala 1, há 1 mulher, dentre 5 pessoas: 𝑃(𝑀|1) = 5
                                                                       2
   •     Na sala 2, há 2 mulheres, dentre 5 pessoas: 𝑃(𝑀|2) =
                                                                       5
                                                                       3
   •     Na sala 3, há 3 mulheres, dentre 5 pessoas: 𝑃(𝑀|3) = 5
                                                                       4
...
29.    (FGV/2022 – SEAD/AP) Uma urna contém 3 bolas azuis e 2 bolas verdes. Bolas são retiradas da urna,
...
Já, a probabilidade de retirar 1 bola verde primeiro e depois 3 bolas azuis é:
                                            ...
                                            𝑃(𝑉𝐴𝐴𝐴) =          × × × =
                                                              5 4 3 2 10
No entanto, a bola verde pode ser a primeira, a segunda ou a terceira bola retirada 1. Logo, devemos
...
30.    (FGV/2022 – SEFAZ/BA) Luana e Vanessa estão brincando de “par ou ímpar” da seguinte maneira:
...
31.    (FGV/2022 – TJ/TO) Bárbara escreveu cada uma das 13 letras da palavra PROBABILIDADE em 13
...
32.    (FGV/2022 – MPE/SC) ALESSANDRA escreveu em 10 cartões diferentes cada uma das 10 letras do
...
33.   (FGV/2022 – MPE/SC) Duas urnas A e B têm, cada uma, 9 bolas numeradas. Na urna A, há 4 bolas
...
34.   (FGV/2022 – SEMSA Manaus) Em uma disputa de pênaltis, quando um time acerta uma cobrança
...
35.    (FGV/2022 – EPE) Uma determinada fábrica produz dois tipos de cabos elétricos, digamos M e N,
...
36.   (FGV/2022 – Pref. Paulínia) Em uma urna há bolas amarelas e bolas não amarelas. Nessa urna,
...
Comentários:
                                                                                         ...
                                                                                         2
O enunciado informa que a probabilidade de a bola ser numerada, dado que é amarela é 7:
...
37.   (FGV/2022 – CBM/AM) Márcia tem uma ficha amarela, uma ficha verde e duas vermelhas. Joana
...
38.    (FGV/2022 – MPE/GO) Em uma determinada cidade, se chover em um dia a probabilidade de
...
39.    (FGV/2022 – TCE/TO) Uma urna contém inicialmente 5 bolas brancas e 3 bolas pretas. Suponha
...
40.     (FGV/2022 – TCE/TO) Na sala 1 há 12 alunos do sexo masculino e 8 do feminino; na sala 2 há 10
...
41.    (FGV/2022 – TRT/MA) A e B são dois eventos independentes com probabilidades 𝑷[𝑨] = 𝟎, 𝟐 e
...
42.   (FGV/2022 – TRT/MA) Avalie se as afirmativas a seguir, acerca de dois eventos A e B com
...
43.     (FGV/2022 – TRT/PB) Considere o experimento de se lançar aleatoriamente dois dados. Sejam A, B
e C os eventos:
...
44.    (FGV/2022 – Senado Federal) Uma peça é colocada inicialmente na casa 1 de um tabuleiro
...
45.    (FGV/2021 – Paulínia) Um grupo de especialistas utiliza técnicas estatísticas para quantificar a
...
46.     (FGV/2021 – FunSaúde/CE) Em um grupo de pessoas de uma pequena cidade, 30 acessam o site A
...
47.    (FGV/2021 – FunSaúde/CE) Dois eventos A e B são tais que P[A] = 0,8, P[B] = 0,5 e P[A|B]= 0,4.
...
48.       (FGV/2021 – FunSaúde/CE) Se A e B são eventos possíveis, avalie as afirmativas a seguir.
...
49.     (FGV/2021 – FunSaúde/CE) Dois eventos independentes A e B têm probabilidades respectivas
...
50.    (FGV/2021 – Paulínia) Duas crianças jogam par ou ímpar. Nesse jogo, um dos participantes escolhe
...
51.    (FGV/2021 – FunSaúde/CE) Em uma população, 10% das pessoas têm uma dada comorbidade. Se
...
52.    (FGV/2021 – PC/RN) Em um campeonato de futebol, quando o TIMEX joga em casa, a probabilidade
...
53.     (FGV/2021 – FunSaúde/CE) Em uma caixa há 7 fichas numeradas com 1, 3, 4, 6, 7, 8, 9. Retira-se
...
54.   (FGV/2021 – IMBEL) Marcela é praticante de tiro ao alvo. Quando ela acerta um tiro no alvo, a
...
55.    (FGV/2021 – FunSaúde/CE) Em uma urna, há bolas pequenas e bolas grandes, sendo 75% pequenas
...
56.  (FGV/2019 – DPE/RJ) A independência entre os eventos de dado espaço amostral expressa,
...
57.  (FGV/2019 – DPE/RJ) A e B são dois eventos tais que P[A] = 0,4 e P[B] = 0,8. Os valores mínimo e
...
58.    (FGV/2019 – Prefeitura de Angra dos Reis/RJ) Uma urna M contém 3 bolas iguais numeradas de 1
...
59.    (FGV/2019 – DPE/RJ) As técnicas de interrogatório utilizadas para identificar se um suspeito está
...
60.   (FGV/2017 – MPE/BA) Sejam A, B e C eventos aleatórios de um espaço amostral (S), onde A é
...
61.     (FGV/2017 – TJ/AL) Sabe-se que a probabilidade de condenação em 1ª instância, para certo juízo,
...
Pelos dados do enunciado, temos o seguinte:
                                                                                  1
   •     A probabilidade de condenação em 1ª instância é de 1/5: 𝑃(𝐶1) = 5.
...
62.    (FGV/2016 – Prefeitura de Paulínia/SP) Em um Departamento de Matemática trabalham seis
...
63.   (FGV/2016 – IBGE) Suponha que, por coincidência, as 12 pessoas que estão numa sala de espera,
...
64.    (FGV/2015 – Prefeitura de Niterói/RJ) Uma urna contém apenas bolas brancas e bolas pretas. São
...
Aula 06
                                                ...
                                                GABARITO
 1. LETRA E                                  15. LETRA A                 29. LETRA D
 2. LETRA C                                  16. LETRA A                 30. LETRA C
 3. LETRA C                                  17. LETRA E                 31. LETRA E
 4. LETRA D                                  18. LETRA D                 32. LETRA E
 5. LETRA B                                  19. LETRA D                 33. LETRA D
 6. LETRA B                                  20. LETRA C                 34. LETRA B
 7. LETRA C                                  21. LETRA B                 35. LETRA B
 8. LETRA B                                  22. LETRA B                 36. LETRA B
 9. LETRA C                                  23. LETRA D                 37. LETRA C
 10. LETRA C                                 24. LETRA A                 38. LETRA B
 11. LETRA D                                 25. LETRA A                 39. LETRA E
 12. LETRA A                                 26. LETRA E                 40. LETRA B
 13. LETRA C                                 27. LETRA C                 41. LETRA D
 14. LETRA B                                 28. LETRA B
...
Aula 06
                                                ...
                                                GABARITO
 1. LETRA C                                  4. LETRA C                  7. LETRA D
 2. LETRA E                                  5. LETRA B                  8. LETRA E
 3. LETRA C                                  6. LETRA A                  9. LETRA D
...
O número zero é o único a figurar em uma célula verde. Sorteando-se, ao acaso, um desses números, a
probabilidade de que o número esteja em uma célula vermelha, dado que ele é múltiplo de 5 é
...
Historicamente, sabe-se que 30% das denúncias contra fraudes eletrônicas são improcedentes, assim
como 10% das denúncias contra roubo e 20% das denúncias contra tráfico de drogas. Se uma denúncia é
escolhida ao acaso, a probabilidade de ela ser contra roubo, sabendo-se que é uma denúncia procedente,
...
15.     (FGV/2023 – RFB) Ana vai passar o fim de semana em sua casa de praia. A previsão do tempo diz
que a probabilidade de chuva no sábado é de 30%, e a probabilidade de chuva no domingo é de 40%. Nesse
caso, a probabilidade de que Ana consiga ir à praia no fim de semana sem pegar chuva é de
...
60.   (FGV/2017 – MPE/BA) Sejam A, B e C eventos aleatórios de um espaço amostral (S), onde A é
independente do evento (BUC) e B é independente de C. Além disso, estão disponíveis as seguintes
informações: P(A) = 3/7, P(B)= 1/6, P(C) = 1/9. Então a probabilidade do evento A ∩ (B U C) é igual a:
...
62.    (FGV/2016 – Prefeitura de Paulínia/SP) Em um Departamento de Matemática trabalham seis
professores, cada um com uma especialidade. Dois são especialistas em Álgebra, dois são especialistas em
Geometria e os outros dois em Trigonometria. Sorteando três professores, a probabilidade de que sejam
todos de especialidades diferentes é
...
64.    (FGV/2015 – Prefeitura de Niterói/RJ) Uma urna contém apenas bolas brancas e bolas pretas. São
vinte bolas ao todo e a probabilidade de uma bola retirada aleatoriamente da urna ser branca é 1/5. Duas
bolas são retiradas da urna sucessivamente e sem reposição. A probabilidade de as duas bolas retiradas
serem pretas é:
...
Aula 06
                                                ...
                                                GABARITO
 1. LETRA D                                  23. LETRA C                 45. LETRA B
 2. LETRA C                                  24. LETRA D                 46. LETRA E
 3. LETRA E                                  25. LETRA A                 47. LETRA B
 4. LETRA B                                  26. LETRA D                 48. LETRA A
 5. LETRA A                                  27. LETRA E                 49. LETRA C
 6. LETRA E                                  28. LETRA B                 50. LETRA B
 7. LETRA B                                  29. LETRA D                 51. LETRA A
 8. LETRA A                                  30. LETRA B                 52. LETRA D
 9. LETRA D                                  31. LETRA A                 53. LETRA A
 10. LETRA C                                 32. LETRA A                 54. LETRA D
 11. LETRA C                                 33. LETRA E                 55. LETRA E
 12. LETRA B                                 34. LETRA A                 56. LETRA E
 13. LETRA C                                 35. LETRA A                 57. LETRA B
 14. LETRA A                                 36. LETRA D                 58. LETRA E
 15. LETRA D                                 37. LETRA D                 59. LETRA C
 16. LETRA B                                 38. LETRA B                 60. LETRA D
 17. LETRA D                                 39. LETRA A                 61. LETRA A
 18. LETRA B                                 40. LETRA B                 62. LETRA C
 19. LETRA E                                 41. LETRA A                 63. LETRA A
 20. LETRA C                                 42. LETRA E                 64. LETRA C
 21. LETRA D                                 43. LETRA B
 22. LETRA A                                 44. LETRA D
