...
- estatistica
- inferencia
arquivo_origem: Aula 08_005_Resumo.txt
...
Discretas de Probabilidade (Parte A). Trata-se de um material pensado para lhe ajudar em
...
Variáveis Aleatórias Discretas (Parte A)
...
● Mediana: divide a distribuição em duas partes iguais
