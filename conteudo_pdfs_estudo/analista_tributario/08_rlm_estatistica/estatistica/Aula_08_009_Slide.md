...
---
        ...
        VARIÁVEL ALEATÓRIA DISCRETA
         Os possíveis resultados estão contidos em um conjunto finito ou
         enumerável
...
---
     ...
     F(x) = 0,8 se 6 ≤ x < 9
     F(x) = 1 se x ≥ 9
     Nesse caso, a probabilidade P[5 ≤ X < 9] é igual a
     A. 0,1
     B. 0,3
     C. 0,4
     D. 0,5
...
---
    ...
    SABENDO QUE E(Z) = 4 E Var(Z) = 25, CALCULE E(Z2)
...
---
        ...
        CÁLCULO COM FUNÇÃO DE PROBABILIDADE
               FUNÇÃO DE               x
             PROBABILIDADE
               CONJUNTA      2                    4
                       1     0,2                0,4
...
---
        ...
        VARIÂNCIA DA SOMA
                   𝑉𝐴𝑅 𝛼𝑋 + 𝛽𝑌 = 𝛼 2 𝑉𝐴𝑅 𝑋 + 𝛽 2 𝑉𝐴𝑅 𝑌 + 2. 𝛼𝛽𝐶𝑂𝑉(𝑋𝑌)
