...
7) Funções de Autocovariância e Autocorrelação.


8) Modelos Arima.


9) Questões Comentadas - Modelo Clássico - FGV


10) Questões Comentadas - Tendência - FGV


11) Questões Comentadas - Funções de Autocovariância e Autocorrelação - FGV


12) Questões Comentadas - Modelos ARIMA - FGV


13) Aviso importante - Orientação de estudo


14) Questões Comentadas - Modelo Clássico - Inéditas


15) Questões Comentadas - Tendência - Inéditas


16) Questões Comentadas - Suavização Exponencial - Inéditas


17) Questões Comentadas - Modelos ARIMA - Inéditas


18) Lista de Questões - Modelo Clássico - FGV


19) Lista de Questões - Tendência - FGV


20) Lista de Questões - Funções de Autocovariância e Autocorrelação - FGV


21) Lista de Questões - Modelos ARIMA - FGV


22) Lista de Questões - Modelo Clássico - Inéditas


23) Lista de Questões - Tendência - Inéditas


24) Lista de Questões - Suavização Exponencial - Inéditas


25) Lista de Questões - Modelos ARIMA - Inéditas
...
períodos mais curtos, como a hora ou o minuto.              ==219a34==
