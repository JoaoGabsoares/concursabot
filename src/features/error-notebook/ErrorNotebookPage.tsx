          ...
          <button
            ...
            className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${
              filterStatus === 'mastered'
                ? 'bg-[var(--accent-gabarito)] text-black font-semibold'
                : 'text-[var(--text-muted)] hover:text-[var(--text-primary)]'
            }`}
          >
            Superados (+15 XP)
      ...
      <div className="space-y-3">
        {displayedErrors.length === 0 ? (
          <Card className="text-center py-12 space-y-2">
            <CheckCircle2 className="w-12 h-12 text-[var(--accent-gabarito)] mx-auto" />
            ...
            return (
              <Card
                ...
                className={`flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                  isMastered ? 'border-[var(--accent-gabarito)]/30 bg-[var(--accent-gabarito-glow)]/20' : 'border-red-900/30'
                }`}
              >
                <div className="space-y-1.5 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {item.topic && (
                      <span className="text-[11px] text-[var(--text-muted)] font-sans">• {item.topic}</span>
                    )}
                  </div>
                  ...
                  {item.personal_notes && (
                    <p className="text-[11px] text-amber-400 font-sans italic">
          ...
          <div className="space-y-4">
            ...
            {retryResult && (
              <div className={`p-3.5 rounded-xl border space-y-1.5 animate-fade-in ${
                retryResult.correct 
                  ? 'bg-[var(--accent-gabarito-glow)] border-[var(--accent-gabarito)] text-[var(--accent-gabarito)]'
            ...
            <div className="space-y-1.5 pt-2 border-t border-[var(--border-subtle)]">
              ...
              <textarea
                ...
                rows={3}
                className="w-full p-2.5 rounded-lg text-xs bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-[var(--text-primary)] focus:border-[var(--accent-gabarito)] outline-none font-sans"
              />
              <Button
                size="sm"
                variant="outline"
