...
const CAREER_METRICS: Record<string, { salary: string; vacancies: string; competition: string }> = {
 atrfb: { salary: 'R$ 11.684,39/mês', vacancies: '469 Vagas', competition: '184 cand/vaga' },
 afrfb: { salary: 'R$ 21.029,09/mês', vacancies: '230 Vagas', competition: '240 cand/vaga' },
 bb_comercial: { salary: 'R$ 5.430,00/mês', vacancies: '3.000 Vagas', competition: '380 cand/vaga' },
 bb_ti: { salary: 'R$ 5.600,00/mês + PLR', vacancies: '1.500 Vagas', competition: '92 cand/vaga' },
...
export const PublicDashboardPage: React.FC<PublicDashboardPageProps> = ({
 ...
 return (
 <div className="min-h-screen w-full overflow-y-auto overflow-x-hidden bg-[var(--bg-base)] text-[var(--text-primary)] font-sans flex flex-col justify-between selection:bg-[var(--accent-primary)] selection:text-white ">
 ...
 <div className="w-10 h-10 rounded-xl bg-[var(--btn-primary-bg)] text-white flex items-center justify-center font-display font-black text-xl shadow-lg">
 G
 </div>
 <div>
 ...
 <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[var(--accent-emerald-bg)] border border-[var(--accent-success)]/30 text-[var(--accent-success)] font-mono text-xs font-bold">
 <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-success)]"></span>
 SISTEMA ATIVO
 </span>
 </div>
 <p className="text-xs font-mono text-[var(--text-muted)] hidden md:block">
 ...
 {/* Navigation Anchors */}
 <nav className="hidden lg:flex items-center gap-6 font-sans text-xs text-[var(--text-secondary)]">
 <a href="#simulador" className="hover:text-[var(--accent-primary)] transition-colors">Simulador</a>
 <a href="#laboratorios" className="hover:text-[var(--accent-primary)] transition-colors">Laboratórios</a>
 <a href="#metodologia" className="hover:text-[var(--accent-primary)] transition-colors">Metodologia</a>
 <a href="#comparativo" className="hover:text-[var(--accent-primary)] transition-colors">Comparativo</a>
 <a href="#patentes" className="hover:text-[var(--accent-primary)] transition-colors">Patentes</a>
 <a href="#faq" className="hover:text-[var(--accent-primary)] transition-colors">FAQ</a>
 </nav>
 ...
 className="p-2 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all cursor-pointer shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]"
 ...
 className="font-sans text-xs font-bold bg-[var(--btn-primary-bg)] hover:bg-[var(--btn-primary-hover)] shadow-md shadow-sm"
 >
 ...
 <span className="text-[var(--border-subtle)] hidden sm:inline">•</span>
 <div className="flex items-center gap-2">
 <BrainCircuit className="w-3.5 h-3.5 text-[var(--accent-purple)]" />
 Bancas <strong className="text-[var(--accent-primary)]">FGV</strong>, <strong className="text-[var(--accent-success)]">Cesgranrio</strong> & <strong className="text-[var(--accent-warning)]">Cebraspe</strong>
 </div>
 </div>

 {/* Hero Title & Value Proposition */}
 <div className="text-center max-w-4xl mx-auto space-y-4">
 <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[var(--accent-primary-glow)] border border-[var(--accent-primary)]/30 text-xs font-mono text-[var(--accent-primary)] font-bold ">
 ...
 <span className="font-sans text-xs sm:text-sm font-bold text-[var(--text-primary)] uppercase tracking-wider">
 1. Selecione o Certame para Simulação em Tempo Real:
 </span>
 </div>
 <span className="text-xs font-mono text-[var(--accent-primary)] font-bold hidden sm:inline">
 ...
 isSelected
 ? 'bg-[var(--btn-primary-bg)] text-white border-[var(--accent-primary)]/30 shadow-lg scale-[1.03]'
 : 'bg-[var(--bg-surface)] hover:bg-[var(--bg-elevated)] text-[var(--text-secondary)] border-[var(--border-subtle)] hover:border-[var(--accent-primary)]/30'
 }`}
 >
 <span className="truncate w-full">{career.name.split('—')[0].trim()}</span>
 <span className={`text-xs px-1.5 py-0.2 rounded font-semibold ${isSelected ? 'bg-white/20 text-white' : 'bg-[var(--bg-elevated)] text-[var(--text-muted)]'}`}>
 ...
 <span className="px-2.5 py-1 rounded-full bg-[var(--accent-emerald-bg)] border border-[var(--accent-success)]/30 text-[var(--accent-success)] font-mono text-xs font-bold">
 ...
 <div className="text-xs text-[var(--text-muted)] uppercase">Vagas</div>
 <div className="font-bold text-[var(--accent-primary)] mt-0.5">{activeMetrics.vacancies}</div>
 </div>
 <div className="p-3 rounded-xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-center">
 <div className="text-xs text-[var(--text-muted)] uppercase">Concorrência</div>
 <div className="font-bold text-[var(--accent-warning)] mt-0.5">{activeMetrics.competition}</div>
 </div>
 <div className="p-3 rounded-xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-center">
 <div className="text-xs text-[var(--text-muted)] uppercase">Simulados</div>
 <div className="font-bold text-[var(--accent-success)] mt-0.5">Disponível</div>
 </div>
 </div>

 {/* Subject Weight Distribution Bars */}
 <div className="space-y-2 pt-2">
 <div className="font-sans text-xs font-bold text-[var(--text-muted)] uppercase tracking-wider flex justify-between">
 <span>Matérias de Maior Peso no Edital:</span>
 <span className="text-[var(--accent-primary)]">Distribuição Oficial da Banca</span>
 </div>
 ...
 className="w-full sm:w-auto font-sans text-xs font-bold bg-[var(--btn-primary-bg)] shadow-md shadow-sm px-5 py-2.5 whitespace-nowrap shrink-0 flex items-center justify-center gap-2"
 >
 ...
 <span className="px-2 py-0.5 rounded bg-[var(--accent-purple-bg)] text-[var(--accent-purple)] font-mono text-xs font-bold">
 INÉDITA
 </span>
 </div>
 ...
 ? 'bg-[var(--accent-emerald-bg)] border-emerald-500 text-[var(--accent-success)] font-semibold'
 ...
 >
 <span className="font-mono font-bold shrink-0 px-1.5 py-0.5 rounded bg-[var(--bg-surface)] border border-[var(--border-subtle)] text-xs">
 {opt.letter}
 </span>
 ...
 {fgvSubmitted && (
 <div className="p-3.5 rounded-xl bg-[var(--accent-purple-bg)] border border-[var(--accent-purple)]/30 text-xs space-y-1 animate-fade-in font-mono">
 <div className="font-bold text-[var(--accent-purple)] flex items-center gap-1.5">
 ...
 <span className="text-[var(--accent-purple)] font-bold">+25 XP por acerto</span>
 </div>
 </Card>
 ...
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--accent-amber-bg)] border border-[var(--accent-warning)]/30 text-xs font-mono text-[var(--accent-warning)] font-bold">
 ...
 <Card className="p-6 sm:p-8 flex flex-col justify-between space-y-5 bg-[var(--bg-surface)] border-t-4 border-t-amber-500 shadow-xl ">
 <div className="space-y-3">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <Scale className="w-5 h-5 text-[var(--accent-warning)] " />
 <span className="font-sans text-xs font-bold text-[var(--text-muted)] uppercase tracking-wider">
 Laboratório 01 • Caça-Pegadinhas da Lei Seca
 </span>
 </div>
 <div className={`px-2.5 py-1 rounded-lg font-mono text-xs font-bold flex items-center gap-1.5 ${timerRunning ? 'bg-[var(--accent-warning)] text-white ' : 'bg-[var(--bg-elevated)] text-[var(--text-muted)]'}`}>
 ...
 <div className="flex items-center justify-between font-mono text-xs text-[var(--accent-primary)] font-bold">
 ...
 className="font-sans text-xs font-bold bg-[var(--accent-primary)] hover:from-amber-400 hover:to-orange-500 shadow-md shadow-amber-500/20 mt-2"
 >
 ...
 className="font-sans text-xs font-bold bg-[var(--accent-success)] hover:bg-[var(--accent-success)]"
 >
 ...
 {/* Feedback Alert */}
 {demoResult && (
 <div className={`p-4 rounded-xl border text-xs font-mono space-y-1.5 animate-fade-in ${demoResult.isCorrect ? 'bg-[var(--accent-emerald-bg)] border-[var(--accent-success)]/30 text-[var(--accent-success)]' : 'bg-rose-500/10 border-rose-500/30 text-rose-400'}`}>
 ...
 className="text-xs font-bold underline text-[var(--accent-primary)] hover:opacity-80 pt-1 cursor-pointer"
 >
 ...
 <span className="font-bold text-[var(--accent-warning)]">+10 XP por acerto</span>
 </div>
 </Card>

 {/* Lab 2: Matriz de Aproveitamento Interativa */}
 <Card className="p-6 sm:p-8 flex flex-col justify-between space-y-5 bg-[var(--bg-surface)] border-t-4 border-t-emerald-500 shadow-xl ">
 <div className="space-y-4">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 ...
 <label className="text-xs text-[var(--text-muted)] uppercase font-bold">Estudei Para:</label>
 <select
 value={matrixFrom}
 ...
 <span className="font-bold text-[var(--accent-success)] text-sm">{getMatrixPercentage()}% de Base Comum</span>
 </div>
 <div className="w-full h-3 rounded-full bg-[var(--bg-surface)] border border-[var(--border-subtle)] overflow-hidden">
 <div
 className="h-full bg-[var(--accent-primary)] transition-all duration-700 rounded-full"
 style={{ width: `${getMatrixPercentage()}%` }}
 />
 </div>
 <p className="text-xs text-[var(--text-secondary)] font-mono pt-1">
 ...
 <span className="text-[var(--accent-success)] font-bold">Trilha Automática</span>
 </div>
 </Card>
 ...
 {/* Pilar 1 */}
 <Card className="p-6 space-y-3 bg-[var(--bg-surface)] hover:border-[var(--accent-primary)] transition-all shadow-md">
 <div className="w-12 h-12 rounded-2xl bg-[var(--accent-primary-glow)] border border-[var(--accent-primary)]/20 text-[var(--accent-primary)] flex items-center justify-center font-bold">
 ...
 {/* Pilar 2 */}
 <Card className="p-6 space-y-3 bg-[var(--bg-surface)] hover:border-[var(--accent-warning)] transition-all shadow-md">
 <div className="w-12 h-12 rounded-2xl bg-[var(--accent-amber-bg)] border border-[var(--accent-warning)]/20 text-[var(--accent-warning)] flex items-center justify-center font-bold">
 ...
 {/* Pilar 3 */}
 <Card className="p-6 space-y-3 bg-[var(--bg-surface)] hover:border-[var(--accent-danger)] transition-all shadow-md">
 <div className="w-12 h-12 rounded-2xl bg-[var(--color-status-danger-bg)] border border-[var(--accent-danger)]/20 text-[var(--accent-danger)] flex items-center justify-center font-bold">
 ...
 {/* Pilar 4 */}
 <Card className="p-6 space-y-3 bg-[var(--bg-surface)] hover:border-[var(--accent-success)] transition-all shadow-md">
 <div className="w-12 h-12 rounded-2xl bg-[var(--accent-emerald-bg)] border border-[var(--accent-success)]/20 text-[var(--accent-success)] flex items-center justify-center font-bold">
 ...
 <th className="pb-3 font-bold uppercase text-[var(--accent-primary)]">Ecossistema Gabarito.AI</th>
 </tr>
 </thead>
 ...
 <td className="py-3.5 text-[var(--accent-primary)] font-bold">Pareto 80/20 com os tópicos mais cobrados</td>
 </tr>
 <tr>
 ...
 <td className="py-3.5 text-[var(--accent-primary)] font-bold">Desafios de 15s no Caça-Pegadinhas da Lei</td>
 </tr>
 <tr>
 ...
 <td className="py-3.5 text-[var(--accent-primary)] font-bold">Algoritmo SM-2 com repetição espaçada automática</td>
 </tr>
 <tr>
 ...
 <td className="py-3.5 text-[var(--accent-primary)] font-bold">Correção instantânea por IA nos 4 eixos oficiais</td>
 </tr>
 <tr>
 ...
 <td className="py-3.5 text-[var(--accent-primary)] font-bold">Provas de 4h com pesos reais e Cartão Digital</td>
 </tr>
 </tbody>
 </table>
 </Card>
 ...
 <div className="text-center space-y-1.5">
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--accent-primary-glow)] border border-[var(--accent-primary)]/30 text-xs font-mono text-[var(--accent-primary)] font-bold">
 ...
 <div 
 key={rank.level}
 className="p-4 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] hover:border-[var(--accent-primary)]/50 transition-all flex flex-col justify-between space-y-2 shadow-sm"
 >
 <div className="flex items-center justify-between">
 <span className="px-2 py-0.5 rounded bg-[var(--bg-elevated)] font-bold text-xs text-[var(--accent-primary)]">
 NÍVEL {rank.level}
 </span>
 ...
 <Card 
 key={idx}
 className="p-5 bg-[var(--bg-surface)] border border-[var(--border-subtle)] hover:border-[var(--accent-primary)]/30 transition-all cursor-pointer"
 ...
 <ChevronDown className={`w-4 h-4 text-[var(--text-muted)] transition-transform duration-200 ${isOpen ? 'rotate-180 text-[var(--accent-primary)]' : ''}`} />
 </div>
 {isOpen && (
 ...
 {/* ============================================================ */}
 <Card className="p-8 sm:p-12 bg-[var(--bg-elevated)] border border-[var(--border-subtle)] shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
 ...
 className="shrink-0 font-sans text-sm font-bold bg-[var(--btn-primary-bg)] hover:bg-[var(--btn-primary-hover)] shadow-xl shadow-blue-500/30 px-8 py-4"
 >
 <Sparkles className="w-4 h-4 text-[var(--accent-primary)]" />
 ...
 <div className="flex items-center gap-2">
 <div className="w-6 h-6 rounded-lg bg-[var(--btn-primary-bg)] text-white flex items-center justify-center font-bold text-xs">G</div>
 ...
 <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-xs font-mono text-[var(--accent-primary)] font-bold">
 ...
 className="w-full h-11 px-4 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] hover:bg-[var(--bg-surface)] text-[var(--text-primary)] hover:border-cyan-500/50 transition-all font-sans font-bold text-xs sm:text-sm flex items-center justify-center gap-3 shadow-sm active:scale-[0.99] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]"
 >
 ...
 className="w-full h-10 pl-10 pr-3 rounded-lg text-xs sm:text-sm bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-[var(--text-primary)] focus:border-[var(--accent-primary)]/30 outline-none font-sans"
 />
 </div>
 </div>
 ...
 className="w-full h-10 pl-10 pr-10 rounded-lg text-xs sm:text-sm bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-[var(--text-primary)] focus:border-[var(--accent-primary)]/30 outline-none font-sans"
 />
 <button
 type="button"
 ...
 size="md"
 disabled={authLoading}
 className="font-sans text-xs sm:text-sm font-bold bg-[var(--btn-primary-bg)] shadow-md shadow-sm mt-3 py-3 h-11 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]"
 >
 {authLoading ? (
